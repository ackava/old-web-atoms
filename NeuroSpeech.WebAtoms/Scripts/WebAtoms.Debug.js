...
;
Templates.jsonML["WebAtoms.AtomCalendar.gridTemplate"] = 
[["div",
{  }
,["div",
{ "class": "title" }
...
;
Templates.jsonML["WebAtoms.AtomFileUploader.template"] = 
[["div",
{ "atom-dock": "Fill", "atom-type": "AtomViewStack", "atom-selected-index": "[$owner.atomParent.displayMode]", "atom-presenter": "viewStack" }
,["div",
{  }
,["input",
{ "atom-presenter": "filePresenter", "type": "file", "value": "Browse", "style": "position: absolute; width: 100%; height: 25px" }
]], ["div",
{ "atom-presenter": "flashPresenter", "style": "min-height: 25px", "atom-type": "AtomViewBox" }
], ["div",
{ "style": "color: #000" }
,["span",
{ "atom-text": "[' Uploading (' + $owner.atomParent.progress + '%)']" }
]], ["div",
{ "style": "color: red" }
,"\nError\n"], ["div",
{  }
...
,["div",
{ "atom-dock": "Top", "atom-presenter": "detailHeaderToolbar", "class": "atom-navigator-detail-header" }
,["button",
...
;
Templates.jsonML["WebAtoms.AtomPhotoPlayer.template"] = 
[
["img",
{ "atom-presenter": "img", "style": "max-width:100%;max-height:100%; text-align:center; vertical-align:middle" }
], ["img",
{ "atom-presenter": "loading", "style": "position:absolute;visibility:hidden;", "style-left": "[(($owner.width/2)-32) + 'px']", "style-top": "[(($owner.height/2)-32) + 'px']" }
]
]
;
...
/*Line 109 - 'AtomBrowser.js' */    initialize: function () {
...
/*Line 143 - 'AtomBrowser.js' */AtomBrowser.initialize();
/*Line 0 - 'Atom.js' */
/*Line 1 - 'Atom.js' */
/*Line 2 - 'Atom.js' */
/*Line 3 - 'Atom.js' */
...
/*Line 7 - 'Atom.js' */// TypeScript Copied...
/*Line 8 - 'Atom.js' *///var __extends = this.__extends || function (d, b) {
/*Line 9 - 'Atom.js' *///    function __() { this.constructor = d; }
/*Line 10 - 'Atom.js' *///    __.prototype = b.prototype;
/*Line 11 - 'Atom.js' *///    d.prototype = new __();
/*Line 12 - 'Atom.js' *///};




/*Line 17 - 'Atom.js' *///if (!Function.prototype.registerClass) {

/*Line 19 - 'Atom.js' *///    Function.__typeName = 'Function';
/*Line 20 - 'Atom.js' *///    Function.__class = true;
/*Line 21 - 'Atom.js' *///    Function.createDelegate = function Function$createDelegate(instance, method) {
/*Line 22 - 'Atom.js' *///        return function () {
/*Line 23 - 'Atom.js' *///            return method.apply(instance, arguments);
/*Line 24 - 'Atom.js' *///        };
/*Line 25 - 'Atom.js' *///    };

/*Line 27 - 'Atom.js' *///    //window.Sys = {};

/*Line 29 - 'Atom.js' *///    //Sys.EventArgs = {};
/*Line 30 - 'Atom.js' *///    //Sys.EventArgs.Empty = {};

/*Line 32 - 'Atom.js' *///    window.zEvalProp = function (t, p) {
/*Line 33 - 'Atom.js' *///        var i = p.indexOf('.');
/*Line 34 - 'Atom.js' *///        if (i == -1)
/*Line 35 - 'Atom.js' *///            return t[p];
/*Line 36 - 'Atom.js' *///        var n = p.substr(0, i);
/*Line 37 - 'Atom.js' *///        p = p.substr(i + 1);
/*Line 38 - 'Atom.js' *///        return window.zEvalProp(t[n], p);
/*Line 39 - 'Atom.js' *///    };

/*Line 41 - 'Atom.js' *///    // This class registers a prototype along with base Type
/*Line 42 - 'Atom.js' *///    // This must be called in inheirtence order only
/*Line 43 - 'Atom.js' *///    Function.prototype.registerClass = function (name, baseType) {
/*Line 44 - 'Atom.js' *///        var pname = window.zEvalProp(window,name);
/*Line 45 - 'Atom.js' *///        if (pname !== this)
/*Line 46 - 'Atom.js' *///            throw new Error("Type " + name + " does not exist");
/*Line 47 - 'Atom.js' *///        this.__typeName = name;
/*Line 48 - 'Atom.js' *///        if (baseType) {
/*Line 49 - 'Atom.js' *///            this.__baseType = baseType;
/*Line 50 - 'Atom.js' *///            this.baseType = baseType.prototype;
/*Line 51 - 'Atom.js' *///            //this.prototype = baseType;
/*Line 52 - 'Atom.js' *///            this.prototype.constructor = this;
/*Line 53 - 'Atom.js' *///            for (var m in baseType.prototype) {
/*Line 54 - 'Atom.js' *///                if (this.prototype[m])
/*Line 55 - 'Atom.js' *///                    continue;
/*Line 56 - 'Atom.js' *///                this.prototype[m] =  baseType.prototype[m];
/*Line 57 - 'Atom.js' *///            }
/*Line 58 - 'Atom.js' *///        }
/*Line 59 - 'Atom.js' *///    };

/*Line 61 - 'Atom.js' *///    // Should be used in constructor to call base class constructor
/*Line 62 - 'Atom.js' *///    Function.prototype.initializeBase = function (instance, baseArguements) {
/*Line 63 - 'Atom.js' *///        if (baseArguements) {
/*Line 64 - 'Atom.js' *///            this.__baseType.apply(instance, baseArguements);
/*Line 65 - 'Atom.js' *///        }else {
/*Line 66 - 'Atom.js' *///            this.__baseType.apply(instance);
/*Line 67 - 'Atom.js' *///        }
/*Line 68 - 'Atom.js' *///    };

/*Line 70 - 'Atom.js' *///    Function.prototype.callBaseMethod = function (instance, name, baseArguements) {
/*Line 71 - 'Atom.js' *///        var baseType = this.__baseType;
/*Line 72 - 'Atom.js' *///        var method = baseType.prototype[name];
/*Line 73 - 'Atom.js' *///        if (method) {
/*Line 74 - 'Atom.js' *///            if (baseArguements) {
/*Line 75 - 'Atom.js' *///                return method.apply(instance, baseArguements);
/*Line 76 - 'Atom.js' *///            }else {
/*Line 77 - 'Atom.js' *///                return method.apply(instance);
/*Line 78 - 'Atom.js' *///            }
/*Line 79 - 'Atom.js' *///        }else {
/*Line 80 - 'Atom.js' *///            return baseType.callBaseMethod(instance, name, baseArguements);
/*Line 81 - 'Atom.js' *///        }
/*Line 82 - 'Atom.js' *///    };

/*Line 84 - 'Atom.js' *///    Function.prototype.isNamespace = function (name) {
/*Line 85 - 'Atom.js' *///        return window[name];
/*Line 86 - 'Atom.js' *///    };

/*Line 88 - 'Atom.js' *///    Function.prototype.registerNamespace = function (name) {
/*Line 89 - 'Atom.js' *///        var ns = name.split('.');
/*Line 90 - 'Atom.js' *///        var root = window;
/*Line 91 - 'Atom.js' *///        for (var i = 0; i < ns.length; i++) {
/*Line 92 - 'Atom.js' *///            var n = ns[i];
/*Line 93 - 'Atom.js' *///            var type = root[n];
/*Line 94 - 'Atom.js' *///            if (!type) {
/*Line 95 - 'Atom.js' *///                type = {};
/*Line 96 - 'Atom.js' *///                root[n] = type;
/*Line 97 - 'Atom.js' *///            }
/*Line 98 - 'Atom.js' *///            root = type;
/*Line 99 - 'Atom.js' *///        }
/*Line 100 - 'Atom.js' *///    };

/*Line 102 - 'Atom.js' *///    window.Type = Function;
/*Line 103 - 'Atom.js' *///}



/*Line 107 - 'Atom.js' */var AtomEnumerator = (function (name, base) {
/*Line 108 - 'Atom.js' */    return classCreator(name, base,
/*Line 109 - 'Atom.js' */    function (array) {
/*Line 110 - 'Atom.js' */        this._array = array;
/*Line 111 - 'Atom.js' */        this.i = -1;
/*Line 112 - 'Atom.js' */    },
/*Line 113 - 'Atom.js' */    {
/*Line 114 - 'Atom.js' */        next: function () {
/*Line 115 - 'Atom.js' */            this.i = this.i + 1;
/*Line 116 - 'Atom.js' */            return this.i < this._array.length;
/*Line 117 - 'Atom.js' */        },
/*Line 118 - 'Atom.js' */        current: function () {
/*Line 119 - 'Atom.js' */            return this._array[this.i];
/*Line 120 - 'Atom.js' */        },
/*Line 121 - 'Atom.js' */        currentIndex: function () {
/*Line 122 - 'Atom.js' */            return this.i;
/*Line 123 - 'Atom.js' */        },
/*Line 124 - 'Atom.js' */        isFirst: function () {
/*Line 125 - 'Atom.js' */            return this.i == 0;
/*Line 126 - 'Atom.js' */        },
/*Line 127 - 'Atom.js' */        isLast: function () {
/*Line 128 - 'Atom.js' */            return this.i == this._array.length - 1;
/*Line 129 - 'Atom.js' */        },
/*Line 130 - 'Atom.js' */        reset: function () {
/*Line 131 - 'Atom.js' */            this.i = -1;
/*Line 132 - 'Atom.js' */        }
/*Line 133 - 'Atom.js' */    });
/*Line 134 - 'Atom.js' */})("AtomEnumerator",null);
    

/*Line 137 - 'Atom.js' */var Atom = {

/*Line 139 - 'Atom.js' */    refreshWindowCommand: function () {
/*Line 140 - 'Atom.js' */        location.href = location.pathname + "?_v=" + (new Date()).getTime() + location.hash;
/*Line 141 - 'Atom.js' */    },

/*Line 143 - 'Atom.js' */    time: function () {
/*Line 144 - 'Atom.js' */        return (new Date()).getTime();
/*Line 145 - 'Atom.js' */    },

/*Line 147 - 'Atom.js' */    get: function (obj, path) {
/*Line 148 - 'Atom.js' */        var index = path.indexOf('.');
/*Line 149 - 'Atom.js' */        if (index != -1) {
/*Line 150 - 'Atom.js' */            var f = path.substr(0, index);
/*Line 151 - 'Atom.js' */            obj = AtomBinder.getValue(obj, f);
/*Line 152 - 'Atom.js' */            path = path.substr(index + 1);
/*Line 153 - 'Atom.js' */            return Atom.get(obj, path);
/*Line 154 - 'Atom.js' */        }
/*Line 155 - 'Atom.js' */        return AtomBinder.getValue(obj, path);
/*Line 156 - 'Atom.js' */    },

/*Line 158 - 'Atom.js' */    set: function (obj, path, val) {
/*Line 159 - 'Atom.js' */        var index = path.indexOf('.');
/*Line 160 - 'Atom.js' */        if (index != -1) {
/*Line 161 - 'Atom.js' */            var f = path.substr(0, index);
/*Line 162 - 'Atom.js' */            obj = AtomBinder.getValue(obj, f);
/*Line 163 - 'Atom.js' */            path = path.substr(index + 1);
/*Line 164 - 'Atom.js' */            return Atom.set(obj, path,val);
/*Line 165 - 'Atom.js' */        }
/*Line 166 - 'Atom.js' */        AtomBinder.setValue(obj, path, val);
/*Line 167 - 'Atom.js' */    },

/*Line 169 - 'Atom.js' */    csv: function (a, path, s) {
/*Line 170 - 'Atom.js' */        if (!s) {
/*Line 171 - 'Atom.js' */            s = ", ";
/*Line 172 - 'Atom.js' */        }
/*Line 173 - 'Atom.js' */        var l = [];
/*Line 174 - 'Atom.js' */        var ae = new AtomEnumerator(a);
/*Line 175 - 'Atom.js' */        while (ae.next()) {
/*Line 176 - 'Atom.js' */            var item = ae.current();
/*Line 177 - 'Atom.js' */            l.push(Atom.get(item,path));
/*Line 178 - 'Atom.js' */        }
/*Line 179 - 'Atom.js' */        return l.join(s);
/*Line 180 - 'Atom.js' */    },

/*Line 182 - 'Atom.js' */    range: function (start, end, step) {
/*Line 183 - 'Atom.js' */        var a = [];
/*Line 184 - 'Atom.js' */        step = step || 1;
/*Line 185 - 'Atom.js' */        for (var i = start; i <= end; i+=step) {
/*Line 186 - 'Atom.js' */            a.push({ label: i, value: i });
/*Line 187 - 'Atom.js' */        }
/*Line 188 - 'Atom.js' */        return a;
/*Line 189 - 'Atom.js' */    },

/*Line 191 - 'Atom.js' */    merge: function (x, y, update, clone) {
/*Line 192 - 'Atom.js' */        //var c = AtomBinder.getClone(y);
/*Line 193 - 'Atom.js' */        if (!x)
/*Line 194 - 'Atom.js' */            return;
/*Line 195 - 'Atom.js' */        var c = clone ? AtomBinder.getClone(y) : y;
/*Line 196 - 'Atom.js' */        if (update) {
/*Line 197 - 'Atom.js' */            for (var k in c) {
/*Line 198 - 'Atom.js' */                //x[k] = c[k];
/*Line 199 - 'Atom.js' */                Atom.set(x, k, AtomBinder.getValue(c, k));
/*Line 200 - 'Atom.js' */            }
/*Line 201 - 'Atom.js' */        } else {
/*Line 202 - 'Atom.js' */            for (var k in c) {
/*Line 203 - 'Atom.js' */                x[k] = c[k];
/*Line 204 - 'Atom.js' */            }
/*Line 205 - 'Atom.js' */        }
/*Line 206 - 'Atom.js' */        return x;
/*Line 207 - 'Atom.js' */    },

/*Line 209 - 'Atom.js' */    url: function (url, q, lq) {
/*Line 210 - 'Atom.js' */        var finalUrl = url;
/*Line 211 - 'Atom.js' */        var plist = [];
/*Line 212 - 'Atom.js' */        if (q) {
/*Line 213 - 'Atom.js' */            for (var i in q) {
/*Line 214 - 'Atom.js' */                if (q.hasOwnProperty(i)) {
/*Line 215 - 'Atom.js' */                    var val = q[i];
/*Line 216 - 'Atom.js' */                    if (val === undefined)
/*Line 217 - 'Atom.js' */                        continue;
/*Line 218 - 'Atom.js' */                    if (val === null)
/*Line 219 - 'Atom.js' */                        continue;
/*Line 220 - 'Atom.js' */                    if (val && (val.constructor != String) && (typeof val) == 'object') {
/*Line 221 - 'Atom.js' */                        val = JSON.stringify(val);
/*Line 222 - 'Atom.js' */                    }
/*Line 223 - 'Atom.js' */                    plist.push(i + '=' + encodeURIComponent(val));
/*Line 224 - 'Atom.js' */                }
/*Line 225 - 'Atom.js' */            }

/*Line 227 - 'Atom.js' */            if (plist.length) {
/*Line 228 - 'Atom.js' */                var index = finalUrl.indexOf('?');
/*Line 229 - 'Atom.js' */                if (index == -1) {
/*Line 230 - 'Atom.js' */                    finalUrl += "?";
/*Line 231 - 'Atom.js' */                } else {
/*Line 232 - 'Atom.js' */                    finalUrl += '&';
/*Line 233 - 'Atom.js' */                }
/*Line 234 - 'Atom.js' */            }

/*Line 236 - 'Atom.js' */            finalUrl += plist.join('&');
/*Line 237 - 'Atom.js' */        }

/*Line 239 - 'Atom.js' */        if (lq) {
/*Line 240 - 'Atom.js' */            plist = [];
/*Line 241 - 'Atom.js' */            for (var i in lq) {
/*Line 242 - 'Atom.js' */                if (lq.hasOwnProperty(i)) {
/*Line 243 - 'Atom.js' */                    var val = lq[i];
/*Line 244 - 'Atom.js' */                    if (val === undefined || val === null)
/*Line 245 - 'Atom.js' */                        continue;
/*Line 246 - 'Atom.js' */                    plist.push(i + '=' + encodeURIComponent(val));
/*Line 247 - 'Atom.js' */                }
/*Line 248 - 'Atom.js' */            }
/*Line 249 - 'Atom.js' */            if (plist.length) {
/*Line 250 - 'Atom.js' */                finalUrl += '#' + plist.join("&");
/*Line 251 - 'Atom.js' */            }
/*Line 252 - 'Atom.js' */        }

/*Line 254 - 'Atom.js' */        return finalUrl;
/*Line 255 - 'Atom.js' */    },

/*Line 257 - 'Atom.js' */    encodeParameters: function (q) {
/*Line 258 - 'Atom.js' */        var plist = [];
/*Line 259 - 'Atom.js' */        for (var i in q) {
/*Line 260 - 'Atom.js' */            if (i.indexOf('_') == 0)
/*Line 261 - 'Atom.js' */                continue;
/*Line 262 - 'Atom.js' */            var val = q[i];
/*Line 263 - 'Atom.js' */            if (val === undefined)
/*Line 264 - 'Atom.js' */                continue;
/*Line 265 - 'Atom.js' */            if (val === null)
/*Line 266 - 'Atom.js' */                continue;
/*Line 267 - 'Atom.js' */            var t = typeof(val);
/*Line 268 - 'Atom.js' */            if (t != 'string' && t != 'number' && t != 'boolean') {
/*Line 269 - 'Atom.js' */                continue;
/*Line 270 - 'Atom.js' */            }
/*Line 271 - 'Atom.js' */            plist.push(i + '=' + encodeURIComponent(val));
/*Line 272 - 'Atom.js' */        }
/*Line 273 - 'Atom.js' */        return plist.join('&');
/*Line 274 - 'Atom.js' */    },

/*Line 276 - 'Atom.js' */    tableLayout: function (columns, cellWidth, cellHeight) {
/*Line 277 - 'Atom.js' */        return new WebAtoms.AtomTableLayout(columns, cellWidth, cellHeight);
/*Line 278 - 'Atom.js' */    },

/*Line 280 - 'Atom.js' */    toDash: function(text){
/*Line 281 - 'Atom.js' */        return text.replace(/([A-Z])/g, function($1){return "-"+$1.toLowerCase();});
/*Line 282 - 'Atom.js' */    },

/*Line 284 - 'Atom.js' */    secureUrl: function () {
/*Line 285 - 'Atom.js' */        var u = "";
/*Line 286 - 'Atom.js' */        for (var i = 0; i < arguments.length; i++) {
/*Line 287 - 'Atom.js' */            var ui = arguments[i];
/*Line 288 - 'Atom.js' */            if (ui === null || ui === undefined) {
/*Line 289 - 'Atom.js' */                return undefined;
/*Line 290 - 'Atom.js' */            }
/*Line 291 - 'Atom.js' */            u += ui;
/*Line 292 - 'Atom.js' */        }
/*Line 293 - 'Atom.js' */        if (/^\/\//.test(u)) {
/*Line 294 - 'Atom.js' */            return document.location.protocol + u;
/*Line 295 - 'Atom.js' */        }
/*Line 296 - 'Atom.js' */        if ('https:' == document.location.protocol) {
/*Line 297 - 'Atom.js' */            u = u.replace(/http\:\/\//, "https://");
/*Line 298 - 'Atom.js' */        }
/*Line 299 - 'Atom.js' */        return u;
/*Line 300 - 'Atom.js' */    }
/*Line 301 - 'Atom.js' */};

/*Line 303 - 'Atom.js' */window.Atom = Atom;

/*Line 305 - 'Atom.js' */(function () {
/*Line 306 - 'Atom.js' */    var e,
/*Line 307 - 'Atom.js' */        a = /\+/g,  
/*Line 308 - 'Atom.js' */        r = /([^&=]+)=?([^&]*)/g,
/*Line 309 - 'Atom.js' */        d = function (s) { return decodeURIComponent(s.replace(a, " ")); },
/*Line 310 - 'Atom.js' */        q = window.location.search.substring(1);

/*Line 312 - 'Atom.js' */    var urlParams = {};
/*Line 313 - 'Atom.js' */    while (e = r.exec(q))
/*Line 314 - 'Atom.js' */        urlParams[d(e[1])] = d(e[2]);
/*Line 315 - 'Atom.js' */    Atom.pageQuery = urlParams;
/*Line 316 - 'Atom.js' */})();

/*Line 318 - 'Atom.js' */var AtomDate = {

/*Line 320 - 'Atom.js' */    zoneOffset: (new Date()).getTimezoneOffset() * 60 * 1000,

/*Line 322 - 'Atom.js' */    toLocalTime: function (d) {
/*Line 323 - 'Atom.js' */        return d.toJSON();
/*Line 324 - 'Atom.js' */    },

/*Line 326 - 'Atom.js' */    m_names: new Array("Jan", "Feb", "Mar", 
/*Line 327 - 'Atom.js' */"Apr", "May", "Jun", "Jul", "Aug", "Sep", 
/*Line 328 - 'Atom.js' */"Oct", "Nov", "Dec"),

/*Line 330 - 'Atom.js' */    setTime: function (dt, time) {
/*Line 331 - 'Atom.js' */        if (!dt || !time)
/*Line 332 - 'Atom.js' */            return dt;
/*Line 333 - 'Atom.js' */        var tokens = time.split(':');
/*Line 334 - 'Atom.js' */        var h = parseInt(tokens[0]);
/*Line 335 - 'Atom.js' */        tokens = tokens[1].split(' ');
/*Line 336 - 'Atom.js' */        var m = parseInt(tokens[0]);
/*Line 337 - 'Atom.js' */        var ap = tokens[1];
/*Line 338 - 'Atom.js' */        if (/am/i.test(ap)) {
/*Line 339 - 'Atom.js' */            if (h == 12) {
/*Line 340 - 'Atom.js' */                h = 0;
/*Line 341 - 'Atom.js' */            }
/*Line 342 - 'Atom.js' */        } else {
/*Line 343 - 'Atom.js' */            if (h != 12) {
/*Line 344 - 'Atom.js' */                h += 12;
/*Line 345 - 'Atom.js' */            }
/*Line 346 - 'Atom.js' */        }
/*Line 347 - 'Atom.js' */        var d = new Date(dt.getFullYear(),dt.getMonth(),dt.getDate());
/*Line 348 - 'Atom.js' */        d.setHours(h);
/*Line 349 - 'Atom.js' */        d.setMinutes(m);
/*Line 350 - 'Atom.js' */        if (d.getTime() == dt.getTime())
/*Line 351 - 'Atom.js' */            return dt;
/*Line 352 - 'Atom.js' */        return d;
/*Line 353 - 'Atom.js' */    },

/*Line 355 - 'Atom.js' */    toMMDDYY: function (dt) {
/*Line 356 - 'Atom.js' */        var m = dt.getMonth() + 1;
/*Line 357 - 'Atom.js' */        var y = dt.getFullYear();
/*Line 358 - 'Atom.js' */        var d = dt.getDate();

/*Line 360 - 'Atom.js' */        var str = "";
/*Line 361 - 'Atom.js' */        str +=  ((m > 9) ? m : ("0" + m));
/*Line 362 - 'Atom.js' */        str += "/" + ((d > 9) ? d : ("0" + d));
/*Line 363 - 'Atom.js' */        str += "/" + y;
/*Line 364 - 'Atom.js' */        return str;
/*Line 365 - 'Atom.js' */    },

/*Line 367 - 'Atom.js' */    toShortDateString: function (val) {
/*Line 368 - 'Atom.js' */        if (!val)
/*Line 369 - 'Atom.js' */            return "";
/*Line 370 - 'Atom.js' */        if (val.constructor == String) {
/*Line 371 - 'Atom.js' */            if (/^\/date\(/gi.test(val)) {
/*Line 372 - 'Atom.js' */                val = val.substr(6);
/*Line 373 - 'Atom.js' */                val = new Date(parseInt(val,10));
/*Line 374 - 'Atom.js' */            } else {
/*Line 375 - 'Atom.js' */                throw new Error("Invalid date format " + val);
/*Line 376 - 'Atom.js' */            }
/*Line 377 - 'Atom.js' */        }
/*Line 378 - 'Atom.js' */        //var dt = new Date();
        
/*Line 380 - 'Atom.js' */        return this.m_names[val.getMonth()] + " " + val.getDate() + ", " + val.getFullYear();
/*Line 381 - 'Atom.js' */    },
/*Line 382 - 'Atom.js' */    toDateTimeString: function (val) {
/*Line 383 - 'Atom.js' */        if (!val)
/*Line 384 - 'Atom.js' */            return "";
/*Line 385 - 'Atom.js' */        if (val.constructor == String) {
/*Line 386 - 'Atom.js' */            val = val.substr(6);
/*Line 387 - 'Atom.js' */            val = new Date(parseInt(val,10));
/*Line 388 - 'Atom.js' */        }
/*Line 389 - 'Atom.js' */        var dt = AtomDate.toShortDateString(val);
/*Line 390 - 'Atom.js' */        return dt + " - " + AtomDate.toTimeString(val);
/*Line 391 - 'Atom.js' */    },

/*Line 393 - 'Atom.js' */    toTimeString: function (d) {
/*Line 394 - 'Atom.js' */        d = AtomDate.parse(d);
/*Line 395 - 'Atom.js' */        if (!d)
/*Line 396 - 'Atom.js' */            return "";
/*Line 397 - 'Atom.js' */        var h = d.getHours();
/*Line 398 - 'Atom.js' */        var s = "AM";
/*Line 399 - 'Atom.js' */        if (h == 12) {
/*Line 400 - 'Atom.js' */            s = "PM";
/*Line 401 - 'Atom.js' */        } else {
/*Line 402 - 'Atom.js' */            if (h > 12) {
/*Line 403 - 'Atom.js' */                h = h - 12;
/*Line 404 - 'Atom.js' */                s = "PM";
/*Line 405 - 'Atom.js' */            }
/*Line 406 - 'Atom.js' */        }
/*Line 407 - 'Atom.js' */        var m = d.getMinutes();
/*Line 408 - 'Atom.js' */        if (m < 10) {
/*Line 409 - 'Atom.js' */            m = "0" + m;
/*Line 410 - 'Atom.js' */        } else {
/*Line 411 - 'Atom.js' */            m = m + "";
/*Line 412 - 'Atom.js' */            if (m.length == 1) {
/*Line 413 - 'Atom.js' */                m = m + "0";
/*Line 414 - 'Atom.js' */            }
/*Line 415 - 'Atom.js' */        }
/*Line 416 - 'Atom.js' */        return h + ":" + m + " " + s;
/*Line 417 - 'Atom.js' */    },

/*Line 419 - 'Atom.js' */    smartDate: function (v) {
/*Line 420 - 'Atom.js' */        if (!v)
/*Line 421 - 'Atom.js' */            return null;
/*Line 422 - 'Atom.js' */        var d = AtomDate.parse(v);
/*Line 423 - 'Atom.js' */        var now = new Date();

/*Line 425 - 'Atom.js' */        if (now.getFullYear() == d.getFullYear()
/*Line 426 - 'Atom.js' */            && now.getMonth() == d.getMonth()) {
/*Line 427 - 'Atom.js' */            var diff = now.getDate() - d.getDate();
/*Line 428 - 'Atom.js' */            switch(diff){
/*Line 429 - 'Atom.js' */                case -1:
/*Line 430 - 'Atom.js' */                    return "Tomorrow (" + AtomDate.toTimeString(d) + ")";
/*Line 431 - 'Atom.js' */                case 0:
/*Line 432 - 'Atom.js' */                    return "Today (" + AtomDate.toTimeString(d) + ")";
/*Line 433 - 'Atom.js' */                case 1:
/*Line 434 - 'Atom.js' */                    return "Yesterday (" + AtomDate.toTimeString(d) + ")";
/*Line 435 - 'Atom.js' */            }
/*Line 436 - 'Atom.js' */        }
/*Line 437 - 'Atom.js' */        return AtomDate.toDateTimeString(d);
/*Line 438 - 'Atom.js' */    },

/*Line 440 - 'Atom.js' */    smartDateUTC: function (v) {
/*Line 441 - 'Atom.js' */        return AtomDate.smartDate(v);
/*Line 442 - 'Atom.js' */    },

/*Line 444 - 'Atom.js' */    parse: function (v) {
/*Line 445 - 'Atom.js' */        if (!v)
/*Line 446 - 'Atom.js' */            return null;
/*Line 447 - 'Atom.js' */        if (!(v.constructor == String))
/*Line 448 - 'Atom.js' */            return v;
/*Line 449 - 'Atom.js' */        if (/^\/date\([\-0-9]+\)\//gi.test(v)) {
/*Line 450 - 'Atom.js' */            v = new Date(parseInt(v.substr(6),10));
/*Line 451 - 'Atom.js' */        } else {
/*Line 452 - 'Atom.js' */            if (/^\/dateiso/gi.test(v)) {
/*Line 453 - 'Atom.js' */                v = v.substr(9);
/*Line 454 - 'Atom.js' */                v = v.substr(0, v.length - 1);
/*Line 455 - 'Atom.js' */                var tokens = v.split('T');
/*Line 456 - 'Atom.js' */                var date = tokens[0];
/*Line 457 - 'Atom.js' */                var time = tokens[1];
/*Line 458 - 'Atom.js' */                date = date.split('-');
/*Line 459 - 'Atom.js' */                time = time.split(':');
/*Line 460 - 'Atom.js' */                var d = new Date(date[0], parseInt(date[1]) - 1, date[2], time[0], time[1], parseFloat(time[2]));
/*Line 461 - 'Atom.js' */                d = new Date(d.getTime() + AtomDate.zoneOffset);
/*Line 462 - 'Atom.js' */                return d;
/*Line 463 - 'Atom.js' */            } else {
/*Line 464 - 'Atom.js' */                v = Date.parse(v);
/*Line 465 - 'Atom.js' */            }
/*Line 466 - 'Atom.js' */        }
/*Line 467 - 'Atom.js' */        return v;
/*Line 468 - 'Atom.js' */        //var i = v.getTime();
/*Line 469 - 'Atom.js' */        //var z = v.getTimezoneOffset() * 60 * 1000;
/*Line 470 - 'Atom.js' */        //i = i - z;
/*Line 471 - 'Atom.js' */        //return new Date(i);
/*Line 472 - 'Atom.js' */    }
/*Line 473 - 'Atom.js' */};

/*Line 475 - 'Atom.js' */window.AtomDate = AtomDate;

/*Line 477 - 'Atom.js' */AtomDate.monthList = [
/*Line 478 - 'Atom.js' */    { label: "January", value: 1 },
/*Line 479 - 'Atom.js' */    { label: "February", value: 2 },
/*Line 480 - 'Atom.js' */    { label: "March", value: 3 },
/*Line 481 - 'Atom.js' */    { label: "April", value: 4 },
/*Line 482 - 'Atom.js' */    { label: "May", value: 5 },
/*Line 483 - 'Atom.js' */    { label: "June", value: 6 },
/*Line 484 - 'Atom.js' */    { label: "July", value: 7 },
/*Line 485 - 'Atom.js' */    { label: "August", value: 8 },
/*Line 486 - 'Atom.js' */    { label: "September", value: 9 },
/*Line 487 - 'Atom.js' */    { label: "October", value: 10 },
/*Line 488 - 'Atom.js' */    { label: "November", value: 11 },
/*Line 489 - 'Atom.js' */    { label: "December", value: 12 }
/*Line 490 - 'Atom.js' */];


/*Line 493 - 'Atom.js' */var AtomFileSize = {
/*Line 494 - 'Atom.js' */    toFileSize: function (val) {
/*Line 495 - 'Atom.js' */        if (!val)
/*Line 496 - 'Atom.js' */            return "";
/*Line 497 - 'Atom.js' */        if (val.constructor == String)
/*Line 498 - 'Atom.js' */            val = parseInt(val, 10);
/*Line 499 - 'Atom.js' */        if (val > 1073741824) {
/*Line 500 - 'Atom.js' */            return Math.round(val / 1073741824) + " GB";
/*Line 501 - 'Atom.js' */        }
/*Line 502 - 'Atom.js' */        if (val > 1048576) {
/*Line 503 - 'Atom.js' */            return Math.round(val / 1048576) + " MB";
/*Line 504 - 'Atom.js' */        }
/*Line 505 - 'Atom.js' */        if (val > 1024) {
/*Line 506 - 'Atom.js' */            return Math.round(val / 1024) + " KB";
/*Line 507 - 'Atom.js' */        }
/*Line 508 - 'Atom.js' */        return val + " B";
/*Line 509 - 'Atom.js' */    }
/*Line 510 - 'Atom.js' */};

/*Line 512 - 'Atom.js' */window.AtomFileSize = AtomFileSize;

/*Line 514 - 'Atom.js' */var AtomPhone = {
/*Line 515 - 'Atom.js' */    toSmallPhoneString: function (val) {
/*Line 516 - 'Atom.js' */        if (!val)
/*Line 517 - 'Atom.js' */            return "";
/*Line 518 - 'Atom.js' */        var tokens = val.split(":", 6);
/*Line 519 - 'Atom.js' */        var cc = tokens[2];
/*Line 520 - 'Atom.js' */        cc = "(" + (/^\+/.test(cc) ? '' : '+') + tokens[2] + ") ";
/*Line 521 - 'Atom.js' */        var phone = tokens[3];
/*Line 522 - 'Atom.js' */        var ext = tokens[4];
/*Line 523 - 'Atom.js' */        var msg = tokens[5];
/*Line 524 - 'Atom.js' */        if (!phone)
/*Line 525 - 'Atom.js' */            return "";
/*Line 526 - 'Atom.js' */        return cc + phone;
/*Line 527 - 'Atom.js' */    },
/*Line 528 - 'Atom.js' */    toPhoneString: function (val) {
/*Line 529 - 'Atom.js' */        if (!val)
/*Line 530 - 'Atom.js' */            return "";
/*Line 531 - 'Atom.js' */        var tokens = val.split(":", 6);
/*Line 532 - 'Atom.js' */        var cc = "(+" + tokens[2] + ") ";
/*Line 533 - 'Atom.js' */        var phone = tokens[3];
/*Line 534 - 'Atom.js' */        var ext = tokens[4];
/*Line 535 - 'Atom.js' */        var msg = tokens[5];
/*Line 536 - 'Atom.js' */        if (!phone)
/*Line 537 - 'Atom.js' */            return "";
/*Line 538 - 'Atom.js' */        var txt = cc + phone;
/*Line 539 - 'Atom.js' */        if (ext)
/*Line 540 - 'Atom.js' */            txt += " (ext: " + ext + ")";
/*Line 541 - 'Atom.js' */        if (msg)
/*Line 542 - 'Atom.js' */            txt += " (" + msg + ")";
/*Line 543 - 'Atom.js' */        return txt;
/*Line 544 - 'Atom.js' */    }
/*Line 545 - 'Atom.js' */};

/*Line 547 - 'Atom.js' */window.AtomPhone = AtomPhone;

/*Line 549 - 'Atom.js' */Atom.resolve = function (obj, ap) {

/*Line 551 - 'Atom.js' */    var start = !ap;

/*Line 553 - 'Atom.js' */    if (!obj)
/*Line 554 - 'Atom.js' */        return obj;

/*Line 556 - 'Atom.js' */    if (start) {

/*Line 558 - 'Atom.js' */        ap = new AtomPromise();
/*Line 559 - 'Atom.js' */        ap.list = [];
/*Line 560 - 'Atom.js' */        ap.done = function (v) {
/*Line 561 - 'Atom.js' */            Atom.remove(ap.list, v);
/*Line 562 - 'Atom.js' */            if (ap.list.length == 0) {
/*Line 563 - 'Atom.js' */                ap.pushValue(obj);
/*Line 564 - 'Atom.js' */            }
/*Line 565 - 'Atom.js' */        };
/*Line 566 - 'Atom.js' */    }


/*Line 569 - 'Atom.js' */    var type = typeof (obj);

/*Line 571 - 'Atom.js' */    if (type == 'object') {
/*Line 572 - 'Atom.js' */        if (typeof (obj.length) != 'undefined') {
/*Line 573 - 'Atom.js' */            //this is an array
/*Line 574 - 'Atom.js' */            for (var i = 0; i < obj.length; i++) {
/*Line 575 - 'Atom.js' */                var v = obj[i];
/*Line 576 - 'Atom.js' */                if (!v)
/*Line 577 - 'Atom.js' */                    continue;
/*Line 578 - 'Atom.js' */                var item = obj;
/*Line 579 - 'Atom.js' */                var key = i;
/*Line 580 - 'Atom.js' */                if (v instanceof AtomPromise || v.constructor == AtomPromise) {
/*Line 581 - 'Atom.js' */                    ap.list.push(v);
/*Line 582 - 'Atom.js' */                    v.failed(function (a) {
/*Line 583 - 'Atom.js' */                        ap.done(a);
/*Line 584 - 'Atom.js' */                    });
/*Line 585 - 'Atom.js' */                    v.then(function (a) {
/*Line 586 - 'Atom.js' */                        item[key] = a.value();
/*Line 587 - 'Atom.js' */                        ap.done(a);
/*Line 588 - 'Atom.js' */                    });
/*Line 589 - 'Atom.js' */                    continue;
/*Line 590 - 'Atom.js' */                }
/*Line 591 - 'Atom.js' */                Atom.resolve(v, ap);
/*Line 592 - 'Atom.js' */            }
/*Line 593 - 'Atom.js' */        } else {
/*Line 594 - 'Atom.js' */            for (var i in obj) {
/*Line 595 - 'Atom.js' */                var v = obj[i];
/*Line 596 - 'Atom.js' */                if (!v)
/*Line 597 - 'Atom.js' */                    continue;
/*Line 598 - 'Atom.js' */                if (v instanceof AtomPromise || v.constructor == AtomPromise) {
/*Line 599 - 'Atom.js' */                    ap.list.push(v);
/*Line 600 - 'Atom.js' */                    v.failed(function (a) {
/*Line 601 - 'Atom.js' */                        ap.done(a);
/*Line 602 - 'Atom.js' */                    });
/*Line 603 - 'Atom.js' */                    var item = obj;
/*Line 604 - 'Atom.js' */                    var key = i;
/*Line 605 - 'Atom.js' */                    v.then(function (a) {
/*Line 606 - 'Atom.js' */                        item[key] = a.value();
/*Line 607 - 'Atom.js' */                        ap.done(a);
/*Line 608 - 'Atom.js' */                    });
/*Line 609 - 'Atom.js' */                    continue;
/*Line 610 - 'Atom.js' */                }
/*Line 611 - 'Atom.js' */                Atom.resolve(v, ap);
/*Line 612 - 'Atom.js' */            }
/*Line 613 - 'Atom.js' */        }
/*Line 614 - 'Atom.js' */    }

/*Line 616 - 'Atom.js' */    if (ap.list.length) {
/*Line 617 - 'Atom.js' */        if (start) {
/*Line 618 - 'Atom.js' */            ap.onInvoke(function () {
/*Line 619 - 'Atom.js' */                var ae = new AtomEnumerator(ap.list);
/*Line 620 - 'Atom.js' */                while (ae.next()) {
/*Line 621 - 'Atom.js' */                    ae.current().invoke(ap._invoker);
/*Line 622 - 'Atom.js' */                }
/*Line 623 - 'Atom.js' */            });
/*Line 624 - 'Atom.js' */        }
/*Line 625 - 'Atom.js' */        return ap;
/*Line 626 - 'Atom.js' */    }
/*Line 627 - 'Atom.js' */    return obj;
...
/*Line 295 - 'AtomUI.js' */            e.style.maxHeight = r.height + "px";
/*Line 296 - 'AtomUI.js' */        }
/*Line 297 - 'AtomUI.js' */        if (r.left) {
/*Line 298 - 'AtomUI.js' */            e.style.left = r.left + "px";
/*Line 299 - 'AtomUI.js' */        }
/*Line 300 - 'AtomUI.js' */        if (r.top) {
/*Line 301 - 'AtomUI.js' */            e.style.top = r.top + "px";
/*Line 302 - 'AtomUI.js' */        }
/*Line 303 - 'AtomUI.js' */    },

/*Line 305 - 'AtomUI.js' */    getPresenterOwner: function (ctrl, p) {
/*Line 306 - 'AtomUI.js' */        if (ctrl._presenters) {
/*Line 307 - 'AtomUI.js' */            var ae = new AtomEnumerator(ctrl._presenters);
/*Line 308 - 'AtomUI.js' */            while (ae.next()) {
/*Line 309 - 'AtomUI.js' */                var c = ae.current();
/*Line 310 - 'AtomUI.js' */                if (c == p)
/*Line 311 - 'AtomUI.js' */                    return ctrl;
/*Line 312 - 'AtomUI.js' */            }
/*Line 313 - 'AtomUI.js' */        }
/*Line 314 - 'AtomUI.js' */        return this.getPresenterOwner(ctrl.get_atomParent(), p);
/*Line 315 - 'AtomUI.js' */    },

/*Line 317 - 'AtomUI.js' */    createCss: function (o) {
/*Line 318 - 'AtomUI.js' */        if (!o)
/*Line 319 - 'AtomUI.js' */            return "";
/*Line 320 - 'AtomUI.js' */        if (o.constructor == String)
/*Line 321 - 'AtomUI.js' */            return o;
/*Line 322 - 'AtomUI.js' */        var list = [];
/*Line 323 - 'AtomUI.js' */        for (var k in o) {
/*Line 324 - 'AtomUI.js' */            var v = o[k];
/*Line 325 - 'AtomUI.js' */            if (!v)
/*Line 326 - 'AtomUI.js' */                continue;
/*Line 327 - 'AtomUI.js' */            list.push(k);
/*Line 328 - 'AtomUI.js' */        }
/*Line 329 - 'AtomUI.js' */        return list.join(" ");
/*Line 330 - 'AtomUI.js' */    },

/*Line 332 - 'AtomUI.js' */    createControl: function (element, type, data, newScope) {
/*Line 333 - 'AtomUI.js' */        if (element.atomControl)
/*Line 334 - 'AtomUI.js' */            return;
/*Line 335 - 'AtomUI.js' */        if (!type) {
/*Line 336 - 'AtomUI.js' */            type = $(element).attr("atom-type");
/*Line 337 - 'AtomUI.js' */            type = WebAtoms[type];
/*Line 338 - 'AtomUI.js' */        } else {
/*Line 339 - 'AtomUI.js' */            if (type.constructor == String) {
/*Line 340 - 'AtomUI.js' */                type = WebAtoms[type];
/*Line 341 - 'AtomUI.js' */            }
/*Line 342 - 'AtomUI.js' */        }
/*Line 343 - 'AtomUI.js' */        if (type) {
/*Line 344 - 'AtomUI.js' */            var ctrl = new type(element);
/*Line 345 - 'AtomUI.js' */            if (data) {
/*Line 346 - 'AtomUI.js' */                ctrl._data = data;
/*Line 347 - 'AtomUI.js' */            }
/*Line 348 - 'AtomUI.js' */            if (newScope) {
/*Line 349 - 'AtomUI.js' */                ctrl._scope = newScope;
/*Line 350 - 'AtomUI.js' */            }

/*Line 352 - 'AtomUI.js' */            //initializes templates..
/*Line 353 - 'AtomUI.js' */            //ctrl.prepareControl();

/*Line 355 - 'AtomUI.js' */            //initialize templates and creates controls...
/*Line 356 - 'AtomUI.js' */            ctrl.createChildren();

/*Line 358 - 'AtomUI.js' */            if (data) {
/*Line 359 - 'AtomUI.js' */                ctrl.initialize();
/*Line 360 - 'AtomUI.js' */            }
/*Line 361 - 'AtomUI.js' */            //$(element).removeAttr("atom-type");
/*Line 362 - 'AtomUI.js' */            return ctrl;
/*Line 363 - 'AtomUI.js' */        }
/*Line 364 - 'AtomUI.js' */        return null;
/*Line 365 - 'AtomUI.js' */    }

/*Line 367 - 'AtomUI.js' */};

/*Line 369 - 'AtomUI.js' */window.AtomUI = AtomUI;

/*Line 371 - 'AtomUI.js' */AtomUI.isIE7 = window.navigator.userAgent.indexOf("MSIE 7.0") != -1;
/*Line 372 - 'AtomUI.js' */AtomUI.isIE8 = window.navigator.userAgent.indexOf("MSIE 8.0") != -1;
...
/*Line 99 - 'AtomComponent.js' */            initialize: function () {
...
/*Line 383 - 'AtomPromise.js' */AtomPromise.json = function (url, query, options) {
/*Line 384 - 'AtomPromise.js' */    options = options || {};
/*Line 385 - 'AtomPromise.js' */    options.type = options.type || "get";
/*Line 386 - 'AtomPromise.js' */    options.dataType = options.dataType || "json";
/*Line 387 - 'AtomPromise.js' */    return AtomPromise.ajax(url, query, options, "json");
/*Line 388 - 'AtomPromise.js' */};

/*Line 390 - 'AtomPromise.js' */AtomPromise.cache = {
/*Line 391 - 'AtomPromise.js' */};

/*Line 393 - 'AtomPromise.js' */AtomPromise.cacheInProgress = {
/*Line 394 - 'AtomPromise.js' */};

/*Line 396 - 'AtomPromise.js' */AtomPromise.cachedPromise = function (key, p) {
/*Line 397 - 'AtomPromise.js' */    var c = AtomPromise.cache[key];

/*Line 399 - 'AtomPromise.js' */    if (!c && window.sessionStorage) {
/*Line 400 - 'AtomPromise.js' */        c = window.sessionStorage["__AP" + key];
/*Line 401 - 'AtomPromise.js' */        if (c) {
/*Line 402 - 'AtomPromise.js' */            c = JSON.parse(c);
/*Line 403 - 'AtomPromise.js' */            AtomPromise.cache[key] = c;
/*Line 404 - 'AtomPromise.js' */        }
/*Line 405 - 'AtomPromise.js' */    }

/*Line 407 - 'AtomPromise.js' */    if (c) {
/*Line 408 - 'AtomPromise.js' */        p.onInvoke(function () {
/*Line 409 - 'AtomPromise.js' */            p.pushValue(c);
/*Line 410 - 'AtomPromise.js' */        });
/*Line 411 - 'AtomPromise.js' */        return p;
/*Line 412 - 'AtomPromise.js' */    }

/*Line 414 - 'AtomPromise.js' */    p.then(function (p1) {
/*Line 415 - 'AtomPromise.js' */        AtomPromise.cache[key] = p1.value();
/*Line 416 - 'AtomPromise.js' */        if (window.sessionStorage) {
/*Line 417 - 'AtomPromise.js' */            window.sessionStorage["__AP" + key] = JSON.stringify( p1.value() );
/*Line 418 - 'AtomPromise.js' */        }
/*Line 419 - 'AtomPromise.js' */    });

/*Line 421 - 'AtomPromise.js' */    return p;
/*Line 422 - 'AtomPromise.js' */};

/*Line 424 - 'AtomPromise.js' */AtomPromise.cachedJson = function (url, query, options) {

/*Line 426 - 'AtomPromise.js' */    var vd = new Date();

/*Line 428 - 'AtomPromise.js' */    var v = AtomConfig.ajax.version;
/*Line 429 - 'AtomPromise.js' */    var vk = AtomConfig.ajax.versionKey + '=' + v;

/*Line 431 - 'AtomPromise.js' */    if (url.indexOf('?') == -1) {
/*Line 432 - 'AtomPromise.js' */        vk = '?' + vk;
/*Line 433 - 'AtomPromise.js' */    } else {
/*Line 434 - 'AtomPromise.js' */        if (!/\&$/.test(url)) {
/*Line 435 - 'AtomPromise.js' */            vk = '&' + vk;
/*Line 436 - 'AtomPromise.js' */        }
/*Line 437 - 'AtomPromise.js' */    }
/*Line 438 - 'AtomPromise.js' */    url += vk;

/*Line 440 - 'AtomPromise.js' */    options = options || {};
/*Line 441 - 'AtomPromise.js' */    // caching must be true everywhere
/*Line 442 - 'AtomPromise.js' */    options.cache = true;
/*Line 443 - 'AtomPromise.js' */    options.ifModified = true;
/*Line 444 - 'AtomPromise.js' */    options.versionUrl = false;

/*Line 446 - 'AtomPromise.js' */    var ap = AtomPromise.ajax(url, query, options, "json");
/*Line 447 - 'AtomPromise.js' */    return AtomPromise.cachedPromise(url, ap);
/*Line 448 - 'AtomPromise.js' */};

/*Line 450 - 'AtomPromise.js' */AtomPromise.configCache = {};

/*Line 452 - 'AtomPromise.js' */AtomPromise.configLabel = function (url, value, options) {

/*Line 454 - 'AtomPromise.js' */    if (value === null || value === undefined)
/*Line 455 - 'AtomPromise.js' */        return "";

/*Line 457 - 'AtomPromise.js' */    options = options || {};

/*Line 459 - 'AtomPromise.js' */    var valuePath = options.valuePath || "value";
/*Line 460 - 'AtomPromise.js' */    var labelPath = options.labelPath || "label";
/*Line 461 - 'AtomPromise.js' */    var isNumber = options.isNumber || false;

/*Line 463 - 'AtomPromise.js' */    if (isNumber) {
/*Line 464 - 'AtomPromise.js' */        if (typeof value !== "number") {
/*Line 465 - 'AtomPromise.js' */            value = parseFloat(value);
/*Line 466 - 'AtomPromise.js' */        }
/*Line 467 - 'AtomPromise.js' */    }

/*Line 469 - 'AtomPromise.js' */    var p = new AtomPromise();
/*Line 470 - 'AtomPromise.js' */    p.onInvoke(function () {

/*Line 472 - 'AtomPromise.js' */        var cf = AtomPromise.configCache[url];
/*Line 473 - 'AtomPromise.js' */        if (cf) {
/*Line 474 - 'AtomPromise.js' */            cf = cf[value];
/*Line 475 - 'AtomPromise.js' */            cf = cf ? cf[labelPath] : "";
/*Line 476 - 'AtomPromise.js' */            p.pushValue(cf);
/*Line 477 - 'AtomPromise.js' */            return;
/*Line 478 - 'AtomPromise.js' */        }

/*Line 480 - 'AtomPromise.js' */        var ap = AtomPromise.cachedJson(url);


/*Line 483 - 'AtomPromise.js' */        ap.then(function (a) {
/*Line 484 - 'AtomPromise.js' */            var v = "";

/*Line 486 - 'AtomPromise.js' */            var nv = {};

/*Line 488 - 'AtomPromise.js' */            var ae = new AtomEnumerator(a.value());
/*Line 489 - 'AtomPromise.js' */            while (ae.next()) {
/*Line 490 - 'AtomPromise.js' */                var item = ae.current();
/*Line 491 - 'AtomPromise.js' */                v = item[valuePath];
/*Line 492 - 'AtomPromise.js' */                if (isNumber) {
/*Line 493 - 'AtomPromise.js' */                    if (typeof v !== "number") {
/*Line 494 - 'AtomPromise.js' */                        v = parseFloat(v);
/*Line 495 - 'AtomPromise.js' */                    }
/*Line 496 - 'AtomPromise.js' */                }
/*Line 497 - 'AtomPromise.js' */                nv[v] = item;
/*Line 498 - 'AtomPromise.js' */            }
/*Line 499 - 'AtomPromise.js' */            AtomPromise.configCache[url] = nv;
/*Line 500 - 'AtomPromise.js' */            nv = nv[value];
/*Line 501 - 'AtomPromise.js' */            nv = nv ? nv[labelPath] : "";
/*Line 502 - 'AtomPromise.js' */            p.pushValue(nv);
/*Line 503 - 'AtomPromise.js' */        });

/*Line 505 - 'AtomPromise.js' */        ap.invoke();
/*Line 506 - 'AtomPromise.js' */    });

/*Line 508 - 'AtomPromise.js' */    return p;
/*Line 509 - 'AtomPromise.js' */};

/*Line 511 - 'AtomPromise.js' */AtomPromise.prototype.insertItem = function (index, item, arrayPath) {
/*Line 512 - 'AtomPromise.js' */    return this.then(function (p) {
/*Line 513 - 'AtomPromise.js' */        var v = p.value();
/*Line 514 - 'AtomPromise.js' */        if (v._$_itemInserted)
/*Line 515 - 'AtomPromise.js' */            return;
/*Line 516 - 'AtomPromise.js' */        if (arrayPath) {
/*Line 517 - 'AtomPromise.js' */            v = v[arrayPath];
/*Line 518 - 'AtomPromise.js' */        }
/*Line 519 - 'AtomPromise.js' */        if (index == -1) {
/*Line 520 - 'AtomPromise.js' */            v.push(item);
/*Line 521 - 'AtomPromise.js' */        } else {
/*Line 522 - 'AtomPromise.js' */            v.splice(index || 0, 0, item);
/*Line 523 - 'AtomPromise.js' */        }
/*Line 524 - 'AtomPromise.js' */        v._$_itemInserted = true;        
/*Line 525 - 'AtomPromise.js' */    });
/*Line 526 - 'AtomPromise.js' */};
/*Line 527 - 'AtomPromise.js' *///$setValue = AtomBinder.setValue;
/*Line 528 - 'AtomPromise.js' *///$getValue = AtomBinder.getValue;


/*Line 531 - 'AtomPromise.js' *///Object.prototype.setValue = function (key, value) {
/*Line 532 - 'AtomPromise.js' *///    
/*Line 533 - 'AtomPromise.js' *///    AtomBinder.setValue(this, key, value);
/*Line 534 - 'AtomPromise.js' *///};

/*Line 536 - 'AtomPromise.js' *///Object.prototype.getValue = function (key) {
/*Line 537 - 'AtomPromise.js' *///    return AtomBinder.getValue(this, key);
/*Line 538 - 'AtomPromise.js' *///};

/*Line 540 - 'AtomPromise.js' *///Object.prototype.add_WatchHandler = function(key,handler){
/*Line 541 - 'AtomPromise.js' *///    AtomBinder.add_WatchHandler(this,key,handler);
/*Line 542 - 'AtomPromise.js' *///};

/*Line 544 - 'AtomPromise.js' *///Object.prototype.remove_WatchHandler = function(key,handler){
/*Line 545 - 'AtomPromise.js' *///    AtomBinder.remove_WatchHandler(this,key,handler);
/*Line 546 - 'AtomPromise.js' *///};

/*Line 548 - 'AtomPromise.js' *///Array.prototype.add = function (item) {
/*Line 549 - 'AtomPromise.js' *///    AtomBinder.addItem(this, item);
/*Line 550 - 'AtomPromise.js' *///};

/*Line 552 - 'AtomPromise.js' *///Array.prototype.remove = function (item) {
/*Line 553 - 'AtomPromise.js' *///    AtomBinder.removeItem(this, item);
/*Line 554 - 'AtomPromise.js' *///};

/*Line 556 - 'AtomPromise.js' *///Array.prototype.add_CollectionHandler= function(handler){
/*Line 557 - 'AtomPromise.js' *///    AtomBinder.add_CollectionHandler(this,handler);
/*Line 558 - 'AtomPromise.js' *///};

/*Line 560 - 'AtomPromise.js' *///Array.prototype.remove_CollectionHandler= function(handler){
/*Line 561 - 'AtomPromise.js' *///    AtomBinder.remove_CollectionHandler(this,handler);
...
/*Line 55 - 'AtomUIComponent.js' */            get_isVisible: function () {
/*Line 56 - 'AtomUIComponent.js' */                return this._isVisible;
/*Line 57 - 'AtomUIComponent.js' */            },
/*Line 58 - 'AtomUIComponent.js' */            set_isVisible: function (v) {
/*Line 59 - 'AtomUIComponent.js' */                var element = this.get_element();
/*Line 60 - 'AtomUIComponent.js' */                this._isVisible = v;
/*Line 61 - 'AtomUIComponent.js' */                if (!this._isVisible) {
/*Line 62 - 'AtomUIComponent.js' */                    $(element).hide();
/*Line 63 - 'AtomUIComponent.js' */                } else {
/*Line 64 - 'AtomUIComponent.js' */                    $(element).show();
/*Line 65 - 'AtomUIComponent.js' */                }
/*Line 66 - 'AtomUIComponent.js' */            },

/*Line 68 - 'AtomUIComponent.js' */            getTemplate: function (k) {

/*Line 70 - 'AtomUIComponent.js' */                var t = this["_" + k];
/*Line 71 - 'AtomUIComponent.js' */                if (t !== undefined && t !== null)
/*Line 72 - 'AtomUIComponent.js' */                    return t;

/*Line 74 - 'AtomUIComponent.js' */                // resolve...
/*Line 75 - 'AtomUIComponent.js' */                t = Templates.get(this.constructor, k);
/*Line 76 - 'AtomUIComponent.js' */                if (!t) {
/*Line 77 - 'AtomUIComponent.js' */                    return null;
/*Line 78 - 'AtomUIComponent.js' */                }
/*Line 79 - 'AtomUIComponent.js' */                this["_" + k] = t;
/*Line 80 - 'AtomUIComponent.js' */                return t;
/*Line 81 - 'AtomUIComponent.js' */            }
/*Line 82 - 'AtomUIComponent.js' */        },
/*Line 83 - 'AtomUIComponent.js' */        {
/*Line 84 - 'AtomUIComponent.js' */            next: null,
/*Line 85 - 'AtomUIComponent.js' */            value: undefined
/*Line 86 - 'AtomUIComponent.js' */        });
/*Line 87 - 'AtomUIComponent.js' */})(window, "WebAtoms.AtomUIComponent", WebAtoms.AtomComponent.prototype);


/*Line 90 - 'AtomUIComponent.js' */Templates.compiled = {
/*Line 91 - 'AtomUIComponent.js' */};

/*Line 93 - 'AtomUIComponent.js' */var document = window.document;

/*Line 95 - 'AtomUIComponent.js' */Templates.compileElement = function (e) {
/*Line 96 - 'AtomUIComponent.js' */    var ae = new AtomEnumerator(e);
/*Line 97 - 'AtomUIComponent.js' */    ae.next();
/*Line 98 - 'AtomUIComponent.js' */    var a = ae.current();
/*Line 99 - 'AtomUIComponent.js' */    var e1 = document.createElement(a);
/*Line 100 - 'AtomUIComponent.js' */    if (!ae.next())
/*Line 101 - 'AtomUIComponent.js' */        return e1;
/*Line 102 - 'AtomUIComponent.js' */    a = ae.current();
/*Line 103 - 'AtomUIComponent.js' */    if (a) {
/*Line 104 - 'AtomUIComponent.js' */        for (var k in a) {
/*Line 105 - 'AtomUIComponent.js' */            e1.setAttribute(k, a[k]);
/*Line 106 - 'AtomUIComponent.js' */        }
/*Line 107 - 'AtomUIComponent.js' */    }
    
/*Line 109 - 'AtomUIComponent.js' */    while (ae.next()) {
/*Line 110 - 'AtomUIComponent.js' */        a = ae.current();
/*Line 111 - 'AtomUIComponent.js' */        if (!a)
/*Line 112 - 'AtomUIComponent.js' */            break;
/*Line 113 - 'AtomUIComponent.js' */        if (a.constructor == String) {
/*Line 114 - 'AtomUIComponent.js' */            e1.appendChild(document.createTextNode(a));
/*Line 115 - 'AtomUIComponent.js' */        } else {
/*Line 116 - 'AtomUIComponent.js' */            e1.appendChild(Templates.compileElement(a));
/*Line 117 - 'AtomUIComponent.js' */        }
/*Line 118 - 'AtomUIComponent.js' */    }
/*Line 119 - 'AtomUIComponent.js' */    return e1;
/*Line 120 - 'AtomUIComponent.js' */};

/*Line 122 - 'AtomUIComponent.js' */Templates.compileJsonML = function (j) {

/*Line 124 - 'AtomUIComponent.js' */    if (j.length == 1)
/*Line 125 - 'AtomUIComponent.js' */        return Templates.compileElement(j[0]);

/*Line 127 - 'AtomUIComponent.js' */    var r = [];
/*Line 128 - 'AtomUIComponent.js' */    var ae = new AtomEnumerator(j);
/*Line 129 - 'AtomUIComponent.js' */    while (ae.next()) {
/*Line 130 - 'AtomUIComponent.js' */        r.push(Templates.compileElement(ae.current()));
/*Line 131 - 'AtomUIComponent.js' */    }
/*Line 132 - 'AtomUIComponent.js' */    return r;
/*Line 133 - 'AtomUIComponent.js' */};

/*Line 135 - 'AtomUIComponent.js' */Templates.compile = function (type, name, t) {

/*Line 137 - 'AtomUIComponent.js' */    var div = document.createElement("div");
/*Line 138 - 'AtomUIComponent.js' */    div.innerHTML = t;

/*Line 140 - 'AtomUIComponent.js' */    if ($(div).children().length == 1) {
/*Line 141 - 'AtomUIComponent.js' */        t = AtomUI.cloneNode((div.firstElementChild || div.children[0]));
/*Line 142 - 'AtomUIComponent.js' */    }

/*Line 144 - 'AtomUIComponent.js' */    return t;
/*Line 145 - 'AtomUIComponent.js' */};

/*Line 147 - 'AtomUIComponent.js' */Templates.get = function (type, k) {
/*Line 148 - 'AtomUIComponent.js' */    //var x = this.compileType(type);
/*Line 149 - 'AtomUIComponent.js' */    //return x[k];

/*Line 151 - 'AtomUIComponent.js' */    var name = type.__typeName + "." + k;
/*Line 152 - 'AtomUIComponent.js' */    var x = this.compiled[name];
/*Line 153 - 'AtomUIComponent.js' */    if (x)
/*Line 154 - 'AtomUIComponent.js' */        return x;
/*Line 155 - 'AtomUIComponent.js' */    x = Templates.jsonML[name];
/*Line 156 - 'AtomUIComponent.js' */    if (!x) {
/*Line 157 - 'AtomUIComponent.js' */        if (type.__baseType) {
/*Line 158 - 'AtomUIComponent.js' */            x = Templates.get(type.__baseType, k);
/*Line 159 - 'AtomUIComponent.js' */        }
/*Line 160 - 'AtomUIComponent.js' */    } else {
/*Line 161 - 'AtomUIComponent.js' */        x = Templates.compileJsonML(x);
/*Line 162 - 'AtomUIComponent.js' */    }
/*Line 163 - 'AtomUIComponent.js' */    if (!x)
/*Line 164 - 'AtomUIComponent.js' */        return null;
/*Line 165 - 'AtomUIComponent.js' */    this.compiled[name] = x;
/*Line 166 - 'AtomUIComponent.js' */    return x;

/*Line 168 - 'AtomUIComponent.js' */};

/*Line 170 - 'AtomUIComponent.js' */Templates.compileType = function (type) {

/*Line 172 - 'AtomUIComponent.js' */    var name = type.__typeName;
/*Line 173 - 'AtomUIComponent.js' */    var shortName = name.split(".");
/*Line 174 - 'AtomUIComponent.js' */    shortName = shortName[shortName.length - 1];

/*Line 176 - 'AtomUIComponent.js' */    var x = this.compiled[name];
/*Line 177 - 'AtomUIComponent.js' */    if (x)
/*Line 178 - 'AtomUIComponent.js' */        return x;

/*Line 180 - 'AtomUIComponent.js' */    x = {
/*Line 181 - 'AtomUIComponent.js' */    };

/*Line 183 - 'AtomUIComponent.js' */    var tl = this[name] || this[shortName];
/*Line 184 - 'AtomUIComponent.js' */    if (tl) {
/*Line 185 - 'AtomUIComponent.js' */        for (var t in tl) {
/*Line 186 - 'AtomUIComponent.js' */            x[t] = this.compile(type, t, tl[t]);
/*Line 187 - 'AtomUIComponent.js' */        }
/*Line 188 - 'AtomUIComponent.js' */    }

/*Line 190 - 'AtomUIComponent.js' */    if (type.__baseType) {
/*Line 191 - 'AtomUIComponent.js' */        var y = this.compileType(type.__baseType);
/*Line 192 - 'AtomUIComponent.js' */        for (var yt in y) {
/*Line 193 - 'AtomUIComponent.js' */            if (!x[yt]) {
/*Line 194 - 'AtomUIComponent.js' */                x[yt] = y[yt];
/*Line 195 - 'AtomUIComponent.js' */            }
/*Line 196 - 'AtomUIComponent.js' */        }
/*Line 197 - 'AtomUIComponent.js' */    }

/*Line 199 - 'AtomUIComponent.js' */    this.compiled[name] = x;

/*Line 201 - 'AtomUIComponent.js' */    var t = this;
/*Line 202 - 'AtomUIComponent.js' */    delete t[name];
/*Line 203 - 'AtomUIComponent.js' */    delete t[shortName];

/*Line 205 - 'AtomUIComponent.js' */    return x;
/*Line 206 - 'AtomUIComponent.js' */};
...
/*Line 62 - 'AtomControl.js' */        ctrl.bind(element, key, value, true, null, "keyup,keydown,keypress,blur");
/*Line 63 - 'AtomControl.js' */    }
/*Line 64 - 'AtomControl.js' */};

/*Line 66 - 'AtomControl.js' */// Property Handlers
/*Line 67 - 'AtomControl.js' */var AtomProperties = {
/*Line 68 - 'AtomControl.js' */    any: function (e, v, k) {
/*Line 69 - 'AtomControl.js' */        //$(e).attr(k, v);
/*Line 70 - 'AtomControl.js' */        e.setAttribute(k, v);
/*Line 71 - 'AtomControl.js' */    },
/*Line 72 - 'AtomControl.js' */    isEnabled: function(element,value){
/*Line 73 - 'AtomControl.js' */        if (value) {
/*Line 74 - 'AtomControl.js' */            $(element).removeAttr("disabled");
/*Line 75 - 'AtomControl.js' */        } else {
/*Line 76 - 'AtomControl.js' */            $(element).attr("disabled", "disabled");
/*Line 77 - 'AtomControl.js' */        }
/*Line 78 - 'AtomControl.js' */    },
/*Line 79 - 'AtomControl.js' */    checked: function (element, value) {
/*Line 80 - 'AtomControl.js' */        if (element.checked != value) {
/*Line 81 - 'AtomControl.js' */            element.checked = value ? true : false;
/*Line 82 - 'AtomControl.js' */        }
/*Line 83 - 'AtomControl.js' */    },
/*Line 84 - 'AtomControl.js' */    value: function (element, value) {
/*Line 85 - 'AtomControl.js' */        if (/date|datetime/gi.test(element.type)) {
/*Line 86 - 'AtomControl.js' */            element.valueAsDate = AtomDate.parse(value);
/*Line 87 - 'AtomControl.js' */        } else {
/*Line 88 - 'AtomControl.js' */            $(element).val(value);
/*Line 89 - 'AtomControl.js' */        }
/*Line 90 - 'AtomControl.js' */    },
/*Line 91 - 'AtomControl.js' */    valueAsDate: function (element, value) {
/*Line 92 - 'AtomControl.js' */        element.valueAsDate = AtomDate.parse(value);
/*Line 93 - 'AtomControl.js' */    },
/*Line 94 - 'AtomControl.js' */    text: function (element, value) {
/*Line 95 - 'AtomControl.js' */        //clears everything..
/*Line 96 - 'AtomControl.js' */        element.innerHTML = "";
/*Line 97 - 'AtomControl.js' */        var a = document.createTextNode(value);
/*Line 98 - 'AtomControl.js' */        element.appendChild(a);
/*Line 99 - 'AtomControl.js' */    },
/*Line 100 - 'AtomControl.js' */    html: function (element, value) {
/*Line 101 - 'AtomControl.js' */        element.innerHTML = value;
/*Line 102 - 'AtomControl.js' */    },
/*Line 103 - 'AtomControl.js' */    absPos: function (element, value) {
/*Line 104 - 'AtomControl.js' */        AtomProperties.setPosition(true, element, value);
/*Line 105 - 'AtomControl.js' */    },
/*Line 106 - 'AtomControl.js' */    relPos: function (element, value) {
/*Line 107 - 'AtomControl.js' */        AtomProperties.setPosition(false, element, value);
/*Line 108 - 'AtomControl.js' */    },
/*Line 109 - 'AtomControl.js' */    "class": function (element,value) {
/*Line 110 - 'AtomControl.js' */        if (element.atomClass) {
/*Line 111 - 'AtomControl.js' */            $(element).removeClass(element.atomClass);
/*Line 112 - 'AtomControl.js' */        }
/*Line 113 - 'AtomControl.js' */        if (value) {
/*Line 114 - 'AtomControl.js' */            value = AtomUI.createCss(value);
/*Line 115 - 'AtomControl.js' */            if (value) {
/*Line 116 - 'AtomControl.js' */                $(element).addClass(value);
/*Line 117 - 'AtomControl.js' */            }
/*Line 118 - 'AtomControl.js' */            element.atomClass = value;
/*Line 119 - 'AtomControl.js' */        }
/*Line 120 - 'AtomControl.js' */    },
/*Line 121 - 'AtomControl.js' */    setPosition: function (a, e, val) {
/*Line 122 - 'AtomControl.js' */        var l = val;

/*Line 124 - 'AtomControl.js' */        if (l.constructor == String) {
/*Line 125 - 'AtomControl.js' */            l = eval("[" + l + "]");
/*Line 126 - 'AtomControl.js' */        }

/*Line 128 - 'AtomControl.js' */        e.style.position = a ? 'absolute' : 'relative';

/*Line 130 - 'AtomControl.js' */        var left = l[0];
/*Line 131 - 'AtomControl.js' */        var top = l[1];

/*Line 133 - 'AtomControl.js' */        if (left !== null) {
/*Line 134 - 'AtomControl.js' */            e.style.left = left + "px";
/*Line 135 - 'AtomControl.js' */        }
/*Line 136 - 'AtomControl.js' */        if (top !== null) {
/*Line 137 - 'AtomControl.js' */            e.style.top = top + "px";
/*Line 138 - 'AtomControl.js' */        }
/*Line 139 - 'AtomControl.js' */        if (l.length > 2) {
/*Line 140 - 'AtomControl.js' */            var width = l[2];
/*Line 141 - 'AtomControl.js' */            var height = l[3];
/*Line 142 - 'AtomControl.js' */            if (width !== undefined && width !== null) {
/*Line 143 - 'AtomControl.js' */                e.style.width = width + "px";
/*Line 144 - 'AtomControl.js' */            }
/*Line 145 - 'AtomControl.js' */            if (height !== undefined && height !== null) {
/*Line 146 - 'AtomControl.js' */                e.style.height = height + "px";
/*Line 147 - 'AtomControl.js' */            }
/*Line 148 - 'AtomControl.js' */        }
/*Line 149 - 'AtomControl.js' */    }
/*Line 150 - 'AtomControl.js' */};

/*Line 152 - 'AtomControl.js' */window.AtomProperties = AtomProperties;

/*Line 154 - 'AtomControl.js' */(function (window, name, base) {


/*Line 157 - 'AtomControl.js' */    return classCreatorEx({
/*Line 158 - 'AtomControl.js' */        name: name,
/*Line 159 - 'AtomControl.js' */        base: base,
/*Line 160 - 'AtomControl.js' */        start: function (element) {
/*Line 161 - 'AtomControl.js' */            element.atomControl = this;
/*Line 162 - 'AtomControl.js' */            this._element = element;

/*Line 164 - 'AtomControl.js' */            this.dispatcher = WebAtoms.dispatcher;
/*Line 165 - 'AtomControl.js' */            this.bindings = [];
/*Line 166 - 'AtomControl.js' */            this._isVisible = true;

/*Line 168 - 'AtomControl.js' */            if (element.id && appScope) {
/*Line 169 - 'AtomControl.js' */                appScope[element.id] = this;
/*Line 170 - 'AtomControl.js' */            }
/*Line 171 - 'AtomControl.js' */            AtomUI.assignID(element);

/*Line 173 - 'AtomControl.js' */            allControls[element.id] = this;
/*Line 174 - 'AtomControl.js' */        },
/*Line 175 - 'AtomControl.js' */        properties: {
/*Line 176 - 'AtomControl.js' */            layout: null,
/*Line 177 - 'AtomControl.js' */            loadNext: null,
/*Line 178 - 'AtomControl.js' */            next: null,
/*Line 179 - 'AtomControl.js' */            merge: undefined,
/*Line 180 - 'AtomControl.js' */            value: undefined
/*Line 181 - 'AtomControl.js' */        },
/*Line 182 - 'AtomControl.js' */        methods: {
/*Line 183 - 'AtomControl.js' */            set_merge: function (v) {
/*Line 184 - 'AtomControl.js' */                this._mergeData2 = null;
/*Line 185 - 'AtomControl.js' */                if (!v)
/*Line 186 - 'AtomControl.js' */                    return;
/*Line 187 - 'AtomControl.js' */                var d = v.data;
/*Line 188 - 'AtomControl.js' */                if (d) {
/*Line 189 - 'AtomControl.js' */                    Atom.merge(this.get_data(), d, true);
/*Line 190 - 'AtomControl.js' */                    this._mergeData2 = d;
/*Line 191 - 'AtomControl.js' */                }
/*Line 192 - 'AtomControl.js' */                d = v.scope;
/*Line 193 - 'AtomControl.js' */                if (d) {
/*Line 194 - 'AtomControl.js' */                    Atom.merge(this.get_scope(), d, true);
/*Line 195 - 'AtomControl.js' */                }
/*Line 196 - 'AtomControl.js' */                d = v.appScope;
/*Line 197 - 'AtomControl.js' */                if (d) {
/*Line 198 - 'AtomControl.js' */                    Atom.merge(this.get_appScope(), d, true);
/*Line 199 - 'AtomControl.js' */                }
/*Line 200 - 'AtomControl.js' */                d = v.localScope;
/*Line 201 - 'AtomControl.js' */                if (d) {
/*Line 202 - 'AtomControl.js' */                    Atom.merge(this.get_localScope(), d, true);
/*Line 203 - 'AtomControl.js' */                }
/*Line 204 - 'AtomControl.js' */                d = v.owner;
/*Line 205 - 'AtomControl.js' */                if (d) {
/*Line 206 - 'AtomControl.js' */                    Atom.merge(this,d,true);
/*Line 207 - 'AtomControl.js' */                }

/*Line 209 - 'AtomControl.js' */                var action = (v.timeOut || v.timeout);
/*Line 210 - 'AtomControl.js' */                if (action) {
/*Line 211 - 'AtomControl.js' */                    var _this = this;
/*Line 212 - 'AtomControl.js' */                    var tm = 100;
/*Line 213 - 'AtomControl.js' */                    if (action.hasOwnProperty("length")) {
/*Line 214 - 'AtomControl.js' */                        if (action.length > 1) {
/*Line 215 - 'AtomControl.js' */                            tm = action[0];
/*Line 216 - 'AtomControl.js' */                            action = action[1];
/*Line 217 - 'AtomControl.js' */                        }
/*Line 218 - 'AtomControl.js' */                    }
/*Line 219 - 'AtomControl.js' */                    setTimeout(function () {
/*Line 220 - 'AtomControl.js' */                        _this.set_merge(action);
/*Line 221 - 'AtomControl.js' */                    }, tm);
/*Line 222 - 'AtomControl.js' */                    return;
/*Line 223 - 'AtomControl.js' */                }
/*Line 224 - 'AtomControl.js' */            },
/*Line 225 - 'AtomControl.js' */            invokeAction: function (action, evt) {
/*Line 226 - 'AtomControl.js' */                if (!action)
/*Line 227 - 'AtomControl.js' */                    return;
/*Line 228 - 'AtomControl.js' */                if (action.constructor == String) {
/*Line 229 - 'AtomControl.js' */                    location.href = action;
/*Line 230 - 'AtomControl.js' */                }
/*Line 231 - 'AtomControl.js' */                else {

/*Line 233 - 'AtomControl.js' */                    var f = action;

/*Line 235 - 'AtomControl.js' */                    // is it atomControl?
/*Line 236 - 'AtomControl.js' */                    if (f.atomControl) {
/*Line 237 - 'AtomControl.js' */                        f = f.atomControl;
/*Line 238 - 'AtomControl.js' */                        if (f.refresh) {
/*Line 239 - 'AtomControl.js' */                            f.refresh(this.get_scope(), this);
/*Line 240 - 'AtomControl.js' */                        } else {
/*Line 241 - 'AtomControl.js' */                            Atom.alert("no default action defined");
/*Line 242 - 'AtomControl.js' */                        }
/*Line 243 - 'AtomControl.js' */                    } else {
/*Line 244 - 'AtomControl.js' */                        if (f._element) {
/*Line 245 - 'AtomControl.js' */                            f.refresh(this.get_scope(), this);
/*Line 246 - 'AtomControl.js' */                        } else {

/*Line 248 - 'AtomControl.js' */                            //is it function

/*Line 250 - 'AtomControl.js' */                            if ((typeof f) == 'function') {

/*Line 252 - 'AtomControl.js' */                                // invoke method...
/*Line 253 - 'AtomControl.js' */                                f(this.get_scope(), this, evt);
/*Line 254 - 'AtomControl.js' */                            } else {

/*Line 256 - 'AtomControl.js' */                                // it is an array...
/*Line 257 - 'AtomControl.js' */                                if (f.length) {
/*Line 258 - 'AtomControl.js' */                                    var ae = new AtomEnumerator(f);
/*Line 259 - 'AtomControl.js' */                                    while (ae.next()) {
/*Line 260 - 'AtomControl.js' */                                        this.invokeAction(ae.current(), evt);
/*Line 261 - 'AtomControl.js' */                                    }
/*Line 262 - 'AtomControl.js' */                                    return;
/*Line 263 - 'AtomControl.js' */                                }

/*Line 265 - 'AtomControl.js' */                                // identify scope and actions...
/*Line 266 - 'AtomControl.js' */                                var action = (f.timeOut || f.timeout);
/*Line 267 - 'AtomControl.js' */                                if (action) {
/*Line 268 - 'AtomControl.js' */                                    var _this = this;
/*Line 269 - 'AtomControl.js' */                                    var tm = 100;
/*Line 270 - 'AtomControl.js' */                                    if (action.hasOwnProperty("length")) {
/*Line 271 - 'AtomControl.js' */                                        if (action.length > 1) {
/*Line 272 - 'AtomControl.js' */                                            tm = action[0];
/*Line 273 - 'AtomControl.js' */                                            action = action[1];
/*Line 274 - 'AtomControl.js' */                                        }
/*Line 275 - 'AtomControl.js' */                                    }
/*Line 276 - 'AtomControl.js' */                                    setTimeout(function () {
/*Line 277 - 'AtomControl.js' */                                        _this.invokeAction(action);
/*Line 278 - 'AtomControl.js' */                                    }, tm);
/*Line 279 - 'AtomControl.js' */                                    return;
/*Line 280 - 'AtomControl.js' */                                }
/*Line 281 - 'AtomControl.js' */                                this.set_merge(f);
/*Line 282 - 'AtomControl.js' */                                action = f.confirm;
/*Line 283 - 'AtomControl.js' */                                if (action) {
/*Line 284 - 'AtomControl.js' */                                    var msg = "Are you sure?";
/*Line 285 - 'AtomControl.js' */                                    if (action.hasOwnProperty("length")) {
/*Line 286 - 'AtomControl.js' */                                        if (action.length > 1) {
/*Line 287 - 'AtomControl.js' */                                            msg = action[0];
/*Line 288 - 'AtomControl.js' */                                            action = action[1];
/*Line 289 - 'AtomControl.js' */                                        } else {
/*Line 290 - 'AtomControl.js' */                                            action = action[0];
/*Line 291 - 'AtomControl.js' */                                        }
/*Line 292 - 'AtomControl.js' */                                    }
/*Line 293 - 'AtomControl.js' */                                    var _this = this;
/*Line 294 - 'AtomControl.js' */                                    var _action = action;
/*Line 295 - 'AtomControl.js' */                                    var _evt = evt;
/*Line 296 - 'AtomControl.js' */                                    Atom.confirm(msg, function () {
/*Line 297 - 'AtomControl.js' */                                        _this.invokeAction(_action, _evt);
/*Line 298 - 'AtomControl.js' */                                    });
/*Line 299 - 'AtomControl.js' */                                }
/*Line 300 - 'AtomControl.js' */                                action = f.alert;
/*Line 301 - 'AtomControl.js' */                                if (action) {
/*Line 302 - 'AtomControl.js' */                                    Atom.alert(action);
/*Line 303 - 'AtomControl.js' */                                }
/*Line 304 - 'AtomControl.js' */                                action = f.next;
/*Line 305 - 'AtomControl.js' */                                if (action) {
/*Line 306 - 'AtomControl.js' */                                    this.invokeAction(action, evt);
/*Line 307 - 'AtomControl.js' */                                    return;
/*Line 308 - 'AtomControl.js' */                                }
/*Line 309 - 'AtomControl.js' */                                action = f.control;
/*Line 310 - 'AtomControl.js' */                                if (action) {
/*Line 311 - 'AtomControl.js' */                                    allControls[action].refresh();
/*Line 312 - 'AtomControl.js' */                                }

/*Line 314 - 'AtomControl.js' */                            }
/*Line 315 - 'AtomControl.js' */                        }
/*Line 316 - 'AtomControl.js' */                    }
/*Line 317 - 'AtomControl.js' */                }
/*Line 318 - 'AtomControl.js' */            },

/*Line 320 - 'AtomControl.js' */            refresh: function () {
/*Line 321 - 'AtomControl.js' */                // invoke some default action...!!!
/*Line 322 - 'AtomControl.js' */            },

/*Line 324 - 'AtomControl.js' */            get_element: function () {
/*Line 325 - 'AtomControl.js' */                return this._element;
/*Line 326 - 'AtomControl.js' */            },

/*Line 328 - 'AtomControl.js' */            clearBinding: function (element, key) {
/*Line 329 - 'AtomControl.js' */                var ae = new AtomEnumerator(this.bindings);
/*Line 330 - 'AtomControl.js' */                var item;
/*Line 331 - 'AtomControl.js' */                var removed = [];
/*Line 332 - 'AtomControl.js' */                while (ae.next()) {
/*Line 333 - 'AtomControl.js' */                    item = ae.current();
/*Line 334 - 'AtomControl.js' */                    if (element && item.element != element)
/*Line 335 - 'AtomControl.js' */                        continue;
/*Line 336 - 'AtomControl.js' */                    if (key && item.key != key)
/*Line 337 - 'AtomControl.js' */                        continue;
/*Line 338 - 'AtomControl.js' */                    //this.bindings.splice(ae.currentIndex(), 1);
/*Line 339 - 'AtomControl.js' */                    item.dispose();
/*Line 340 - 'AtomControl.js' */                    removed.push(item);
/*Line 341 - 'AtomControl.js' */                }
/*Line 342 - 'AtomControl.js' */                ae = new AtomEnumerator(removed);
/*Line 343 - 'AtomControl.js' */                while (ae.next()) {
/*Line 344 - 'AtomControl.js' */                    AtomArray.remove(this.bindings, ae.current());
/*Line 345 - 'AtomControl.js' */                }
/*Line 346 - 'AtomControl.js' */            },
/*Line 347 - 'AtomControl.js' */            addBinding: function (target, element, key, path, twoWays, jq, valueFunction, events) {
/*Line 348 - 'AtomControl.js' */                this.clearBinding(element, key);
/*Line 349 - 'AtomControl.js' */                var ab = new WebAtoms.AtomBinding(target, element, key, path, twoWays, jq, valueFunction, events);
/*Line 350 - 'AtomControl.js' */                this.bindings.push(ab);
/*Line 351 - 'AtomControl.js' */                ab.setup();
/*Line 352 - 'AtomControl.js' */            },

/*Line 354 - 'AtomControl.js' */            get_atomParent: function (element) {
/*Line 355 - 'AtomControl.js' */                if (element == null) {
/*Line 356 - 'AtomControl.js' */                    if (this._element._logicalParent || this._element.parentNode)
/*Line 357 - 'AtomControl.js' */                        element = this._element._logicalParent || this._element.parentNode;
/*Line 358 - 'AtomControl.js' */                    else
/*Line 359 - 'AtomControl.js' */                        return null;
/*Line 360 - 'AtomControl.js' */                }
/*Line 361 - 'AtomControl.js' */                if (element.atomControl) {
/*Line 362 - 'AtomControl.js' */                    return element.atomControl;
/*Line 363 - 'AtomControl.js' */                }
/*Line 364 - 'AtomControl.js' */                if (element === document || element === window || !element.parentNode)
/*Line 365 - 'AtomControl.js' */                    return null;
/*Line 366 - 'AtomControl.js' */                return this.get_atomParent(element._logicalParent || element.parentNode);
/*Line 367 - 'AtomControl.js' */            },

/*Line 369 - 'AtomControl.js' */            get_templateParent: function (element) {
/*Line 370 - 'AtomControl.js' */                if (!element) {
/*Line 371 - 'AtomControl.js' */                    element = this._element;
/*Line 372 - 'AtomControl.js' */                }
/*Line 373 - 'AtomControl.js' */                if (element._templateParent) {
/*Line 374 - 'AtomControl.js' */                    return element._templateParent;
/*Line 375 - 'AtomControl.js' */                }
/*Line 376 - 'AtomControl.js' */                var p = element._logicalParent || element.parentNode;
/*Line 377 - 'AtomControl.js' */                if (!p)
/*Line 378 - 'AtomControl.js' */                    throw new Error("Could not find templateParent");
/*Line 379 - 'AtomControl.js' */                return this.get_templateParent(element._logicalParent || element.parentNode);
/*Line 380 - 'AtomControl.js' */            },

/*Line 382 - 'AtomControl.js' */            get_data: function () {
/*Line 383 - 'AtomControl.js' */                if (this._data === undefined) {
/*Line 384 - 'AtomControl.js' */                    // get parent...
/*Line 385 - 'AtomControl.js' */                    var ap = this.get_atomParent(this._element._logicalParent || this._element.parentNode);
/*Line 386 - 'AtomControl.js' */                    if (ap)
/*Line 387 - 'AtomControl.js' */                        return ap.get_data();
/*Line 388 - 'AtomControl.js' */                }
/*Line 389 - 'AtomControl.js' */                return this._data;
/*Line 390 - 'AtomControl.js' */            },
/*Line 391 - 'AtomControl.js' */            set_data: function (d) {
/*Line 392 - 'AtomControl.js' */                this._data = d;
/*Line 393 - 'AtomControl.js' */                this.mergeData();
/*Line 394 - 'AtomControl.js' */                // update child references...
/*Line 395 - 'AtomControl.js' */                this.updateChildBindings(this._element);
/*Line 396 - 'AtomControl.js' */            },

/*Line 398 - 'AtomControl.js' */            mergeData: function () {
/*Line 399 - 'AtomControl.js' */                if (!this._mergeData2)
/*Line 400 - 'AtomControl.js' */                    return;
/*Line 401 - 'AtomControl.js' */                Atom.merge(this.get_data(), this._mergeData2, true);
/*Line 402 - 'AtomControl.js' */            },

/*Line 404 - 'AtomControl.js' */            updateChildBindings: function (element) {
/*Line 405 - 'AtomControl.js' */                var ae = new ChildEnumerator(element);
/*Line 406 - 'AtomControl.js' */                while (ae.next()) {
/*Line 407 - 'AtomControl.js' */                    var child = ae.current();
/*Line 408 - 'AtomControl.js' */                    if (child.atomControl && child.atomControl._created) {
/*Line 409 - 'AtomControl.js' */                        var ctrl = child.atomControl;
/*Line 410 - 'AtomControl.js' */                        if (ctrl._data !== undefined)
/*Line 411 - 'AtomControl.js' */                            continue;
/*Line 412 - 'AtomControl.js' */                        AtomBinder.refreshValue(ctrl, "data");
/*Line 413 - 'AtomControl.js' */                        ctrl.mergeData();
/*Line 414 - 'AtomControl.js' */                    }
/*Line 415 - 'AtomControl.js' */                    this.updateChildBindings(child);
/*Line 416 - 'AtomControl.js' */                }
/*Line 417 - 'AtomControl.js' */            },

/*Line 419 - 'AtomControl.js' */            initializeProperties: function () {

/*Line 421 - 'AtomControl.js' */                if (this._disposed)
/*Line 422 - 'AtomControl.js' */                    return;

/*Line 424 - 'AtomControl.js' */                //// initialize properties...
/*Line 425 - 'AtomControl.js' */                var element = this.get_element();

/*Line 427 - 'AtomControl.js' */                this.setProperties(element);
/*Line 428 - 'AtomControl.js' */                this._created = true;
/*Line 429 - 'AtomControl.js' */                this.onCreationComplete();
/*Line 430 - 'AtomControl.js' */                this.onLoaded();
/*Line 431 - 'AtomControl.js' */            },


/*Line 434 - 'AtomControl.js' */            createChildren: function () {

/*Line 436 - 'AtomControl.js' */                this.onCreateChildren(this._element);

/*Line 438 - 'AtomControl.js' */                var t = this.getTemplate("template");

/*Line 440 - 'AtomControl.js' */                if (t) {
/*Line 441 - 'AtomControl.js' */                    if ($(this._element).children().length == 0) {
/*Line 442 - 'AtomControl.js' */                        if (t.constructor == String) {
/*Line 443 - 'AtomControl.js' */                            this._element.innerHTML = t;
/*Line 444 - 'AtomControl.js' */                            var caller = this;
/*Line 445 - 'AtomControl.js' */                            $(this._element).children().each(function () {
/*Line 446 - 'AtomControl.js' */                                this._templateParent = caller;
/*Line 447 - 'AtomControl.js' */                            });
/*Line 448 - 'AtomControl.js' */                        } else {
/*Line 449 - 'AtomControl.js' */                            //this._element.innerHTML = this._template;
/*Line 450 - 'AtomControl.js' */                            if (AtomUI.isNode(t)) {
/*Line 451 - 'AtomControl.js' */                                t = AtomUI.cloneNode(t);
/*Line 452 - 'AtomControl.js' */                                t._templateParent = this;
/*Line 453 - 'AtomControl.js' */                                this._element.appendChild(t);
/*Line 454 - 'AtomControl.js' */                            } else {
/*Line 455 - 'AtomControl.js' */                                // should be an array...
/*Line 456 - 'AtomControl.js' */                                var ae = new AtomEnumerator(t);
/*Line 457 - 'AtomControl.js' */                                while (ae.next()) {
/*Line 458 - 'AtomControl.js' */                                    var tc = ae.current();
/*Line 459 - 'AtomControl.js' */                                    tc = AtomUI.cloneNode(tc);
/*Line 460 - 'AtomControl.js' */                                    tc._templateParent = this;
/*Line 461 - 'AtomControl.js' */                                    this._element.appendChild(tc);
/*Line 462 - 'AtomControl.js' */                                }
/*Line 463 - 'AtomControl.js' */                            }
/*Line 464 - 'AtomControl.js' */                        }
/*Line 465 - 'AtomControl.js' */                        this.onCreateChildren(this._element);
/*Line 466 - 'AtomControl.js' */                    }
/*Line 467 - 'AtomControl.js' */                }
/*Line 468 - 'AtomControl.js' */            },


/*Line 471 - 'AtomControl.js' */            onCreateChildren: function (element) {

/*Line 473 - 'AtomControl.js' */                var ae = new ChildEnumerator(element);
/*Line 474 - 'AtomControl.js' */                var child;
/*Line 475 - 'AtomControl.js' */                while (ae.next()) {
/*Line 476 - 'AtomControl.js' */                    child = ae.current();

/*Line 478 - 'AtomControl.js' */                    var amap = AtomUI.attributeMap(child, /^atom\-(template|presenter|type|template\-name)$/gi);

/*Line 480 - 'AtomControl.js' */                    var t = amap["atom-template"];
/*Line 481 - 'AtomControl.js' */                    if (t) {
/*Line 482 - 'AtomControl.js' */                        child.removeAttributeNode(t.node);
/*Line 483 - 'AtomControl.js' */                        element.templateOwner = true;
/*Line 484 - 'AtomControl.js' */                        this["_" + t.value] = child;
/*Line 485 - 'AtomControl.js' */                        element.removeChild(child);
/*Line 486 - 'AtomControl.js' */                        continue;
/*Line 487 - 'AtomControl.js' */                    }

/*Line 489 - 'AtomControl.js' */                    var tn = amap["atom-template-name"];
/*Line 490 - 'AtomControl.js' */                    if (tn) {
/*Line 491 - 'AtomControl.js' */                        child.removeAttributeNode(tn.node);
/*Line 492 - 'AtomControl.js' */                        this._scopeTemplates = this._scopeTemplates || {};
/*Line 493 - 'AtomControl.js' */                        this._scopeTemplates[tn.value] = child;
/*Line 494 - 'AtomControl.js' */                        element.removeChild(child);
/*Line 495 - 'AtomControl.js' */                        continue;
/*Line 496 - 'AtomControl.js' */                    }

/*Line 498 - 'AtomControl.js' */                    var p = amap["atom-presenter"];
/*Line 499 - 'AtomControl.js' */                    if (p) {
/*Line 500 - 'AtomControl.js' */                        // search upwords for expected presenter...
/*Line 501 - 'AtomControl.js' */                        var owner = AtomUI.getPresenterOwner(this, p.value);
/*Line 502 - 'AtomControl.js' */                        owner["_" + p.value] = child;
/*Line 503 - 'AtomControl.js' */                    }

/*Line 505 - 'AtomControl.js' */                    var childType = amap["atom-type"];

/*Line 507 - 'AtomControl.js' */                    if (childType) {
/*Line 508 - 'AtomControl.js' */                        AtomUI.createControl(child, childType.value);
/*Line 509 - 'AtomControl.js' */                        //element.removeAttributeNode(childType.node);
/*Line 510 - 'AtomControl.js' */                    } else {
/*Line 511 - 'AtomControl.js' */                        this.onCreateChildren(child);
/*Line 512 - 'AtomControl.js' */                    }
/*Line 513 - 'AtomControl.js' */                }
/*Line 514 - 'AtomControl.js' */            },

/*Line 516 - 'AtomControl.js' */            onLoaded: function () {
/*Line 517 - 'AtomControl.js' */            },

/*Line 519 - 'AtomControl.js' */            onUpdateUI: function () {
/*Line 520 - 'AtomControl.js' */                if (this._layout) {
/*Line 521 - 'AtomControl.js' */                    this._layout.doLayout(this._element);
/*Line 522 - 'AtomControl.js' */                } else {
/*Line 523 - 'AtomControl.js' */                    this.updateChildUI(this.get_element());
/*Line 524 - 'AtomControl.js' */                }
/*Line 525 - 'AtomControl.js' */            },

/*Line 527 - 'AtomControl.js' */            updateUI: function () {
/*Line 528 - 'AtomControl.js' */                var ctrl = this;
/*Line 529 - 'AtomControl.js' */                this.dispatcher.callLater(function () {
/*Line 530 - 'AtomControl.js' */                    ctrl.onUpdateUI();
/*Line 531 - 'AtomControl.js' */                });
/*Line 532 - 'AtomControl.js' */            },

/*Line 534 - 'AtomControl.js' */            updateChildUI: function (parent) {
/*Line 535 - 'AtomControl.js' */                if (!parent)
/*Line 536 - 'AtomControl.js' */                    parent = this._element;
/*Line 537 - 'AtomControl.js' */                var ae = new ChildEnumerator(parent);
/*Line 538 - 'AtomControl.js' */                while (ae.next()) {
/*Line 539 - 'AtomControl.js' */                    var child = ae.current();
/*Line 540 - 'AtomControl.js' */                    if (child.atomControl) {
/*Line 541 - 'AtomControl.js' */                        child.atomControl.updateUI();
/*Line 542 - 'AtomControl.js' */                        continue;
/*Line 543 - 'AtomControl.js' */                    }
/*Line 544 - 'AtomControl.js' */                    this.updateChildUI(child);
/*Line 545 - 'AtomControl.js' */                }
/*Line 546 - 'AtomControl.js' */            },

/*Line 548 - 'AtomControl.js' */            onCreationComplete: function () {
/*Line 549 - 'AtomControl.js' */                this.updateUI();
/*Line 550 - 'AtomControl.js' */            },

/*Line 552 - 'AtomControl.js' */            setProperties: function (element) {


/*Line 555 - 'AtomControl.js' */                var obj;
/*Line 556 - 'AtomControl.js' */                var key;
/*Line 557 - 'AtomControl.js' */                var value;
/*Line 558 - 'AtomControl.js' */                var fn;
/*Line 559 - 'AtomControl.js' */                var at;

/*Line 561 - 'AtomControl.js' */                var attr = element.attributes;
/*Line 562 - 'AtomControl.js' */                var ae = new AtomEnumerator(attr);

/*Line 564 - 'AtomControl.js' */                var remove = [];

/*Line 566 - 'AtomControl.js' */                var nodeValue = "value";
/*Line 567 - 'AtomControl.js' */                if (AtomBrowser.isIE && AtomBrowser.majorVersion < 9) {
/*Line 568 - 'AtomControl.js' */                    nodeValue = "nodeValue";
/*Line 569 - 'AtomControl.js' */                }

/*Line 571 - 'AtomControl.js' */                var bindList = {};

/*Line 573 - 'AtomControl.js' */                while (ae.next()) {
/*Line 574 - 'AtomControl.js' */                    at = ae.current();
/*Line 575 - 'AtomControl.js' */                    key = at.nodeName;
/*Line 576 - 'AtomControl.js' */                    value = at[nodeValue];
/*Line 577 - 'AtomControl.js' */                    if (/^atomControl$/g.test(key)) {
/*Line 578 - 'AtomControl.js' */                        continue;
/*Line 579 - 'AtomControl.js' */                    }
/*Line 580 - 'AtomControl.js' */                    if (/^atom\-type$/.test(key)) {
/*Line 581 - 'AtomControl.js' */                        remove.push(at);
/*Line 582 - 'AtomControl.js' */                        continue;
/*Line 583 - 'AtomControl.js' */                    }
/*Line 584 - 'AtomControl.js' */                    if (!(/^(atom|bind|style|event)\-/g.test(key)))
/*Line 585 - 'AtomControl.js' */                        continue;
/*Line 586 - 'AtomControl.js' */                    if (!(/^(style|event)\-/g.test(key)))
/*Line 587 - 'AtomControl.js' */                        key = key.substr(5);

/*Line 589 - 'AtomControl.js' */                    if (!value)
/*Line 590 - 'AtomControl.js' */                        continue;

/*Line 592 - 'AtomControl.js' */                    if (!/(^style$|dock)/.test(key)) {
/*Line 593 - 'AtomControl.js' */                        remove.push(at);
/*Line 594 - 'AtomControl.js' */                    }

/*Line 596 - 'AtomControl.js' */                    // rename key...
/*Line 597 - 'AtomControl.js' */                    key = $.camelCase(key);

/*Line 599 - 'AtomControl.js' */                    bindList[key] = value;

/*Line 601 - 'AtomControl.js' */                }

/*Line 603 - 'AtomControl.js' */                // Since setValue may add up new attributes
/*Line 604 - 'AtomControl.js' */                // We set value after we have collected attribute list
/*Line 605 - 'AtomControl.js' */                for (key in bindList) {
/*Line 606 - 'AtomControl.js' */                    this.setValue(key, bindList[key], true, element);
/*Line 607 - 'AtomControl.js' */                }

/*Line 609 - 'AtomControl.js' */                ae = new AtomEnumerator(remove);
/*Line 610 - 'AtomControl.js' */                while (ae.next()) {
/*Line 611 - 'AtomControl.js' */                    //$(element).removeAttr(ae.current().nodeName);
/*Line 612 - 'AtomControl.js' */                    element.removeAttributeNode(ae.current());
/*Line 613 - 'AtomControl.js' */                }

/*Line 615 - 'AtomControl.js' */                var child = new ChildEnumerator(element);
/*Line 616 - 'AtomControl.js' */                while (child.next()) {
/*Line 617 - 'AtomControl.js' */                    var childItem = child.current();
/*Line 618 - 'AtomControl.js' */                    if (childItem.atomControl)
/*Line 619 - 'AtomControl.js' */                        continue;
/*Line 620 - 'AtomControl.js' */                    this.setProperties(childItem);
/*Line 621 - 'AtomControl.js' */                }

/*Line 623 - 'AtomControl.js' */            },

/*Line 625 - 'AtomControl.js' */            setValue: function (key, value, bind, element) {
/*Line 626 - 'AtomControl.js' */                if (value && value.constructor == String) {

/*Line 628 - 'AtomControl.js' */                    var s = value[0];

/*Line 630 - 'AtomControl.js' */                    var f = AtomBinders[s];
/*Line 631 - 'AtomControl.js' */                    if (f) {
/*Line 632 - 'AtomControl.js' */                        f(this, key, value, element);
/*Line 633 - 'AtomControl.js' */                        return;
/*Line 634 - 'AtomControl.js' */                    }

/*Line 636 - 'AtomControl.js' */                    s += value[1];
/*Line 637 - 'AtomControl.js' */                    f = AtomBinders[s];
/*Line 638 - 'AtomControl.js' */                    if (f) {
/*Line 639 - 'AtomControl.js' */                        f(this, key, value, element);
/*Line 640 - 'AtomControl.js' */                        return;
/*Line 641 - 'AtomControl.js' */                    }

/*Line 643 - 'AtomControl.js' */                }

/*Line 645 - 'AtomControl.js' */                this.setLocalValue(key, value, element);
/*Line 646 - 'AtomControl.js' */            },

/*Line 648 - 'AtomControl.js' */            setLocalValue: function (key, value, element, refresh) {

/*Line 650 - 'AtomControl.js' */                // undefined can never be set
/*Line 651 - 'AtomControl.js' */                if (value === undefined)
/*Line 652 - 'AtomControl.js' */                    return;

/*Line 654 - 'AtomControl.js' */                if (value && value instanceof AtomPromise) {

/*Line 656 - 'AtomControl.js' */                    element._promisesQueue = element._promisesQueue || {};

/*Line 658 - 'AtomControl.js' */                    var op = element._promisesQueue[key];
/*Line 659 - 'AtomControl.js' */                    if (op) {
/*Line 660 - 'AtomControl.js' */                        op.abort();
/*Line 661 - 'AtomControl.js' */                    }
/*Line 662 - 'AtomControl.js' */                    element._promisesQueue[key] = value;

/*Line 664 - 'AtomControl.js' */                    if (value._persist) {

/*Line 666 - 'AtomControl.js' */                        // is it a promise?
/*Line 667 - 'AtomControl.js' */                        this._promises = this._promises || {};

/*Line 669 - 'AtomControl.js' */                        // cache promise...
/*Line 670 - 'AtomControl.js' */                        this._promises[key] = value;


/*Line 673 - 'AtomControl.js' */                    }

/*Line 675 - 'AtomControl.js' */                    var caller = this;

/*Line 677 - 'AtomControl.js' */                    value.then(function (p) {

/*Line 679 - 'AtomControl.js' */                        if (element._promisesQueue[key] == p) {
/*Line 680 - 'AtomControl.js' */                            element._promisesQueue[key] = null;
/*Line 681 - 'AtomControl.js' */                        }

/*Line 683 - 'AtomControl.js' */                        element._promisesQueue[key] = null;

/*Line 685 - 'AtomControl.js' */                        caller.setLocalValue(key, p.value(), element, true);

/*Line 687 - 'AtomControl.js' */                        if (caller._loadNext) {
/*Line 688 - 'AtomControl.js' */                            caller.invokeAction(caller._loadNext);
/*Line 689 - 'AtomControl.js' */                        }
/*Line 690 - 'AtomControl.js' */                    });

/*Line 692 - 'AtomControl.js' */                    value.failed(function (p) {
/*Line 693 - 'AtomControl.js' */                        if (element._promisesQueue[key] == p) {
/*Line 694 - 'AtomControl.js' */                            element._promisesQueue[key] = null;
/*Line 695 - 'AtomControl.js' */                        }
/*Line 696 - 'AtomControl.js' */                    });

/*Line 698 - 'AtomControl.js' */                    value.invoke();
/*Line 699 - 'AtomControl.js' */                    return;

/*Line 701 - 'AtomControl.js' */                }

/*Line 703 - 'AtomControl.js' */                if (this._element == element) {
/*Line 704 - 'AtomControl.js' */                    var fn = this["set_" + key];
/*Line 705 - 'AtomControl.js' */                    if (fn != null) {
/*Line 706 - 'AtomControl.js' */                        if (refresh) {
/*Line 707 - 'AtomControl.js' */                            // checking old value is necessary
/*Line 708 - 'AtomControl.js' */                            // as two way binding may cause recursive
/*Line 709 - 'AtomControl.js' */                            // updates
/*Line 710 - 'AtomControl.js' */                            var oldValue = AtomBinder.getValue(this, key);
/*Line 711 - 'AtomControl.js' */                            if (oldValue == value)
/*Line 712 - 'AtomControl.js' */                                return;
/*Line 713 - 'AtomControl.js' */                        }
/*Line 714 - 'AtomControl.js' */                        fn.apply(this, [value]);
/*Line 715 - 'AtomControl.js' */                        if (refresh) {
/*Line 716 - 'AtomControl.js' */                            AtomBinder.refreshValue(this, key);
/*Line 717 - 'AtomControl.js' */                        }
/*Line 718 - 'AtomControl.js' */                        return;
/*Line 719 - 'AtomControl.js' */                    }
/*Line 720 - 'AtomControl.js' */                }

/*Line 722 - 'AtomControl.js' */                if (/^style/g.test(key) && key.length > 5) {
/*Line 723 - 'AtomControl.js' */                    var k = key.substr(5);
/*Line 724 - 'AtomControl.js' */                    k = String.fromCharCode(k.charCodeAt(0)).toLowerCase() + k.substr(1);
/*Line 725 - 'AtomControl.js' */                    element.style[k] = value;
/*Line 726 - 'AtomControl.js' */                    return;
/*Line 727 - 'AtomControl.js' */                }

/*Line 729 - 'AtomControl.js' */                if (/^event/g.test(key) && key.length > 5) {
/*Line 730 - 'AtomControl.js' */                    var k = key.substr(5);
/*Line 731 - 'AtomControl.js' */                    k = String.fromCharCode(k.charCodeAt(0)).toLowerCase() + k.substr(1);
/*Line 732 - 'AtomControl.js' */                    var _this = this;
/*Line 733 - 'AtomControl.js' */                    // unbind previous event...
/*Line 734 - 'AtomControl.js' */                    this.unbindEvent(element, k);
/*Line 735 - 'AtomControl.js' */                    this.bindEvent(element, k, null, null, function (evt) {
/*Line 736 - 'AtomControl.js' */                        _this.invokeAction(value, evt);
/*Line 737 - 'AtomControl.js' */                    });
/*Line 738 - 'AtomControl.js' */                    return;
/*Line 739 - 'AtomControl.js' */                }

/*Line 741 - 'AtomControl.js' */                var f = AtomProperties[key] || AtomProperties.any;
/*Line 742 - 'AtomControl.js' */                if (f) {
/*Line 743 - 'AtomControl.js' */                    f(element || this._element, value, key);
/*Line 744 - 'AtomControl.js' */                }

/*Line 746 - 'AtomControl.js' */            },

/*Line 748 - 'AtomControl.js' */            bind: function (element, key, value, twoWays, vf, events) {

/*Line 750 - 'AtomControl.js' */                if (value == null) {
/*Line 751 - 'AtomControl.js' */                    // remove existing binding...
/*Line 752 - 'AtomControl.js' */                    this.clearBinding(element, key);
/*Line 753 - 'AtomControl.js' */                    return;
/*Line 754 - 'AtomControl.js' */                }

/*Line 756 - 'AtomControl.js' */                var target = this;
/*Line 757 - 'AtomControl.js' */                if (value && value.constructor == String && /^window\./g.test(value)) {
/*Line 758 - 'AtomControl.js' */                    target = window;
/*Line 759 - 'AtomControl.js' */                }

/*Line 761 - 'AtomControl.js' */                var thisElement = this.get_element();

/*Line 763 - 'AtomControl.js' */                var jq = thisElement != element;

/*Line 765 - 'AtomControl.js' */                if (!jq) {
/*Line 766 - 'AtomControl.js' */                    var f = this["get_" + key];
/*Line 767 - 'AtomControl.js' */                    if (f == undefined || f == null) {
/*Line 768 - 'AtomControl.js' */                        jq = true;
/*Line 769 - 'AtomControl.js' */                    }
/*Line 770 - 'AtomControl.js' */                }

/*Line 772 - 'AtomControl.js' */                switch (key) {
/*Line 773 - 'AtomControl.js' */                    case "value":
/*Line 774 - 'AtomControl.js' */                        if (/input/gi.test(element.nodeName)) { jq = true; }
/*Line 775 - 'AtomControl.js' */                        this.addBinding(target, element, "value", value, twoWays, jq, vf, events);
/*Line 776 - 'AtomControl.js' */                        break;
/*Line 777 - 'AtomControl.js' */                    case "text":
/*Line 778 - 'AtomControl.js' */                        this.addBinding(target, element, "text", value, false, true, vf, events);
/*Line 779 - 'AtomControl.js' */                        break;
/*Line 780 - 'AtomControl.js' */                    default:
/*Line 781 - 'AtomControl.js' */                        this.addBinding(target, element, key, value, twoWays, jq, vf, events);
/*Line 782 - 'AtomControl.js' */                        break;
/*Line 783 - 'AtomControl.js' */                }

/*Line 785 - 'AtomControl.js' */            },

/*Line 787 - 'AtomControl.js' */            initializationComplete: function () {
/*Line 788 - 'AtomControl.js' */            },

/*Line 790 - 'AtomControl.js' */            initialize: function () {

/*Line 792 - 'AtomControl.js' */                // first remove all templates ...
/*Line 793 - 'AtomControl.js' */                base.initialize.apply(this, arguments);

/*Line 795 - 'AtomControl.js' */                // initialize properties...
/*Line 796 - 'AtomControl.js' */                var element = this.get_element();

/*Line 798 - 'AtomControl.js' */                var amap = AtomUI.attributeMap(element, /^atom\-(name|local\-scope)$/gi);

/*Line 800 - 'AtomControl.js' */                var ls = amap["atom-name"];
/*Line 801 - 'AtomControl.js' */                if (ls) {
/*Line 802 - 'AtomControl.js' */                    if (/^(app|window|owner|scope|localScope|parent)$/gi.test(ls.value))
/*Line 803 - 'AtomControl.js' */                        throw new Error("Invalid Control Name '" + ls.value + "'");
/*Line 804 - 'AtomControl.js' */                    var s = this.get_scope();
/*Line 805 - 'AtomControl.js' */                    AtomBinder.setValue(s, ls.value, this);
/*Line 806 - 'AtomControl.js' */                    this._name = ls.value;
/*Line 807 - 'AtomControl.js' */                    element.removeAttributeNode(ls.node);
/*Line 808 - 'AtomControl.js' */                }


/*Line 811 - 'AtomControl.js' */                ls = amap["atom-local-scope"];
/*Line 812 - 'AtomControl.js' */                if (ls) {
/*Line 813 - 'AtomControl.js' */                    this._localScope = new AtomScope(this, this.get_scope(), atomApplication);
/*Line 814 - 'AtomControl.js' */                    this._scope = this._localScope;
/*Line 815 - 'AtomControl.js' */                    if (this._name) {
/*Line 816 - 'AtomControl.js' */                        this._localScope[this._name] = this;
/*Line 817 - 'AtomControl.js' */                    }
/*Line 818 - 'AtomControl.js' */                    element.removeAttributeNode(ls.node);
/*Line 819 - 'AtomControl.js' */                }

/*Line 821 - 'AtomControl.js' */                // scope is now ready, set scopeTemplates...
/*Line 822 - 'AtomControl.js' */                var st = this._scopeTemplates;
/*Line 823 - 'AtomControl.js' */                if (st) {
/*Line 824 - 'AtomControl.js' */                    var s = this.get_scope();
/*Line 825 - 'AtomControl.js' */                    for (var i in st) {
/*Line 826 - 'AtomControl.js' */                        var t = st[i];
/*Line 827 - 'AtomControl.js' */                        AtomBinder.setValue(s, i, t);
/*Line 828 - 'AtomControl.js' */                    }
/*Line 829 - 'AtomControl.js' */                    //try {
/*Line 830 - 'AtomControl.js' */                    //    delete this._scopeTemplates;
/*Line 831 - 'AtomControl.js' */                    //} catch (exx) {

/*Line 833 - 'AtomControl.js' */                    //}
/*Line 834 - 'AtomControl.js' */                }

/*Line 836 - 'AtomControl.js' */                //var fn = Function.createDelegate(this, this.initializeProperties);
/*Line 837 - 'AtomControl.js' */                var _this = this;
/*Line 838 - 'AtomControl.js' */                WebAtoms.dispatcher.callLater(function () {
/*Line 839 - 'AtomControl.js' */                    _this.initializeProperties();
/*Line 840 - 'AtomControl.js' */                });

/*Line 842 - 'AtomControl.js' */                // initialize every children..
/*Line 843 - 'AtomControl.js' */                this.initializeChildren(this._element);

/*Line 845 - 'AtomControl.js' */                //fn = Function.createDelegate(this, this.initializationComplete);
/*Line 846 - 'AtomControl.js' */                WebAtoms.dispatcher.callLater(function () {
/*Line 847 - 'AtomControl.js' */                    _this.initializationComplete();
/*Line 848 - 'AtomControl.js' */                });
/*Line 849 - 'AtomControl.js' */            },


/*Line 852 - 'AtomControl.js' */            dispose: function (e) {

/*Line 854 - 'AtomControl.js' */                // disposing only one element
/*Line 855 - 'AtomControl.js' */                if (e) {
/*Line 856 - 'AtomControl.js' */                    var eac = e.atomControl;
/*Line 857 - 'AtomControl.js' */                    if (eac) {
/*Line 858 - 'AtomControl.js' */                        eac.dispose();
/*Line 859 - 'AtomControl.js' */                    } else {
/*Line 860 - 'AtomControl.js' */                        this.clearBinding(e);
/*Line 861 - 'AtomControl.js' */                        this.disposeChildren(e);
/*Line 862 - 'AtomControl.js' */                    }
/*Line 863 - 'AtomControl.js' */                    $(e).remove();
/*Line 864 - 'AtomControl.js' */                    return;
/*Line 865 - 'AtomControl.js' */                }

/*Line 867 - 'AtomControl.js' */                this._disposed = true;
/*Line 868 - 'AtomControl.js' */                this.disposeChildren(this._element);
/*Line 869 - 'AtomControl.js' */                this.clearBinding();
/*Line 870 - 'AtomControl.js' */                this.bindings.length = 0;
/*Line 871 - 'AtomControl.js' */                //WebAtoms.AtomControl.callBaseMethod(this, "dispose");
/*Line 872 - 'AtomControl.js' */                base.dispose.apply(this, arguments);
/*Line 873 - 'AtomControl.js' */            },


/*Line 876 - 'AtomControl.js' */            disposeChildren: function (e) {
/*Line 877 - 'AtomControl.js' */                var oldIE = AtomBrowser.isIE && AtomBrowser.majorVersion < 9;
/*Line 878 - 'AtomControl.js' */                var ae = new ChildEnumerator(e);
/*Line 879 - 'AtomControl.js' */                while (ae.next()) {
/*Line 880 - 'AtomControl.js' */                    var ce = ae.current();
/*Line 881 - 'AtomControl.js' */                    if (ce.atomControl) {
/*Line 882 - 'AtomControl.js' */                        ce.atomControl.dispose();
/*Line 883 - 'AtomControl.js' */                        if (oldIE) {
/*Line 884 - 'AtomControl.js' */                            ce.atomControl = undefined;
/*Line 885 - 'AtomControl.js' */                        } else {
/*Line 886 - 'AtomControl.js' */                            delete ce.atomControl;
/*Line 887 - 'AtomControl.js' */                        }
/*Line 888 - 'AtomControl.js' */                    } else {
/*Line 889 - 'AtomControl.js' */                        this.clearBinding(ce);
/*Line 890 - 'AtomControl.js' */                        this.unbindEvent(ce);
/*Line 891 - 'AtomControl.js' */                        this.disposeChildren(ce);
/*Line 892 - 'AtomControl.js' */                    }
/*Line 893 - 'AtomControl.js' */                    //$(ce).remove();
/*Line 894 - 'AtomControl.js' */                }
/*Line 895 - 'AtomControl.js' */                // this will and should remove every children..
/*Line 896 - 'AtomControl.js' */                try {
/*Line 897 - 'AtomControl.js' */                    e.innerHTML = "";
/*Line 898 - 'AtomControl.js' */                } catch (ex) {
/*Line 899 - 'AtomControl.js' */                    $(e).html('');
/*Line 900 - 'AtomControl.js' */                }
/*Line 901 - 'AtomControl.js' */            },

/*Line 903 - 'AtomControl.js' */            get_innerTemplate: function () {
/*Line 904 - 'AtomControl.js' */                return this._template;
/*Line 905 - 'AtomControl.js' */            },

/*Line 907 - 'AtomControl.js' */            set_innerTemplate: function (v) {
/*Line 908 - 'AtomControl.js' */                if (this._template === v) {
/*Line 909 - 'AtomControl.js' */                    if (this._created)
/*Line 910 - 'AtomControl.js' */                        return;
/*Line 911 - 'AtomControl.js' */                }
/*Line 912 - 'AtomControl.js' */                if (!this._created) {
/*Line 913 - 'AtomControl.js' */                    var _this = this;
/*Line 914 - 'AtomControl.js' */                    // this is because, sometimes template change occurs while creation
/*Line 915 - 'AtomControl.js' */                    // which creates endless loop
/*Line 916 - 'AtomControl.js' */                    WebAtoms.dispatcher.callLater(function () {
/*Line 917 - 'AtomControl.js' */                        _this.set_innerTemplate(v);
/*Line 918 - 'AtomControl.js' */                    });
/*Line 919 - 'AtomControl.js' */                    return;
/*Line 920 - 'AtomControl.js' */                }
/*Line 921 - 'AtomControl.js' */                this._template = v;
/*Line 922 - 'AtomControl.js' */                // disposing all children...
/*Line 923 - 'AtomControl.js' */                this.disposeChildren(this._element);

/*Line 925 - 'AtomControl.js' */                this.createChildren();
/*Line 926 - 'AtomControl.js' */                this.setProperties(this._element);
/*Line 927 - 'AtomControl.js' */                this.initializeChildren(this._element);
/*Line 928 - 'AtomControl.js' */                this.updateUI();
/*Line 929 - 'AtomControl.js' */            },

/*Line 931 - 'AtomControl.js' */            initializeChildren: function (e) {
/*Line 932 - 'AtomControl.js' */                var ae = new ChildEnumerator(e);
/*Line 933 - 'AtomControl.js' */                var item;
/*Line 934 - 'AtomControl.js' */                var ctrl;

/*Line 936 - 'AtomControl.js' */                var remove = [];

/*Line 938 - 'AtomControl.js' */                while (ae.next()) {
/*Line 939 - 'AtomControl.js' */                    item = ae.current();

/*Line 941 - 'AtomControl.js' */                    if (item.nodeName == "SCRIPT") {

/*Line 943 - 'AtomControl.js' */                        // evalute and set scope...
/*Line 944 - 'AtomControl.js' */                        var s = $.trim(item.innerHTML);
/*Line 945 - 'AtomControl.js' */                        if (/^\(\{/.test(s) && /\}\)$/.test(s)) {
/*Line 946 - 'AtomControl.js' */                            try {
/*Line 947 - 'AtomControl.js' */                                s = (new Function("return " + s + ";"))()
/*Line 948 - 'AtomControl.js' */                                //this.set_scope(s);
/*Line 949 - 'AtomControl.js' */                                var scope = this._localScope || this.get_scope();
/*Line 950 - 'AtomControl.js' */                                for (var k in s) {
/*Line 951 - 'AtomControl.js' */                                    if (scope[k] === undefined) {
/*Line 952 - 'AtomControl.js' */                                        scope[k] = s[k];
/*Line 953 - 'AtomControl.js' */                                    }
/*Line 954 - 'AtomControl.js' */                                }
/*Line 955 - 'AtomControl.js' */                            } catch (ex) {
/*Line 956 - 'AtomControl.js' */                                log(JSON.stringify(ex));
/*Line 957 - 'AtomControl.js' */                                alert(JSON.stringify(ex));
/*Line 958 - 'AtomControl.js' */                            }

/*Line 960 - 'AtomControl.js' */                        }
/*Line 961 - 'AtomControl.js' */                        remove.push(item);
/*Line 962 - 'AtomControl.js' */                        continue;

/*Line 964 - 'AtomControl.js' */                    }

/*Line 966 - 'AtomControl.js' */                    ctrl = item.atomControl;
/*Line 967 - 'AtomControl.js' */                    if (ctrl) {
/*Line 968 - 'AtomControl.js' */                        ctrl.initialize();
/*Line 969 - 'AtomControl.js' */                    } else {
/*Line 970 - 'AtomControl.js' */                        this.initializeChildren(item);
/*Line 971 - 'AtomControl.js' */                    }
/*Line 972 - 'AtomControl.js' */                }

/*Line 974 - 'AtomControl.js' */                ae = new AtomEnumerator(remove);
/*Line 975 - 'AtomControl.js' */                while (ae.next()) {
/*Line 976 - 'AtomControl.js' */                    e.removeChild(ae.current());
/*Line 977 - 'AtomControl.js' */                }
/*Line 978 - 'AtomControl.js' */            }
/*Line 979 - 'AtomControl.js' */        }
/*Line 980 - 'AtomControl.js' */    });
/*Line 981 - 'AtomControl.js' */})(window,"WebAtoms.AtomControl",WebAtoms.AtomUIComponent.prototype);
...
/*Line 616 - 'AtomItemsControl.js' */                this.updateUI();

/*Line 618 - 'AtomItemsControl.js' */                WebAtoms.dispatcher.start();

/*Line 620 - 'AtomItemsControl.js' */                AtomBinder.refreshValue(this, "childAtomControls");


/*Line 623 - 'AtomItemsControl.js' */            },

/*Line 625 - 'AtomItemsControl.js' */            set_innerTemplate: function (v) {
/*Line 626 - 'AtomItemsControl.js' */                this._itemsPresenter = this._element;
/*Line 627 - 'AtomItemsControl.js' */                base.set_innerTemplate.apply(this, arguments);
/*Line 628 - 'AtomItemsControl.js' */                this.onCollectionChangedInternal("mode", -1, null);
/*Line 629 - 'AtomItemsControl.js' */            },

/*Line 631 - 'AtomItemsControl.js' */            applyItemStyle: function (item, dataItem, first, last) {
/*Line 632 - 'AtomItemsControl.js' */            },

/*Line 634 - 'AtomItemsControl.js' */            createChildElement: function (parentScope, parentElement, data, ae, before) {
/*Line 635 - 'AtomItemsControl.js' */                //if (!this._template)
/*Line 636 - 'AtomItemsControl.js' */                //    return null;

/*Line 638 - 'AtomItemsControl.js' */                this.getTemplate("itemTemplate");

/*Line 640 - 'AtomItemsControl.js' */                var elementChild = AtomUI.cloneNode(this._itemTemplate);
/*Line 641 - 'AtomItemsControl.js' */                elementChild._templateParent = this;
/*Line 642 - 'AtomItemsControl.js' */                if (before) {
/*Line 643 - 'AtomItemsControl.js' */                    parentElement.insertBefore(elementChild, before);
/*Line 644 - 'AtomItemsControl.js' */                } else {
/*Line 645 - 'AtomItemsControl.js' */                    parentElement.appendChild(elementChild);
/*Line 646 - 'AtomItemsControl.js' */                }

/*Line 648 - 'AtomItemsControl.js' */                var scope = new AtomScope(this, parentScope, parentScope.__application);
/*Line 649 - 'AtomItemsControl.js' */                if (ae) {
/*Line 650 - 'AtomItemsControl.js' */                    scope.itemIsFirst = ae.isFirst();
/*Line 651 - 'AtomItemsControl.js' */                    scope.itemIsLast = ae.isLast();
/*Line 652 - 'AtomItemsControl.js' */                    scope.itemIndex = ae.currentIndex();
/*Line 653 - 'AtomItemsControl.js' */                    scope.itemExpanded = false;
/*Line 654 - 'AtomItemsControl.js' */                    scope.data = data;
/*Line 655 - 'AtomItemsControl.js' */                    scope.get_itemSelected = function () {
/*Line 656 - 'AtomItemsControl.js' */                        return scope.owner.isSelected(data);
/*Line 657 - 'AtomItemsControl.js' */                    };
/*Line 658 - 'AtomItemsControl.js' */                    scope.set_itemSelected = function (v) {
/*Line 659 - 'AtomItemsControl.js' */                        scope.owner.toggleSelection(data, true);
/*Line 660 - 'AtomItemsControl.js' */                    };
/*Line 661 - 'AtomItemsControl.js' */                }

/*Line 663 - 'AtomItemsControl.js' */                var ac = AtomUI.createControl(elementChild, this._childItemType, data, scope);
/*Line 664 - 'AtomItemsControl.js' */                return elementChild;
/*Line 665 - 'AtomItemsControl.js' */            },

/*Line 667 - 'AtomItemsControl.js' */            toggleSelection: function (data) {
/*Line 668 - 'AtomItemsControl.js' */                this._onUIChanged = true;
/*Line 669 - 'AtomItemsControl.js' */                this._value = undefined;
/*Line 670 - 'AtomItemsControl.js' */                if (this._allowMultipleSelection) {
/*Line 671 - 'AtomItemsControl.js' */                    if (AtomUI.contains(this._selectedItems, data)) {
/*Line 672 - 'AtomItemsControl.js' */                        AtomBinder.removeItem(this._selectedItems, data);
/*Line 673 - 'AtomItemsControl.js' */                    } else {
/*Line 674 - 'AtomItemsControl.js' */                        AtomBinder.addItem(this._selectedItems, data);
/*Line 675 - 'AtomItemsControl.js' */                    }
/*Line 676 - 'AtomItemsControl.js' */                } else {
/*Line 677 - 'AtomItemsControl.js' */                    this._selectedItems.length = 1;
/*Line 678 - 'AtomItemsControl.js' */                    this._selectedItems[0] = data;
/*Line 679 - 'AtomItemsControl.js' */                    AtomBinder.refreshItems(this._selectedItems);
/*Line 680 - 'AtomItemsControl.js' */                }
/*Line 681 - 'AtomItemsControl.js' */                this._onUIChanged = false;
/*Line 682 - 'AtomItemsControl.js' */            },

/*Line 684 - 'AtomItemsControl.js' */            onUpdateUI: function () {
/*Line 685 - 'AtomItemsControl.js' */                base.onUpdateUI.call(this);
/*Line 686 - 'AtomItemsControl.js' */                var ae = new ChildEnumerator(this._itemsPresenter);
/*Line 687 - 'AtomItemsControl.js' */                while (ae.next()) {
/*Line 688 - 'AtomItemsControl.js' */                    var item = ae.current();
/*Line 689 - 'AtomItemsControl.js' */                    if (!item.atomControl)
/*Line 690 - 'AtomItemsControl.js' */                        continue;
/*Line 691 - 'AtomItemsControl.js' */                    var dataItem = item.atomControl.get_data();
/*Line 692 - 'AtomItemsControl.js' */                    AtomBinder.refreshValue(item.atomControl.get_scope(), "itemSelected");
/*Line 693 - 'AtomItemsControl.js' */                    this.applyItemStyle(item, dataItem, ae.isFirst(), ae.isLast());
/*Line 694 - 'AtomItemsControl.js' */                }
/*Line 695 - 'AtomItemsControl.js' */            },

/*Line 697 - 'AtomItemsControl.js' */            onCreationComplete: function () {


/*Line 700 - 'AtomItemsControl.js' */                if (this._items) {
/*Line 701 - 'AtomItemsControl.js' */                    this.onCollectionChangedInternal("refresh", -1, null);
/*Line 702 - 'AtomItemsControl.js' */                }

/*Line 704 - 'AtomItemsControl.js' */                var caller = this;

/*Line 706 - 'AtomItemsControl.js' */                this.dispatcher.callLater(function () {
/*Line 707 - 'AtomItemsControl.js' */                    if (caller._autoScrollToSelection) {
/*Line 708 - 'AtomItemsControl.js' */                        caller.bringSelectionIntoView();
/*Line 709 - 'AtomItemsControl.js' */                    }
/*Line 710 - 'AtomItemsControl.js' */                });

/*Line 712 - 'AtomItemsControl.js' */            },


/*Line 715 - 'AtomItemsControl.js' */            initialize: function () {

/*Line 717 - 'AtomItemsControl.js' */                var element = this.get_element();


/*Line 720 - 'AtomItemsControl.js' */                // set self as Items Presenter..
/*Line 721 - 'AtomItemsControl.js' */                if (!this._itemsPresenter) {
/*Line 722 - 'AtomItemsControl.js' */                    this._itemsPresenter = this._element;
/*Line 723 - 'AtomItemsControl.js' */                }
/*Line 724 - 'AtomItemsControl.js' */                else {
/*Line 725 - 'AtomItemsControl.js' */                    //this._layout = WebAtoms.AtomViewBoxLayout.defaultInstnace;
/*Line 726 - 'AtomItemsControl.js' */                }

/*Line 728 - 'AtomItemsControl.js' */                var _this = this;
/*Line 729 - 'AtomItemsControl.js' */                this.bindEvent(this._selectedItems, "CollectionChanged", function () {
/*Line 730 - 'AtomItemsControl.js' */                    _this.onSelectedItemsChanged.apply(_this, arguments);
/*Line 731 - 'AtomItemsControl.js' */                });
/*Line 732 - 'AtomItemsControl.js' */                base.initialize.apply(this, arguments);


/*Line 735 - 'AtomItemsControl.js' */                var caller = this;

/*Line 737 - 'AtomItemsControl.js' */                this.removeItemCommand = function (scope, sender) {
/*Line 738 - 'AtomItemsControl.js' */                    if (!sender)
/*Line 739 - 'AtomItemsControl.js' */                        return;
/*Line 740 - 'AtomItemsControl.js' */                    var d = sender.get_data();
/*Line 741 - 'AtomItemsControl.js' */                    AtomBinder.removeItem(caller._items, d);
/*Line 742 - 'AtomItemsControl.js' */                };

/*Line 744 - 'AtomItemsControl.js' */                this.removeSelectedCommand = function (scope, sender) {
/*Line 745 - 'AtomItemsControl.js' */                    var s = caller.get_selectedItems().slice(0);
/*Line 746 - 'AtomItemsControl.js' */                    var ae = new AtomEnumerator(s);
/*Line 747 - 'AtomItemsControl.js' */                    while (ae.next()) {
/*Line 748 - 'AtomItemsControl.js' */                        AtomBinder.removeItem(caller.get_items(), ae.current());
/*Line 749 - 'AtomItemsControl.js' */                    }
/*Line 750 - 'AtomItemsControl.js' */                };

/*Line 752 - 'AtomItemsControl.js' */                this.removeAllCommand = function (scope, sender) {
/*Line 753 - 'AtomItemsControl.js' */                    AtomBinder.clear(caller.get_items());
/*Line 754 - 'AtomItemsControl.js' */                };
/*Line 755 - 'AtomItemsControl.js' */            }
/*Line 756 - 'AtomItemsControl.js' */        }
/*Line 757 - 'AtomItemsControl.js' */    });
/*Line 758 - 'AtomItemsControl.js' */})(window, WebAtoms.AtomControl.prototype);
...
/*Line 28 - 'AtomDockPanel.js' */                var size = { width: $(element).innerWidth(), height: $(element).innerHeight() };
...
/*Line 53 - 'AtomListBox.js' */            onCreationComplete: function () {
/*Line 54 - 'AtomListBox.js' */                this.bindEvent(this._itemsPresenter, "click", "onClick");
/*Line 55 - 'AtomListBox.js' */                baseType.onCreationComplete.call(this);
...
/*Line 83 - 'AtomListBox.js' */            initialize: function () {


/*Line 86 - 'AtomListBox.js' */                baseType.initialize.call(this);
...
/*Line 236 - 'AtomAutoCompleteBox.js' */            onCreationComplete: function () {
...
/*Line 246 - 'AtomAutoCompleteBox.js' */                base.onCreationComplete.apply(this, arguments);
...
/*Line 264 - 'AtomAutoCompleteBox.js' */            initialize: function () {

/*Line 266 - 'AtomAutoCompleteBox.js' */                base.initialize.apply(this, arguments);
...
/*Line 13 - 'AtomCheckBoxList.js' */            initialize: function () {
/*Line 14 - 'AtomCheckBoxList.js' */                base.initialize.call(this);
...
/*Line 70 - 'AtomComboBox.js' */            initialize: function () {
...
/*Line 74 - 'AtomComboBox.js' */                base.initialize.apply(this, arguments);
...
/*Line 56 - 'AtomDateListBox.js' */            initialize: function () {
/*Line 57 - 'AtomDateListBox.js' */                base.initialize.apply(this);
...
/*Line 173 - 'AtomDateListBox.js' */                for (i = 0; i < 42; i++) {
/*Line 174 - 'AtomDateListBox.js' */                    var cd = i + first.getDate();
/*Line 175 - 'AtomDateListBox.js' */                    var id = new Date(y, m, cd);
/*Line 176 - 'AtomDateListBox.js' */                    var w = id.getDay();
/*Line 177 - 'AtomDateListBox.js' */                    w = w == 0 || w == 6;
/*Line 178 - 'AtomDateListBox.js' */                    items.push({
/*Line 179 - 'AtomDateListBox.js' */                        label: id.getDate(),
/*Line 180 - 'AtomDateListBox.js' */                        isWeekEnd: w,
/*Line 181 - 'AtomDateListBox.js' */                        isToday:
/*Line 182 - 'AtomDateListBox.js' */                            now.getDate() == id.getDate()
/*Line 183 - 'AtomDateListBox.js' */                            && now.getMonth() == id.getMonth()
/*Line 184 - 'AtomDateListBox.js' */                            && now.getFullYear() == id.getFullYear(),
/*Line 185 - 'AtomDateListBox.js' */                        isOtherMonth: id.getMonth() != this._month -1,
/*Line 186 - 'AtomDateListBox.js' */                        dateLabel: AtomDate.toShortDateString(id),
/*Line 187 - 'AtomDateListBox.js' */                        value: AtomDate.toMMDDYY(id),
/*Line 188 - 'AtomDateListBox.js' */                        date: id
/*Line 189 - 'AtomDateListBox.js' */                    });
/*Line 190 - 'AtomDateListBox.js' */                }

/*Line 192 - 'AtomDateListBox.js' */                this._items = items;
/*Line 193 - 'AtomDateListBox.js' */                AtomBinder.refreshValue(this, "items");
/*Line 194 - 'AtomDateListBox.js' */                AtomBinder.refreshValue(this, "selectedItems");
/*Line 195 - 'AtomDateListBox.js' */                if (this._created) {
/*Line 196 - 'AtomDateListBox.js' */                    AtomBinder.refreshValue(this, "value");
/*Line 197 - 'AtomDateListBox.js' */                }
/*Line 198 - 'AtomDateListBox.js' */            }
/*Line 199 - 'AtomDateListBox.js' */        }
/*Line 200 - 'AtomDateListBox.js' */    });
/*Line 201 - 'AtomDateListBox.js' */})(window, WebAtoms.AtomControl.prototype);
...
/*Line 79 - 'AtomNavigatorList.js' */                    this.initializeChildren(p);
...
/*Line 181 - 'AtomNavigatorList.js' */            initialize: function () {
/*Line 182 - 'AtomNavigatorList.js' */                base.initialize.call(this);
...
/*Line 18 - 'AtomToggleButtonBar.js' */            initialize: function () {

/*Line 20 - 'AtomToggleButtonBar.js' */                baseType.initialize.call(this);
...
/*Line 18 - 'AtomApplication.js' */            if (window.model) {
/*Line 19 - 'AtomApplication.js' */                window.appScope.model = window.model;
/*Line 20 - 'AtomApplication.js' */                this._data = window.model;
/*Line 21 - 'AtomApplication.js' */            }
/*Line 22 - 'AtomApplication.js' */            window.atomApplication = this;
/*Line 23 - 'AtomApplication.js' */            this.busyCount = 0;

/*Line 25 - 'AtomApplication.js' */            var url = location.hash;
/*Line 26 - 'AtomApplication.js' */            url = url ? url.substr(1) : url;
/*Line 27 - 'AtomApplication.js' */            if (url) {
/*Line 28 - 'AtomApplication.js' */                var s = AtomUI.parseUrl(url);
/*Line 29 - 'AtomApplication.js' */                this._hash = location.hash;
/*Line 30 - 'AtomApplication.js' */                var ts = this._scope;
/*Line 31 - 'AtomApplication.js' */                for (var i in s) {
/*Line 32 - 'AtomApplication.js' */                    ts[i] = s[i];
/*Line 33 - 'AtomApplication.js' */                }
/*Line 34 - 'AtomApplication.js' */            } else {
/*Line 35 - 'AtomApplication.js' */                this._hash = location.hash;
/*Line 36 - 'AtomApplication.js' */            }
/*Line 37 - 'AtomApplication.js' */        },
/*Line 38 - 'AtomApplication.js' */        {
/*Line 39 - 'AtomApplication.js' */            get_title: function () {
/*Line 40 - 'AtomApplication.js' */                return window.document.title;
/*Line 41 - 'AtomApplication.js' */            },
/*Line 42 - 'AtomApplication.js' */            set_title: function (v) {
/*Line 43 - 'AtomApplication.js' */                window.document.title = v;
/*Line 44 - 'AtomApplication.js' */            },

/*Line 46 - 'AtomApplication.js' */            get_isBusy: function () {
/*Line 47 - 'AtomApplication.js' */                return this.busyCount;
/*Line 48 - 'AtomApplication.js' */            },

/*Line 50 - 'AtomApplication.js' */            setBusy: function (b, msg) {
/*Line 51 - 'AtomApplication.js' */                if (b) {
/*Line 52 - 'AtomApplication.js' */                    this.busyCount++;
/*Line 53 - 'AtomApplication.js' */                } else {
/*Line 54 - 'AtomApplication.js' */                    this.busyCount--;
/*Line 55 - 'AtomApplication.js' */                }
/*Line 56 - 'AtomApplication.js' */                if (msg !== undefined) {
/*Line 57 - 'AtomApplication.js' */                    if (!msg)
/*Line 58 - 'AtomApplication.js' */                        msg = "";
/*Line 59 - 'AtomApplication.js' */                    AtomBinder.setValue(this, "busyMessage", msg);
/*Line 60 - 'AtomApplication.js' */                } else {
/*Line 61 - 'AtomApplication.js' */                    AtomBinder.setValue(this, "busyMessage", "Loading...");
/*Line 62 - 'AtomApplication.js' */                }
/*Line 63 - 'AtomApplication.js' */                AtomBinder.refreshValue(this, "isBusy");
/*Line 64 - 'AtomApplication.js' */            },

/*Line 66 - 'AtomApplication.js' */            updateUI: function () {
/*Line 67 - 'AtomApplication.js' */                //if (!this._renderAsPage) {
/*Line 68 - 'AtomApplication.js' */                //    var element = this.get_element();
/*Line 69 - 'AtomApplication.js' */                //    var ep = element.parentNode;
/*Line 70 - 'AtomApplication.js' */                //    var pw = $(ep).outerWidth();
/*Line 71 - 'AtomApplication.js' */                //    var left = (pw - $(element).width()) / 2;
/*Line 72 - 'AtomApplication.js' */                //    element.style.left = left + "px";
/*Line 73 - 'AtomApplication.js' */                //    element.style.position = "absolute";
/*Line 74 - 'AtomApplication.js' */                //}
/*Line 75 - 'AtomApplication.js' */                base.updateUI.call(this);

/*Line 77 - 'AtomApplication.js' */                AtomBinder.refreshValue(this, "appWidth");
/*Line 78 - 'AtomApplication.js' */                AtomBinder.refreshValue(this, "appHeight");
/*Line 79 - 'AtomApplication.js' */                AtomBinder.refreshValue(this, "bodyWidth");
/*Line 80 - 'AtomApplication.js' */                AtomBinder.refreshValue(this, "bodyHeight");
/*Line 81 - 'AtomApplication.js' */            },

/*Line 83 - 'AtomApplication.js' */            onUpdateUI: function () {
/*Line 84 - 'AtomApplication.js' */                if (!this._renderAsPage) {
/*Line 85 - 'AtomApplication.js' */                    base.onUpdateUI.call(this);
/*Line 86 - 'AtomApplication.js' */                }
/*Line 87 - 'AtomApplication.js' */            },

/*Line 89 - 'AtomApplication.js' */            get_appWidth: function () {
/*Line 90 - 'AtomApplication.js' */                return $(this._element).width();
/*Line 91 - 'AtomApplication.js' */            },
/*Line 92 - 'AtomApplication.js' */            get_appHeight: function () {
/*Line 93 - 'AtomApplication.js' */                return $(this._element).height();
/*Line 94 - 'AtomApplication.js' */            },

/*Line 96 - 'AtomApplication.js' */            get_bodyWidth: function () {
/*Line 97 - 'AtomApplication.js' */                return $(document.body).width();
/*Line 98 - 'AtomApplication.js' */            },
/*Line 99 - 'AtomApplication.js' */            get_bodyHeight: function () {
/*Line 100 - 'AtomApplication.js' */                return $(document.body).height();
/*Line 101 - 'AtomApplication.js' */            },


/*Line 104 - 'AtomApplication.js' */            onHashChanged: function () {

/*Line 106 - 'AtomApplication.js' */                if (this._noHashRefresh)
/*Line 107 - 'AtomApplication.js' */                    return;
/*Line 108 - 'AtomApplication.js' */                var scope = this._scope;

/*Line 110 - 'AtomApplication.js' */                var url = location.hash ? location.hash : this._defaultScope;
/*Line 111 - 'AtomApplication.js' */                if (!url) {
/*Line 112 - 'AtomApplication.js' */                    return;
/*Line 113 - 'AtomApplication.js' */                }

/*Line 115 - 'AtomApplication.js' */                //log("#changed:" + url);

/*Line 117 - 'AtomApplication.js' */                this._noHashRefresh = true;
/*Line 118 - 'AtomApplication.js' */                url = url.substr(1);

/*Line 120 - 'AtomApplication.js' */                var s = AtomUI.parseUrl(url);

/*Line 122 - 'AtomApplication.js' */                if (this._created) {
/*Line 123 - 'AtomApplication.js' */                    for (var key in s) {
/*Line 124 - 'AtomApplication.js' */                        var val = s[key];
/*Line 125 - 'AtomApplication.js' */                        if (scope[key] != val) {
/*Line 126 - 'AtomApplication.js' */                            AtomBinder.setValue(scope, key, val);
/*Line 127 - 'AtomApplication.js' */                        }
/*Line 128 - 'AtomApplication.js' */                    }
/*Line 129 - 'AtomApplication.js' */                } else {
/*Line 130 - 'AtomApplication.js' */                    Atom.merge(scope, s);
/*Line 131 - 'AtomApplication.js' */                }

/*Line 133 - 'AtomApplication.js' */                this._noHashRefresh = false;

/*Line 135 - 'AtomApplication.js' */            },

/*Line 137 - 'AtomApplication.js' */            invokeUpdateUI: function () {
/*Line 138 - 'AtomApplication.js' */                var container = this;
/*Line 139 - 'AtomApplication.js' */                var _this = this;
/*Line 140 - 'AtomApplication.js' */                window.setTimeout(function () {
/*Line 141 - 'AtomApplication.js' */                    return _this.updateUI();
/*Line 142 - 'AtomApplication.js' */                }, 5);
/*Line 143 - 'AtomApplication.js' */            },

/*Line 145 - 'AtomApplication.js' */            onRefreshValue: function (target, key) {
/*Line 146 - 'AtomApplication.js' */                if (this._noHashRefresh)
/*Line 147 - 'AtomApplication.js' */                    return;

/*Line 149 - 'AtomApplication.js' */                var dest = this._defaultScope;
/*Line 150 - 'AtomApplication.js' */                if (!dest)
/*Line 151 - 'AtomApplication.js' */                    return;

/*Line 153 - 'AtomApplication.js' */                var i = key;
/*Line 154 - 'AtomApplication.js' */                if (i.indexOf('_') == 0)
/*Line 155 - 'AtomApplication.js' */                    return;
/*Line 156 - 'AtomApplication.js' */                var val = this._scope[i];
/*Line 157 - 'AtomApplication.js' */                if (val === undefined)
/*Line 158 - 'AtomApplication.js' */                    return;
/*Line 159 - 'AtomApplication.js' */                if (val === null)
/*Line 160 - 'AtomApplication.js' */                    return;
/*Line 161 - 'AtomApplication.js' */                var t = typeof (val);
/*Line 162 - 'AtomApplication.js' */                if (t != 'string' && t != 'number' && t != 'boolean') {
/*Line 163 - 'AtomApplication.js' */                    return;
/*Line 164 - 'AtomApplication.js' */                }


/*Line 167 - 'AtomApplication.js' */                var diff = [];
/*Line 168 - 'AtomApplication.js' */                var src = this._scope;

/*Line 170 - 'AtomApplication.js' */                for (var k in src) {
/*Line 171 - 'AtomApplication.js' */                    var v = src[k];
/*Line 172 - 'AtomApplication.js' */                    if (dest.hasOwnProperty(k)) {
...
/*Line 199 - 'AtomApplication.js' */            initializationComplete: function () {
...
/*Line 218 - 'AtomApplication.js' */                base.initializationComplete.call(this);
...
/*Line 236 - 'AtomApplication.js' */            onCreationComplete: function () {
/*Line 237 - 'AtomApplication.js' */                base.onCreationComplete.call(this);
...
/*Line 277 - 'AtomApplication.js' */                this.initialize();
/*Line 278 - 'AtomApplication.js' */            },

/*Line 280 - 'AtomApplication.js' */            initialize: function () {

/*Line 282 - 'AtomApplication.js' */                this.closeCommand = function () {
/*Line 283 - 'AtomApplication.js' */                    _this.onCloseCommand.apply(_this, arguments);
/*Line 284 - 'AtomApplication.js' */                };

/*Line 286 - 'AtomApplication.js' */                this.bindEvent(window, "resize", "invokeUpdateUI");

/*Line 288 - 'AtomApplication.js' */                var _this = this;
/*Line 289 - 'AtomApplication.js' */                this._onRefreshValue = function () {
/*Line 290 - 'AtomApplication.js' */                    _this.onRefreshValue.apply(_this, arguments);
/*Line 291 - 'AtomApplication.js' */                };

/*Line 293 - 'AtomApplication.js' */                this._scope._$_watcher = this;

/*Line 295 - 'AtomApplication.js' */                base.initialize.call(this);
...
/*Line 302 - 'AtomApplication.js' */            renderAsPage: false,
/*Line 303 - 'AtomApplication.js' */            busyMessage: "",
/*Line 304 - 'AtomApplication.js' */            progress: 0

/*Line 306 - 'AtomApplication.js' */        });
/*Line 307 - 'AtomApplication.js' */})(window, "WebAtoms.AtomApplication", WebAtoms.AtomDockPanel.prototype);
/*Line 0 - 'AtomForm.js' */
...
/*Line 186 - 'AtomForm.js' */            initialize: function () {
/*Line 187 - 'AtomForm.js' */                baseType.initialize.call(this);
...
/*Line 3 - 'AtomPlayer.js' */window.__updateFPObject = function __updateFPObject(id) {
/*Line 4 - 'AtomPlayer.js' */    if (allControls.hasOwnProperty(id)) {
/*Line 5 - 'AtomPlayer.js' */        var ctrl = allControls[id];
/*Line 6 - 'AtomPlayer.js' */        if (ctrl.playerUpdated) {
/*Line 7 - 'AtomPlayer.js' */            ctrl.playerUpdated();
/*Line 8 - 'AtomPlayer.js' */        }
/*Line 9 - 'AtomPlayer.js' */    }
/*Line 10 - 'AtomPlayer.js' */};

/*Line 12 - 'AtomPlayer.js' */(function (baseType) {
/*Line 13 - 'AtomPlayer.js' */    return classCreatorEx({
/*Line 14 - 'AtomPlayer.js' */        name: "WebAtoms.AtomPlayer",
/*Line 15 - 'AtomPlayer.js' */        base: baseType,
/*Line 16 - 'AtomPlayer.js' */        properties: {
/*Line 17 - 'AtomPlayer.js' */            url: null
/*Line 18 - 'AtomPlayer.js' */        },
/*Line 19 - 'AtomPlayer.js' */        start: function () { },
/*Line 20 - 'AtomPlayer.js' */        methods: {
/*Line 21 - 'AtomPlayer.js' */            playerUpdated: function () {
/*Line 22 - 'AtomPlayer.js' */            },

/*Line 24 - 'AtomPlayer.js' */            set_url: function (url) {
/*Line 25 - 'AtomPlayer.js' */                this._url = url;
/*Line 26 - 'AtomPlayer.js' */                if (url !== undefined)
/*Line 27 - 'AtomPlayer.js' */                    this.play(url);
/*Line 28 - 'AtomPlayer.js' */            },

/*Line 30 - 'AtomPlayer.js' */            play: function (url) {
/*Line 31 - 'AtomPlayer.js' */            },
/*Line 32 - 'AtomPlayer.js' */            stop: function () {
/*Line 33 - 'AtomPlayer.js' */            }
/*Line 34 - 'AtomPlayer.js' */        }
/*Line 35 - 'AtomPlayer.js' */    });
/*Line 36 - 'AtomPlayer.js' */})(WebAtoms.AtomControl.prototype);
...
/*Line 107 - 'AtomWindow.js' */            initialize: function () {



/*Line 111 - 'AtomWindow.js' */                $(this._element).addClass("atom-window-placeholder");
/*Line 112 - 'AtomWindow.js' */                baseType.initialize.call(this);
...
/*Line 22 - 'AtomCalendar.js' */            onCreationComplete: function () {
/*Line 23 - 'AtomCalendar.js' */                baseType.onCreationComplete.call(this);
...
/*Line 89 - 'AtomCalendar.js' */            initialize: function () {
/*Line 90 - 'AtomCalendar.js' */                baseType.initialize.call(this);
...
/*Line 101 - 'AtomCalendar.js' */})(window,WebAtoms.AtomNavigatorList.prototype);
/*Line 0 - 'AtomCheckBox.js' *////// <reference path="AtomControl.js" />

/*Line 2 - 'AtomCheckBox.js' *///WebAtoms.AtomCheckBox = function (element) {
/*Line 3 - 'AtomCheckBox.js' *///    WebAtoms.AtomCheckBox.initializeBase(this, [element]);
...
/*Line 37 - 'AtomCheckBox.js' *///    initialize: function () {
...
/*Line 42 - 'AtomCheckBox.js' *///        WebAtoms.AtomCheckBox.baseType.initialize.apply(this, arguments);
...
/*Line 105 - 'AtomDataPager.js' */                onCreationComplete: function () {
...
/*Line 131 - 'AtomDataPager.js' */                initialize: function () {

/*Line 133 - 'AtomDataPager.js' */                    $(this._element).addClass("atom-data-pager");

/*Line 135 - 'AtomDataPager.js' */                    base.initialize.apply(this, arguments);
...
/*Line 105 - 'AtomDateControl.js' */            initialize: function () {
...
/*Line 138 - 'AtomDateControl.js' */                base.initialize.apply(this, arguments);
...
/*Line 40 - 'AtomDateField.js' */                    this.initializeChildren(this.popup);
...
/*Line 58 - 'AtomDateField.js' */                        clearInterval(this._refreshInterval);
/*Line 59 - 'AtomDateField.js' */                    }
/*Line 60 - 'AtomDateField.js' */                    if (this.popup) {
/*Line 61 - 'AtomDateField.js' */                        this.disposeChildren(this.popup);
/*Line 62 - 'AtomDateField.js' */                        $(this.popup).remove();
/*Line 63 - 'AtomDateField.js' */                        this.popup = null;
/*Line 64 - 'AtomDateField.js' */                    }
/*Line 65 - 'AtomDateField.js' */                }
/*Line 66 - 'AtomDateField.js' */            },

/*Line 68 - 'AtomDateField.js' */            dispose: function () {
/*Line 69 - 'AtomDateField.js' */                this.set_isOpen(false);
/*Line 70 - 'AtomDateField.js' */                base.dispose.call(this);
/*Line 71 - 'AtomDateField.js' */            },
/*Line 72 - 'AtomDateField.js' */            get_isOpen: function () {
/*Line 73 - 'AtomDateField.js' */                return this._isOpen;
/*Line 74 - 'AtomDateField.js' */            },

/*Line 76 - 'AtomDateField.js' */            get_selectedItem: function () {
/*Line 77 - 'AtomDateField.js' */                if (this._selectedItems.length)
/*Line 78 - 'AtomDateField.js' */                    return this._selectedItems[0];
/*Line 79 - 'AtomDateField.js' */                return null;
/*Line 80 - 'AtomDateField.js' */            },

/*Line 82 - 'AtomDateField.js' */            set_time: function (v) {
/*Line 83 - 'AtomDateField.js' */                if (this._set_timeCalled)
/*Line 84 - 'AtomDateField.js' */                    return;
/*Line 85 - 'AtomDateField.js' */                this._set_timeCalled = true;
/*Line 86 - 'AtomDateField.js' */                if (v) {
/*Line 87 - 'AtomDateField.js' */                    this._time = v;
/*Line 88 - 'AtomDateField.js' */                    var d = AtomDate.setTime(this.get_value(), v);
/*Line 89 - 'AtomDateField.js' */                    AtomBinder.setValue(this, "value", d);
/*Line 90 - 'AtomDateField.js' */                }
/*Line 91 - 'AtomDateField.js' */                this._set_timeCalled = false;
/*Line 92 - 'AtomDateField.js' */            },

/*Line 94 - 'AtomDateField.js' */            set_value: function (v) {
/*Line 95 - 'AtomDateField.js' */                v = AtomDate.parse(v);
/*Line 96 - 'AtomDateField.js' */                this._value = v;

/*Line 98 - 'AtomDateField.js' */                AtomBinder.setValue(this, "time", AtomDate.toTimeString(v));

/*Line 100 - 'AtomDateField.js' */                this._selectedItems.length = 0;
/*Line 101 - 'AtomDateField.js' */                if (v) {

/*Line 103 - 'AtomDateField.js' */                    this._selectedItems.push({ date: v, dateLabel: AtomDate.toShortDateString(v), value: AtomDate.toMMDDYY(v), label: v.getDate() });
/*Line 104 - 'AtomDateField.js' */                    this.set_visibleDate(v);
/*Line 105 - 'AtomDateField.js' */                }
/*Line 106 - 'AtomDateField.js' */                if (this._created) {
/*Line 107 - 'AtomDateField.js' */                    AtomBinder.refreshItems(this._selectedItems);
/*Line 108 - 'AtomDateField.js' */                    AtomBinder.refreshValue(this, "value");
/*Line 109 - 'AtomDateField.js' */                    AtomBinder.refreshValue(this, "selectedItem");
/*Line 110 - 'AtomDateField.js' */                    AtomBinder.refreshValue(this, "selectedItems");
/*Line 111 - 'AtomDateField.js' */                }
/*Line 112 - 'AtomDateField.js' */            },
/*Line 113 - 'AtomDateField.js' */            get_value: function (v) {
/*Line 114 - 'AtomDateField.js' */                if (this._selectedItems.length)
/*Line 115 - 'AtomDateField.js' */                    return this._selectedItems[0].date;
/*Line 116 - 'AtomDateField.js' */                return this._value;
/*Line 117 - 'AtomDateField.js' */            },

/*Line 119 - 'AtomDateField.js' */            toggleDate: function (scope, sender) {
/*Line 120 - 'AtomDateField.js' */                var item = sender.get_data();
/*Line 121 - 'AtomDateField.js' */                this._selectedItems.length = 0;
/*Line 122 - 'AtomDateField.js' */                AtomBinder.addItem(this._selectedItems, item);
/*Line 123 - 'AtomDateField.js' */                AtomBinder.refreshValue(this, "value");
/*Line 124 - 'AtomDateField.js' */                AtomBinder.refreshValue(this, "selectedItem");
/*Line 125 - 'AtomDateField.js' */                AtomBinder.refreshValue(this, "selectedItems");
/*Line 126 - 'AtomDateField.js' */                AtomBinder.setValue(this, "isOpen", false);
/*Line 127 - 'AtomDateField.js' */            }


/*Line 130 - 'AtomDateField.js' */        }
/*Line 131 - 'AtomDateField.js' */    });
/*Line 132 - 'AtomDateField.js' */})(window, WebAtoms.AtomDateListBox.prototype);
...
/*Line 2 - 'AtomFileUploader.js' */function __waFlashUploadEvent(id, name, a1,a2)
/*Line 3 - 'AtomFileUploader.js' */{
/*Line 4 - 'AtomFileUploader.js' */    var af = allControls[id];
/*Line 5 - 'AtomFileUploader.js' */    af.onFlashEvent(name, a1,a2);
/*Line 6 - 'AtomFileUploader.js' */}

/*Line 8 - 'AtomFileUploader.js' */window.__waFlashUploadEvent = __waFlashUploadEvent;

/*Line 10 - 'AtomFileUploader.js' */(function (window, baseType) {
/*Line 11 - 'AtomFileUploader.js' */    return classCreatorEx({
/*Line 12 - 'AtomFileUploader.js' */        name: "WebAtoms.AtomFileUploader",
/*Line 13 - 'AtomFileUploader.js' */        base: baseType,
/*Line 14 - 'AtomFileUploader.js' */        start: function () {
/*Line 15 - 'AtomFileUploader.js' */            this._presenters = ["viewStack", "filePresenter", "flashPresenter", "flashButtonPresenter"];
/*Line 16 - 'AtomFileUploader.js' */        },
/*Line 17 - 'AtomFileUploader.js' */        properties: {
/*Line 18 - 'AtomFileUploader.js' */            url: null,
/*Line 19 - 'AtomFileUploader.js' */            fileTypes: null,
/*Line 20 - 'AtomFileUploader.js' */            filters: null,
/*Line 21 - 'AtomFileUploader.js' */            value: null,
/*Line 22 - 'AtomFileUploader.js' */            uploadOnUrlSet: false,
/*Line 23 - 'AtomFileUploader.js' */            progress: 0,
/*Line 24 - 'AtomFileUploader.js' */            lockProgress: true,
/*Line 25 - 'AtomFileUploader.js' */            state: '',
/*Line 26 - 'AtomFileUploader.js' */            error: '',
/*Line 27 - 'AtomFileUploader.js' */            displayMode: 0,
/*Line 28 - 'AtomFileUploader.js' */            processUrl: '',
/*Line 29 - 'AtomFileUploader.js' */            processData: null,
/*Line 30 - 'AtomFileUploader.js' */            processMaxTries: 100,
/*Line 31 - 'AtomFileUploader.js' */            processInterval: 5000,
/*Line 32 - 'AtomFileUploader.js' */            proccessResult: {},
/*Line 33 - 'AtomFileUploader.js' */            processDone: false,
/*Line 34 - 'AtomFileUploader.js' */            onSelect: null,
/*Line 35 - 'AtomFileUploader.js' */            accept: "*/*",
/*Line 36 - 'AtomFileUploader.js' */            capture: ""
/*Line 37 - 'AtomFileUploader.js' */        },
/*Line 38 - 'AtomFileUploader.js' */        methods: {
/*Line 39 - 'AtomFileUploader.js' */            set_accept: function (v) {
/*Line 40 - 'AtomFileUploader.js' */                this._accept = v;
/*Line 41 - 'AtomFileUploader.js' */                if (v) {
/*Line 42 - 'AtomFileUploader.js' */                    if (this._filePresenter) {
/*Line 43 - 'AtomFileUploader.js' */                        $(this._filePresenter).attr("accept", v);
/*Line 44 - 'AtomFileUploader.js' */                    }
/*Line 45 - 'AtomFileUploader.js' */                }
/*Line 46 - 'AtomFileUploader.js' */            },

/*Line 48 - 'AtomFileUploader.js' */            set_capture: function (v) {
/*Line 49 - 'AtomFileUploader.js' */                this._capture = v;
/*Line 50 - 'AtomFileUploader.js' */                if (v) {
/*Line 51 - 'AtomFileUploader.js' */                    if (this._filePresenter) {
/*Line 52 - 'AtomFileUploader.js' */                        $(this._filePresenter).attr("capture", v);
/*Line 53 - 'AtomFileUploader.js' */                    }
/*Line 54 - 'AtomFileUploader.js' */                }
/*Line 55 - 'AtomFileUploader.js' */            },
/*Line 56 - 'AtomFileUploader.js' */            set_progress: function (v) {
/*Line 57 - 'AtomFileUploader.js' */                this._progress = v;
/*Line 58 - 'AtomFileUploader.js' */                if (this._lockProgress && v) {
/*Line 59 - 'AtomFileUploader.js' */                    if (v > 99) {
/*Line 60 - 'AtomFileUploader.js' */                        AtomBinder.setValue(atomApplication, "busyMessage", "Converting...");
/*Line 61 - 'AtomFileUploader.js' */                    }
/*Line 62 - 'AtomFileUploader.js' */                    AtomBinder.setValue(atomApplication, "progress", v);
/*Line 63 - 'AtomFileUploader.js' */                }
/*Line 64 - 'AtomFileUploader.js' */            },
/*Line 65 - 'AtomFileUploader.js' */            set_value: function (v) {
/*Line 66 - 'AtomFileUploader.js' */                this._value = v;
/*Line 67 - 'AtomFileUploader.js' */                var caller = this;
/*Line 68 - 'AtomFileUploader.js' */                this.dispatcher.callLater(function () {
/*Line 69 - 'AtomFileUploader.js' */                    if (caller._value) {
/*Line 70 - 'AtomFileUploader.js' */                        if (caller._onSelect) {
/*Line 71 - 'AtomFileUploader.js' */                            caller.invokeAction(caller._onSelect);
/*Line 72 - 'AtomFileUploader.js' */                        }
/*Line 73 - 'AtomFileUploader.js' */                    }
/*Line 74 - 'AtomFileUploader.js' */                });
/*Line 75 - 'AtomFileUploader.js' */            },
/*Line 76 - 'AtomFileUploader.js' */            set_url: function (v) {
/*Line 77 - 'AtomFileUploader.js' */                this._url = v;
/*Line 78 - 'AtomFileUploader.js' */                if (!v)
/*Line 79 - 'AtomFileUploader.js' */                    return;
/*Line 80 - 'AtomFileUploader.js' */                if (this._uploadOnUrlSet) {
/*Line 81 - 'AtomFileUploader.js' */                    this.uploadFile();
/*Line 82 - 'AtomFileUploader.js' */                }

/*Line 84 - 'AtomFileUploader.js' */            },

/*Line 86 - 'AtomFileUploader.js' */            isFlashSupported: function () {
/*Line 87 - 'AtomFileUploader.js' */                return AtomBrowser.supportsFlash && !AtomBrowser.supportsUpload;
/*Line 88 - 'AtomFileUploader.js' */            },

/*Line 90 - 'AtomFileUploader.js' */            onFileSelected: function (f) {
/*Line 91 - 'AtomFileUploader.js' */                this._files = f.target.files;
/*Line 92 - 'AtomFileUploader.js' */                AtomBinder.setValue(this, "value", this._files[0].name);
/*Line 93 - 'AtomFileUploader.js' */            },


/*Line 96 - 'AtomFileUploader.js' */            uploadFile: function () {
/*Line 97 - 'AtomFileUploader.js' */                if (!this._url) {

/*Line 99 - 'AtomFileUploader.js' */                    // process next???
/*Line 100 - 'AtomFileUploader.js' */                    return;
/*Line 101 - 'AtomFileUploader.js' */                }

/*Line 103 - 'AtomFileUploader.js' */                if (this._isFlash) {
/*Line 104 - 'AtomFileUploader.js' */                    var fp = this.get_player();
/*Line 105 - 'AtomFileUploader.js' */                    var r = fp.upload(this._url);
/*Line 106 - 'AtomFileUploader.js' */                } else {
/*Line 107 - 'AtomFileUploader.js' */                    var xhr = this._xhr;
/*Line 108 - 'AtomFileUploader.js' */                    if (!xhr) {
/*Line 109 - 'AtomFileUploader.js' */                        xhr = new XMLHttpRequest();
/*Line 110 - 'AtomFileUploader.js' */                        var upload = xhr.upload;
/*Line 111 - 'AtomFileUploader.js' */                        try {
/*Line 112 - 'AtomFileUploader.js' */                            xhr.timeout = 3600000;
/*Line 113 - 'AtomFileUploader.js' */                        } catch (e) {
/*Line 114 - 'AtomFileUploader.js' */                            // IE 10 has some issue with this code..
/*Line 115 - 'AtomFileUploader.js' */                        }

/*Line 117 - 'AtomFileUploader.js' */                        this.bindEvent(upload, "progress", "onProgress");
/*Line 118 - 'AtomFileUploader.js' */                        this.bindEvent(upload, "timeout", "onError");
/*Line 119 - 'AtomFileUploader.js' */                        this.bindEvent(upload, "error", "onError");
/*Line 120 - 'AtomFileUploader.js' */                        this.bindEvent(xhr, "load", "onComplete");
/*Line 121 - 'AtomFileUploader.js' */                        this.bindEvent(xhr, "error", "onError");
/*Line 122 - 'AtomFileUploader.js' */                        this.bindEvent(xhr, "timeout", "onError");
/*Line 123 - 'AtomFileUploader.js' */                        this._xhr = xhr;
/*Line 124 - 'AtomFileUploader.js' */                    }

/*Line 126 - 'AtomFileUploader.js' */                    var fd = new FormData();
/*Line 127 - 'AtomFileUploader.js' */                    fd.append("fileToUpload", this._files[0]);

/*Line 129 - 'AtomFileUploader.js' */                    xhr.open("POST", this._url);
/*Line 130 - 'AtomFileUploader.js' */                    //xhr.setRequestHeader("Content-Type", "multipart/form-data");
/*Line 131 - 'AtomFileUploader.js' */                    xhr.send(fd);

/*Line 133 - 'AtomFileUploader.js' */                }

/*Line 135 - 'AtomFileUploader.js' */                if (this._lockProgress) {
/*Line 136 - 'AtomFileUploader.js' */                    atomApplication.setBusy(true, "Uploading...");
/*Line 137 - 'AtomFileUploader.js' */                }

/*Line 139 - 'AtomFileUploader.js' */                AtomBinder.setValue(this, "displayMode", 2);
/*Line 140 - 'AtomFileUploader.js' */                AtomBinder.setValue(this, "state", "uploading");
/*Line 141 - 'AtomFileUploader.js' */            },

/*Line 143 - 'AtomFileUploader.js' */            invokeNext: function () {
/*Line 144 - 'AtomFileUploader.js' */                if (this._next) {
/*Line 145 - 'AtomFileUploader.js' */                    if (this._isFlash) {
/*Line 146 - 'AtomFileUploader.js' */                        var fp = this.get_player();
/*Line 147 - 'AtomFileUploader.js' */                        fp.reset();
/*Line 148 - 'AtomFileUploader.js' */                        AtomBinder.setValue(this, "displayMode", 1);
/*Line 149 - 'AtomFileUploader.js' */                    } else {
/*Line 150 - 'AtomFileUploader.js' */                        AtomBinder.setValue(this, "displayMode", 0);
/*Line 151 - 'AtomFileUploader.js' */                    }
/*Line 152 - 'AtomFileUploader.js' */                    AtomBinder.setValue(this, "value", "");
/*Line 153 - 'AtomFileUploader.js' */                    this.invokeAction(this._next);
/*Line 154 - 'AtomFileUploader.js' */                }
/*Line 155 - 'AtomFileUploader.js' */            },

/*Line 157 - 'AtomFileUploader.js' */            refresh: function () {
/*Line 158 - 'AtomFileUploader.js' */                if (this.get_value()) {
/*Line 159 - 'AtomFileUploader.js' */                    this.uploadFile();
/*Line 160 - 'AtomFileUploader.js' */                } else {
/*Line 161 - 'AtomFileUploader.js' */                    this.invokeNext();
/*Line 162 - 'AtomFileUploader.js' */                }
/*Line 163 - 'AtomFileUploader.js' */            },

/*Line 165 - 'AtomFileUploader.js' */            onUploadFinished: function () {
/*Line 166 - 'AtomFileUploader.js' */                AtomBinder.setValue(this, "displayMode", 4);
/*Line 167 - 'AtomFileUploader.js' */                AtomBinder.setValue(this, "state", "uploaded");
/*Line 168 - 'AtomFileUploader.js' */                if (this._lockProgress) {
/*Line 169 - 'AtomFileUploader.js' */                    AtomBinder.setValue(atomApplication, "progress", 0);
/*Line 170 - 'AtomFileUploader.js' */                    atomApplication.setBusy(false, "Uploading...");
/*Line 171 - 'AtomFileUploader.js' */                }

/*Line 173 - 'AtomFileUploader.js' */                if (this._processUrl) {
/*Line 174 - 'AtomFileUploader.js' */                    var caller = this;
/*Line 175 - 'AtomFileUploader.js' */                    this.tries = this._processMaxTries;
/*Line 176 - 'AtomFileUploader.js' */                    if (this.tries && this.tries.constructor == String)
/*Line 177 - 'AtomFileUploader.js' */                        this.tries = parseInt(this.tries, 10);
/*Line 178 - 'AtomFileUploader.js' */                    this.timer = setInterval(function () {
/*Line 179 - 'AtomFileUploader.js' */                        caller.queryProcessUrl();
/*Line 180 - 'AtomFileUploader.js' */                    }, this._processInterval);
/*Line 181 - 'AtomFileUploader.js' */                    atomApplication.setBusy(true, "Converting...");
/*Line 182 - 'AtomFileUploader.js' */                } else {
/*Line 183 - 'AtomFileUploader.js' */                    this.invokeNext();
/*Line 184 - 'AtomFileUploader.js' */                }
/*Line 185 - 'AtomFileUploader.js' */            },

/*Line 187 - 'AtomFileUploader.js' */            queryProcessUrl: function () {
/*Line 188 - 'AtomFileUploader.js' */                var caller = this;
/*Line 189 - 'AtomFileUploader.js' */                var res = function (r) { caller.onQueryResult(r); };

/*Line 191 - 'AtomFileUploader.js' */                var data = this._processData;

/*Line 193 - 'AtomFileUploader.js' */                this.invokeAjax(this._processUrl, { success: res, error: res, data: data });
/*Line 194 - 'AtomFileUploader.js' */            },

/*Line 196 - 'AtomFileUploader.js' */            onQueryResult: function (r) {
/*Line 197 - 'AtomFileUploader.js' */                AtomBinder.setValue(this, "processResult", r);

/*Line 199 - 'AtomFileUploader.js' */                this.tries = this.tries - 1;
/*Line 200 - 'AtomFileUploader.js' */                if (this.tries <= 0 || this._processDone) {
/*Line 201 - 'AtomFileUploader.js' */                    // stop..

/*Line 203 - 'AtomFileUploader.js' */                    var caller = this;
/*Line 204 - 'AtomFileUploader.js' */                    clearInterval(this.timer);
/*Line 205 - 'AtomFileUploader.js' */                    delete this.timer;

/*Line 207 - 'AtomFileUploader.js' */                    setTimeout(function () {
/*Line 208 - 'AtomFileUploader.js' */                        atomApplication.setBusy(false, "Converting...");
/*Line 209 - 'AtomFileUploader.js' */                        caller.invokeNext();
/*Line 210 - 'AtomFileUploader.js' */                    }, caller._processInterval);

/*Line 212 - 'AtomFileUploader.js' */                }
/*Line 213 - 'AtomFileUploader.js' */            },

/*Line 215 - 'AtomFileUploader.js' */            onError: function (evt) {
/*Line 216 - 'AtomFileUploader.js' */                this._lastError = evt;
/*Line 217 - 'AtomFileUploader.js' */                AtomBinder.setValue(this, "displayMode", 3);
/*Line 218 - 'AtomFileUploader.js' */                AtomBinder.setValue(this, "state", "error");
/*Line 219 - 'AtomFileUploader.js' */            },
/*Line 220 - 'AtomFileUploader.js' */            onProgress: function (evt) {
/*Line 221 - 'AtomFileUploader.js' */                //evt = evt.originalEvent;
/*Line 222 - 'AtomFileUploader.js' */                if (evt.lengthComputable) {
/*Line 223 - 'AtomFileUploader.js' */                    var percentComplete = Math.round(evt.loaded * 100 / evt.total);
/*Line 224 - 'AtomFileUploader.js' */                    AtomBinder.setValue(this, "progress", percentComplete);
/*Line 225 - 'AtomFileUploader.js' */                }
/*Line 226 - 'AtomFileUploader.js' */            },
/*Line 227 - 'AtomFileUploader.js' */            onComplete: function (evt) {
/*Line 228 - 'AtomFileUploader.js' */                var result = null;
/*Line 229 - 'AtomFileUploader.js' */                if (evt.target) {
/*Line 230 - 'AtomFileUploader.js' */                    result = evt.target.responseText;
/*Line 231 - 'AtomFileUploader.js' */                } else {
/*Line 232 - 'AtomFileUploader.js' */                    result = evt.result;
/*Line 233 - 'AtomFileUploader.js' */                }
/*Line 234 - 'AtomFileUploader.js' */                this.onUploadFinished();
/*Line 235 - 'AtomFileUploader.js' */            },

/*Line 237 - 'AtomFileUploader.js' */            get_player: function () {
/*Line 238 - 'AtomFileUploader.js' */                var appName = this._fpID;
/*Line 239 - 'AtomFileUploader.js' */                if (navigator.appName.indexOf("Microsoft") != -1) {
/*Line 240 - 'AtomFileUploader.js' */                    return window[appName];
/*Line 241 - 'AtomFileUploader.js' */                } else {
/*Line 242 - 'AtomFileUploader.js' */                    return document[appName];
/*Line 243 - 'AtomFileUploader.js' */                }
/*Line 244 - 'AtomFileUploader.js' */            },



/*Line 248 - 'AtomFileUploader.js' */            playerUpdated: function () {
/*Line 249 - 'AtomFileUploader.js' */                // load status..
/*Line 250 - 'AtomFileUploader.js' */                if (!this._playerReady) {
/*Line 251 - 'AtomFileUploader.js' */                    this._playerReady = true;
/*Line 252 - 'AtomFileUploader.js' */                    var fp = this.get_player();
/*Line 253 - 'AtomFileUploader.js' */                    fp.setProperty("filters", JSON.stringify(this._filters));
/*Line 254 - 'AtomFileUploader.js' */                    if (this._uploadOnUrlSet && this._url) {
/*Line 255 - 'AtomFileUploader.js' */                        fp.uploadFile(this._url);
/*Line 256 - 'AtomFileUploader.js' */                    }
/*Line 257 - 'AtomFileUploader.js' */                }
/*Line 258 - 'AtomFileUploader.js' */                var p = this.get_player();
/*Line 259 - 'AtomFileUploader.js' */                AtomBinder.setValue(this, "state", p.getProperty("currentState").toLowerCase());
/*Line 260 - 'AtomFileUploader.js' */                if (this._state == 'uploaded') {
/*Line 261 - 'AtomFileUploader.js' */                    // yes.. do next...
/*Line 262 - 'AtomFileUploader.js' */                    this.invokeAction(this.get_next());
/*Line 263 - 'AtomFileUploader.js' */                }
/*Line 264 - 'AtomFileUploader.js' */                if (this._state == 'ready') {
/*Line 265 - 'AtomFileUploader.js' */                    AtomBinder.setValue(this, "value", "selected");
/*Line 266 - 'AtomFileUploader.js' */                }
/*Line 267 - 'AtomFileUploader.js' */            },

/*Line 269 - 'AtomFileUploader.js' */            onFlashEvent: function (name, a1, a2) {
/*Line 270 - 'AtomFileUploader.js' */                switch (name) {
/*Line 271 - 'AtomFileUploader.js' */                    case "playerReady":
/*Line 272 - 'AtomFileUploader.js' */                        var ft = AtomBinder.getValue(this, "fileTypes");
/*Line 273 - 'AtomFileUploader.js' */                        if (ft) {
/*Line 274 - 'AtomFileUploader.js' */                            var fp = this.get_player();
/*Line 275 - 'AtomFileUploader.js' */                            fp.clearFileTypes();
/*Line 276 - 'AtomFileUploader.js' */                            var ae = new AtomEnumerator(ft);
/*Line 277 - 'AtomFileUploader.js' */                            while (ae.next()) {
/*Line 278 - 'AtomFileUploader.js' */                                var fti = ae.current();
/*Line 279 - 'AtomFileUploader.js' */                                fp.addFileType(fti.description, fti.extensions);
/*Line 280 - 'AtomFileUploader.js' */                            }
/*Line 281 - 'AtomFileUploader.js' */                        }
/*Line 282 - 'AtomFileUploader.js' */                        break;
/*Line 283 - 'AtomFileUploader.js' */                    case "progress":
/*Line 284 - 'AtomFileUploader.js' */                        this.onFlashProgress(a1, a2);
/*Line 285 - 'AtomFileUploader.js' */                        break;
/*Line 286 - 'AtomFileUploader.js' */                    case "complete":
/*Line 287 - 'AtomFileUploader.js' */                        this.onFlashSuccess(null);
/*Line 288 - 'AtomFileUploader.js' */                        break;
/*Line 289 - 'AtomFileUploader.js' */                    case "selected":
/*Line 290 - 'AtomFileUploader.js' */                        AtomBinder.setValue(this, "value", a1);
/*Line 291 - 'AtomFileUploader.js' */                        break;
/*Line 292 - 'AtomFileUploader.js' */                    case "httpError":
/*Line 293 - 'AtomFileUploader.js' */                    case "ioError":
/*Line 294 - 'AtomFileUploader.js' */                    case "securityError":
/*Line 295 - 'AtomFileUploader.js' */                        this.onFlashError(name, a1);
/*Line 296 - 'AtomFileUploader.js' */                        break;
/*Line 297 - 'AtomFileUploader.js' */                    default:
/*Line 298 - 'AtomFileUploader.js' */                }
/*Line 299 - 'AtomFileUploader.js' */            },

/*Line 301 - 'AtomFileUploader.js' */            onFlashProgress: function (bytesLoaded, bytesTotal) {
/*Line 302 - 'AtomFileUploader.js' */                var percent = Math.ceil((bytesLoaded / bytesTotal) * 100);
/*Line 303 - 'AtomFileUploader.js' */                AtomBinder.setValue(this, "progress", percent);
/*Line 304 - 'AtomFileUploader.js' */            },
/*Line 305 - 'AtomFileUploader.js' */            onFlashError: function (errorCode, message) {
/*Line 306 - 'AtomFileUploader.js' */                this._lastError = { file: file, errorCode: errorCode, message: message };
/*Line 307 - 'AtomFileUploader.js' */                AtomBinder.setValue(this, "displayMode", 3);
/*Line 308 - 'AtomFileUploader.js' */                AtomBinder.setValue(this, "state", "error");
/*Line 309 - 'AtomFileUploader.js' */            },
/*Line 310 - 'AtomFileUploader.js' */            onFlashSuccess: function (serverData) {
/*Line 311 - 'AtomFileUploader.js' */                this.onUploadFinished();
/*Line 312 - 'AtomFileUploader.js' */            },
/*Line 313 - 'AtomFileUploader.js' */            onFlashDialogComplete: function (numFilesSelected, numFilesQueued) {
/*Line 314 - 'AtomFileUploader.js' */                if (numFilesQueued > 0)
/*Line 315 - 'AtomFileUploader.js' */                    AtomBinder.setValue(this, "value", "selected");
/*Line 316 - 'AtomFileUploader.js' */            },

/*Line 318 - 'AtomFileUploader.js' */            onFlashLoaded: function () {
/*Line 319 - 'AtomFileUploader.js' */                this.swfUploader.setButtonDimensions(100, 25);
/*Line 320 - 'AtomFileUploader.js' */            },

/*Line 322 - 'AtomFileUploader.js' */            useFlash: function () {
/*Line 323 - 'AtomFileUploader.js' */                if (AtomBrowser.isIE && AtomBrowser.majorVersion <= 9)
/*Line 324 - 'AtomFileUploader.js' */                    return true;
/*Line 325 - 'AtomFileUploader.js' */                if (AtomBrowser.isSafari) {

/*Line 327 - 'AtomFileUploader.js' */                    if (AtomBrowser.isMac && AtomBrowser.majorVersion < 6) {
/*Line 328 - 'AtomFileUploader.js' */                        return true;
/*Line 329 - 'AtomFileUploader.js' */                    }
/*Line 330 - 'AtomFileUploader.js' */                }
/*Line 331 - 'AtomFileUploader.js' */                return false;
/*Line 332 - 'AtomFileUploader.js' */            },

/*Line 334 - 'AtomFileUploader.js' */            initialize: function () {
/*Line 335 - 'AtomFileUploader.js' */                var element = this._element;

/*Line 337 - 'AtomFileUploader.js' */                allControls[element.id] = this;

/*Line 339 - 'AtomFileUploader.js' */                baseType.initialize.apply(this, arguments);
/*Line 340 - 'AtomFileUploader.js' */                element.style.height = "25px";
/*Line 341 - 'AtomFileUploader.js' */                element.style.minWidth = "240px";
/*Line 342 - 'AtomFileUploader.js' */                if (this.useFlash()) {
/*Line 343 - 'AtomFileUploader.js' */                    AtomBinder.setValue(this, "displayMode", 1);
/*Line 344 - 'AtomFileUploader.js' */                    var fp = this._flashPresenter;
/*Line 345 - 'AtomFileUploader.js' */                    AtomUI.assignID(fp);
/*Line 346 - 'AtomFileUploader.js' */                    this._fpID = fp.id + "_flash";

/*Line 348 - 'AtomFileUploader.js' */                    createFlashUploader(element.id, fp.id, this._fpID);
/*Line 349 - 'AtomFileUploader.js' */                    this._isFlash = true;
/*Line 350 - 'AtomFileUploader.js' */                } else {
/*Line 351 - 'AtomFileUploader.js' */                    AtomBinder.setValue(this, "displayMode", 0);
/*Line 352 - 'AtomFileUploader.js' */                    var f = this._filePresenter;
/*Line 353 - 'AtomFileUploader.js' */                    this.bindEvent(f, "change", "onFileSelected");
/*Line 354 - 'AtomFileUploader.js' */                    this.clickCommand = function () {
/*Line 355 - 'AtomFileUploader.js' */                        $(f).trigger('click');
/*Line 356 - 'AtomFileUploader.js' */                    };
/*Line 357 - 'AtomFileUploader.js' */                }

/*Line 359 - 'AtomFileUploader.js' */            }
/*Line 360 - 'AtomFileUploader.js' */        }
/*Line 361 - 'AtomFileUploader.js' */    });
/*Line 362 - 'AtomFileUploader.js' */})(window, WebAtoms.AtomDockPanel.prototype);
...
/*Line 129 - 'AtomLinkBar.js' */            initialize: function () {
/*Line 130 - 'AtomLinkBar.js' */                base.initialize.apply(this, arguments);
...
/*Line 132 - 'AtomPhoneControl.js' */            initialize: function () {
...
/*Line 190 - 'AtomPhoneControl.js' */                base.initialize.call(this);
...
/*Line 79 - 'AtomRadioButtonList.js' */            initialize: function () {
/*Line 80 - 'AtomRadioButtonList.js' */                this._groupName = "__g" + AtomUI.getNewIndex();
/*Line 81 - 'AtomRadioButtonList.js' */                baseType.initialize.call(this);
...
/*Line 57 - 'AtomSortableColumn.js' */            initialize: function () {
/*Line 58 - 'AtomSortableColumn.js' */                baseType.initialize.call(this);
...
/*Line 10 - 'AtomTimePicker.js' */            initialize: function () {
...
/*Line 28 - 'AtomTimePicker.js' */                baseType.initialize.call(this);
...
/*Line 152 - 'AtomUploadButton.js' */            initialize: function () {
/*Line 153 - 'AtomUploadButton.js' */                baseType.initialize.call(this);
...
/*Line 40 - 'AtomWizard.js' */            initialize: function () {
/*Line 41 - 'AtomWizard.js' */                $(this._element).addClass('atom-wizard');

/*Line 43 - 'AtomWizard.js' */                baseType.initialize.call(this);
...
/*Line 90 - 'AtomWizard.js' */                    cc.initialize();
...
/*Line 14 - 'AtomYesNoControl.js' */            initialize: function () {
/*Line 15 - 'AtomYesNoControl.js' */                this._element.style.height = "26px";
/*Line 16 - 'AtomYesNoControl.js' */                baseType.initialize.call(this);
...
/*Line 44 - 'AtomYesNoCustom.js' */            initialize: function () {

/*Line 46 - 'AtomYesNoCustom.js' */                baseType.initialize.call(this);
...
/*Line 73 - 'AtomAutoPostForm.js' */            onCreationComplete: function () {
/*Line 74 - 'AtomAutoPostForm.js' */                baseType.onCreationComplete.apply(this, arguments);
...
/*Line 100 - 'AtomAutoPostForm.js' */            initialize: function () {
/*Line 101 - 'AtomAutoPostForm.js' */                baseType.initialize.call(this);
...
/*Line 3 - 'AtomDataGrid.js' *///    WebAtoms.AtomDataGridColumn.initializeBase(this, arguments);
...
/*Line 13 - 'AtomDataGrid.js' *///    WebAtoms.AtomDataGrid.initializeBase(this, arguments);
...
/*Line 130 - 'AtomFormField.js' */            onCreationComplete: function () {
...
/*Line 2 - 'AtomPhotoPlayer.js' */(function (baseType) {
/*Line 3 - 'AtomPhotoPlayer.js' */    return classCreatorEx({
/*Line 4 - 'AtomPhotoPlayer.js' */        name: "WebAtoms.AtomPhotoPlayer",
/*Line 5 - 'AtomPhotoPlayer.js' */        base: baseType,
/*Line 6 - 'AtomPhotoPlayer.js' */        start: function () {
/*Line 7 - 'AtomPhotoPlayer.js' */            this._img = null;
/*Line 8 - 'AtomPhotoPlayer.js' */            this._presenters = ["img", "loading"];
/*Line 9 - 'AtomPhotoPlayer.js' */        },
/*Line 10 - 'AtomPhotoPlayer.js' */        methods: {
/*Line 11 - 'AtomPhotoPlayer.js' */            get_width: function () {
/*Line 12 - 'AtomPhotoPlayer.js' */                return $(this._element).width();
/*Line 13 - 'AtomPhotoPlayer.js' */            },
/*Line 14 - 'AtomPhotoPlayer.js' */            get_height: function () {
/*Line 15 - 'AtomPhotoPlayer.js' */                return $(this._element).height();
/*Line 16 - 'AtomPhotoPlayer.js' */            },
/*Line 17 - 'AtomPhotoPlayer.js' */            play: function (url) {

/*Line 19 - 'AtomPhotoPlayer.js' */                // clear the image...
/*Line 20 - 'AtomPhotoPlayer.js' */                this._img.src = "";
/*Line 21 - 'AtomPhotoPlayer.js' */                if (url) {
/*Line 22 - 'AtomPhotoPlayer.js' */                    this._img.src = url;
/*Line 23 - 'AtomPhotoPlayer.js' */                }
/*Line 24 - 'AtomPhotoPlayer.js' */                $(this._img).hide();
/*Line 25 - 'AtomPhotoPlayer.js' */                if (url) {
/*Line 26 - 'AtomPhotoPlayer.js' */                    $(this._loading).show();
/*Line 27 - 'AtomPhotoPlayer.js' */                } else {
/*Line 28 - 'AtomPhotoPlayer.js' */                    $(this._loading).hide();
/*Line 29 - 'AtomPhotoPlayer.js' */                }

/*Line 31 - 'AtomPhotoPlayer.js' */                AtomBinder.refreshValue(this, "width");
/*Line 32 - 'AtomPhotoPlayer.js' */                AtomBinder.refreshValue(this, "height");
/*Line 33 - 'AtomPhotoPlayer.js' */            },
/*Line 34 - 'AtomPhotoPlayer.js' */            stop: function () {
/*Line 35 - 'AtomPhotoPlayer.js' */            },
/*Line 36 - 'AtomPhotoPlayer.js' */            onImgLoaded: function () {
/*Line 37 - 'AtomPhotoPlayer.js' */                $(this._img).show();
/*Line 38 - 'AtomPhotoPlayer.js' */                $(this._loading).hide();
/*Line 39 - 'AtomPhotoPlayer.js' */            },
/*Line 40 - 'AtomPhotoPlayer.js' */            //onImgProgress: function (e) {
/*Line 41 - 'AtomPhotoPlayer.js' */            //    if (e.lengthComputable) {
/*Line 42 - 'AtomPhotoPlayer.js' */            //        var val = e.loaded / e.total * 100;
/*Line 43 - 'AtomPhotoPlayer.js' */            //        $(this._loading).text("loading.. (" + val + "%)");
/*Line 44 - 'AtomPhotoPlayer.js' */            //    }
/*Line 45 - 'AtomPhotoPlayer.js' */            //},
/*Line 46 - 'AtomPhotoPlayer.js' */            initialize: function () {
/*Line 47 - 'AtomPhotoPlayer.js' */                var element = this.get_element();
/*Line 48 - 'AtomPhotoPlayer.js' */                element.style.textAlign = "center";
/*Line 49 - 'AtomPhotoPlayer.js' */                baseType.initialize.call(this);

/*Line 51 - 'AtomPhotoPlayer.js' */                this.bindEvent(this._img, "load", "onImgLoaded");
/*Line 52 - 'AtomPhotoPlayer.js' */                this.bindEvent(this._img, "error", "onImgLoaded");
/*Line 53 - 'AtomPhotoPlayer.js' */                //this.bindEvent(img, "progress", "onImgProgress");
/*Line 54 - 'AtomPhotoPlayer.js' */            }
/*Line 55 - 'AtomPhotoPlayer.js' */        }
/*Line 56 - 'AtomPhotoPlayer.js' */    });
/*Line 57 - 'AtomPhotoPlayer.js' */})(WebAtoms.AtomPlayer.prototype);
/*Line 0 - 'AtomVideoPlayer.js' */

/*Line 2 - 'AtomVideoPlayer.js' */(function (baseType) {
/*Line 3 - 'AtomVideoPlayer.js' */    return classCreatorEx({
/*Line 4 - 'AtomVideoPlayer.js' */        name: "WebAtoms.AtomVideoPlayer",
/*Line 5 - 'AtomVideoPlayer.js' */        base: baseType,
/*Line 6 - 'AtomVideoPlayer.js' */        start: function () {
/*Line 7 - 'AtomVideoPlayer.js' */            this._isFlash = false;
/*Line 8 - 'AtomVideoPlayer.js' */            this._fpID = null;
/*Line 9 - 'AtomVideoPlayer.js' */            this._divID = null;
/*Line 10 - 'AtomVideoPlayer.js' */            this._playerReady = false;
/*Line 11 - 'AtomVideoPlayer.js' */            this._timeoutCallback = null;
/*Line 12 - 'AtomVideoPlayer.js' */            this._playerID = null;
/*Line 13 - 'AtomVideoPlayer.js' */            this._srcID = null;
/*Line 14 - 'AtomVideoPlayer.js' */            this._video = null;
/*Line 15 - 'AtomVideoPlayer.js' */            this._src = null;
/*Line 16 - 'AtomVideoPlayer.js' */            this._errorHandler = null;
/*Line 17 - 'AtomVideoPlayer.js' */            this._autoCreate = false;
/*Line 18 - 'AtomVideoPlayer.js' */            this._playerCreated = false;
/*Line 19 - 'AtomVideoPlayer.js' */        },
/*Line 20 - 'AtomVideoPlayer.js' */        properties: {
/*Line 21 - 'AtomVideoPlayer.js' */            swfPath: "/content/player.swf",
/*Line 22 - 'AtomVideoPlayer.js' */            autoPlay: true,
/*Line 23 - 'AtomVideoPlayer.js' */            poster: null,
/*Line 24 - 'AtomVideoPlayer.js' */            autoCreate: false
/*Line 25 - 'AtomVideoPlayer.js' */        },
/*Line 26 - 'AtomVideoPlayer.js' */        methods: {
/*Line 27 - 'AtomVideoPlayer.js' */            set_poster: function (v) {
/*Line 28 - 'AtomVideoPlayer.js' */                this._poster = v;
/*Line 29 - 'AtomVideoPlayer.js' */                if (this._isFlash) {
/*Line 30 - 'AtomVideoPlayer.js' */                    jwplayer(this._divID).load({ image: v });
/*Line 31 - 'AtomVideoPlayer.js' */                }
/*Line 32 - 'AtomVideoPlayer.js' */                else {
/*Line 33 - 'AtomVideoPlayer.js' */                    if (this._video) {
/*Line 34 - 'AtomVideoPlayer.js' */                        $(this._video).attr("poster", this._poster);
/*Line 35 - 'AtomVideoPlayer.js' */                    }
/*Line 36 - 'AtomVideoPlayer.js' */                }
/*Line 37 - 'AtomVideoPlayer.js' */            },

/*Line 39 - 'AtomVideoPlayer.js' */            onError: function () {
/*Line 40 - 'AtomVideoPlayer.js' */                Atom.alert("something went wrong with video");
/*Line 41 - 'AtomVideoPlayer.js' */            },

/*Line 43 - 'AtomVideoPlayer.js' */            get_player: function (appName) {
/*Line 44 - 'AtomVideoPlayer.js' */                if (navigator.appName.indexOf("Microsoft") != -1) {
/*Line 45 - 'AtomVideoPlayer.js' */                    return window[appName];
/*Line 46 - 'AtomVideoPlayer.js' */                } else {
/*Line 47 - 'AtomVideoPlayer.js' */                    return document[appName];
/*Line 48 - 'AtomVideoPlayer.js' */                }
/*Line 49 - 'AtomVideoPlayer.js' */            },

/*Line 51 - 'AtomVideoPlayer.js' */            playerUpdated: function () {
/*Line 52 - 'AtomVideoPlayer.js' */                this._playerReady = true;
/*Line 53 - 'AtomVideoPlayer.js' */            },

/*Line 55 - 'AtomVideoPlayer.js' */            playIfQueued: function () {
/*Line 56 - 'AtomVideoPlayer.js' */                if (this._queuePlay) {
/*Line 57 - 'AtomVideoPlayer.js' */                    this.play(this._url);
/*Line 58 - 'AtomVideoPlayer.js' */                }
/*Line 59 - 'AtomVideoPlayer.js' */            },

/*Line 61 - 'AtomVideoPlayer.js' */            onUpdateUI: function () {
/*Line 62 - 'AtomVideoPlayer.js' */                baseType.onUpdateUI.call(this);

/*Line 64 - 'AtomVideoPlayer.js' */                var s = $(this._element).css('visibility');
/*Line 65 - 'AtomVideoPlayer.js' */                if (s == "visible") {
/*Line 66 - 'AtomVideoPlayer.js' */                    this.playIfQueued();
/*Line 67 - 'AtomVideoPlayer.js' */                }
/*Line 68 - 'AtomVideoPlayer.js' */            },

/*Line 70 - 'AtomVideoPlayer.js' */            set_options: function (v) {
/*Line 71 - 'AtomVideoPlayer.js' */                if (!v)
/*Line 72 - 'AtomVideoPlayer.js' */                    return;

/*Line 74 - 'AtomVideoPlayer.js' */                this._poster = v.poster;
/*Line 75 - 'AtomVideoPlayer.js' */                if (v.autoPlay !== undefined) {
/*Line 76 - 'AtomVideoPlayer.js' */                    this._autoPlay = v.autoPlay;
/*Line 77 - 'AtomVideoPlayer.js' */                }
/*Line 78 - 'AtomVideoPlayer.js' */                if (v.url !== undefined) {
/*Line 79 - 'AtomVideoPlayer.js' */                    this._url = v.url;
/*Line 80 - 'AtomVideoPlayer.js' */                    this.play(v.url);
/*Line 81 - 'AtomVideoPlayer.js' */                }
/*Line 82 - 'AtomVideoPlayer.js' */            },
/*Line 83 - 'AtomVideoPlayer.js' */            get_options: function () {
/*Line 84 - 'AtomVideoPlayer.js' */                return {};
/*Line 85 - 'AtomVideoPlayer.js' */            },

/*Line 87 - 'AtomVideoPlayer.js' */            play: function (url) {

/*Line 89 - 'AtomVideoPlayer.js' */                if (!url) {
/*Line 90 - 'AtomVideoPlayer.js' */                    this.stop();
/*Line 91 - 'AtomVideoPlayer.js' */                    return;
/*Line 92 - 'AtomVideoPlayer.js' */                }

/*Line 94 - 'AtomVideoPlayer.js' */                this._url = url;

/*Line 96 - 'AtomVideoPlayer.js' */                var s = $(this._element).css('visibility');
/*Line 97 - 'AtomVideoPlayer.js' */                if (s != "visible") {
/*Line 98 - 'AtomVideoPlayer.js' */                    if (!this._queuePlay) {
/*Line 99 - 'AtomVideoPlayer.js' */                        this._queuePlay = true;
/*Line 100 - 'AtomVideoPlayer.js' */                    }
/*Line 101 - 'AtomVideoPlayer.js' */                    return;
/*Line 102 - 'AtomVideoPlayer.js' */                }

/*Line 104 - 'AtomVideoPlayer.js' */                this._queuePlay = false;


/*Line 107 - 'AtomVideoPlayer.js' */                var element = this.get_element();
/*Line 108 - 'AtomVideoPlayer.js' */                this.create();
/*Line 109 - 'AtomVideoPlayer.js' */                if (this._isFlash) {
/*Line 110 - 'AtomVideoPlayer.js' */                    jwplayer(this._divID).load({ file: url, image: this._poster });
/*Line 111 - 'AtomVideoPlayer.js' */                    if (this._autoPlay) {
/*Line 112 - 'AtomVideoPlayer.js' */                        jwplayer(this._divID).play();
/*Line 113 - 'AtomVideoPlayer.js' */                    }
/*Line 114 - 'AtomVideoPlayer.js' */                    return;
/*Line 115 - 'AtomVideoPlayer.js' */                } else {

/*Line 117 - 'AtomVideoPlayer.js' */                    if (this._video) {
/*Line 118 - 'AtomVideoPlayer.js' */                        $(this._video).remove();
/*Line 119 - 'AtomVideoPlayer.js' */                    }

/*Line 121 - 'AtomVideoPlayer.js' */                    this._video = document.createElement("video");
/*Line 122 - 'AtomVideoPlayer.js' */                    this._playerID = this._divID + "_Video";
/*Line 123 - 'AtomVideoPlayer.js' */                    this._video.id = this._playerID;
/*Line 124 - 'AtomVideoPlayer.js' */                    $(this._video).attr("controls", "controls");
/*Line 125 - 'AtomVideoPlayer.js' */                    this._video.style.width = "100%";
/*Line 126 - 'AtomVideoPlayer.js' */                    this._video.style.height = "100%";
/*Line 127 - 'AtomVideoPlayer.js' */                    this._video.autobuffer = true;
/*Line 128 - 'AtomVideoPlayer.js' */                    this._video.autoplay = true;
/*Line 129 - 'AtomVideoPlayer.js' */                    this._video.allowfullscreen = true;
/*Line 130 - 'AtomVideoPlayer.js' */                    if (this._poster) {
/*Line 131 - 'AtomVideoPlayer.js' */                        $(this._video).attr("poster", this._poster);
/*Line 132 - 'AtomVideoPlayer.js' */                    }
/*Line 133 - 'AtomVideoPlayer.js' */                    var src = document.createElement("source");
/*Line 134 - 'AtomVideoPlayer.js' */                    src.type = "video/mp4";
/*Line 135 - 'AtomVideoPlayer.js' */                    src.src = url;
/*Line 136 - 'AtomVideoPlayer.js' */                    this._video.appendChild(src);
/*Line 137 - 'AtomVideoPlayer.js' */                    $(element).append(this._video);
/*Line 138 - 'AtomVideoPlayer.js' */                    this._video.play();
/*Line 139 - 'AtomVideoPlayer.js' */                }
/*Line 140 - 'AtomVideoPlayer.js' */            },

/*Line 142 - 'AtomVideoPlayer.js' */            stop: function () {
/*Line 143 - 'AtomVideoPlayer.js' */                if (!this._playerCreated)
/*Line 144 - 'AtomVideoPlayer.js' */                    return;
/*Line 145 - 'AtomVideoPlayer.js' */                var element = this.get_element();
/*Line 146 - 'AtomVideoPlayer.js' */                if (this._isFlash) {
/*Line 147 - 'AtomVideoPlayer.js' */                    jwplayer(this._divID).pause(true);
/*Line 148 - 'AtomVideoPlayer.js' */                } else {
/*Line 149 - 'AtomVideoPlayer.js' */                    if (this._video) {
/*Line 150 - 'AtomVideoPlayer.js' */                        this._video.pause();
/*Line 151 - 'AtomVideoPlayer.js' */                    }
/*Line 152 - 'AtomVideoPlayer.js' */                }
/*Line 153 - 'AtomVideoPlayer.js' */            },

/*Line 155 - 'AtomVideoPlayer.js' */            supportsMP4: function () {
/*Line 156 - 'AtomVideoPlayer.js' */                var ua = window.navigator.userAgent.toLowerCase();

/*Line 158 - 'AtomVideoPlayer.js' */                if (/msie 10.0|safari|android|iphone|ipad|ios/gi.test(ua)) {
/*Line 159 - 'AtomVideoPlayer.js' */                    if (/chrome/gi.test(ua) && /mac|windows/gi.test(ua)) {
/*Line 160 - 'AtomVideoPlayer.js' */                        return false;
/*Line 161 - 'AtomVideoPlayer.js' */                    }
/*Line 162 - 'AtomVideoPlayer.js' */                    return true;
/*Line 163 - 'AtomVideoPlayer.js' */                }
/*Line 164 - 'AtomVideoPlayer.js' */                return false;
/*Line 165 - 'AtomVideoPlayer.js' */            },

/*Line 167 - 'AtomVideoPlayer.js' */            create: function () {
/*Line 168 - 'AtomVideoPlayer.js' */                if (this._playerCreated)
/*Line 169 - 'AtomVideoPlayer.js' */                    return;
/*Line 170 - 'AtomVideoPlayer.js' */                this._playerCreated = true;
/*Line 171 - 'AtomVideoPlayer.js' */                var element = this.get_element();
/*Line 172 - 'AtomVideoPlayer.js' */                AtomUI.assignID(element);
/*Line 173 - 'AtomVideoPlayer.js' */                allControls[element.id] = this;


/*Line 176 - 'AtomVideoPlayer.js' */                this._divID = element.id + "_Player";


/*Line 179 - 'AtomVideoPlayer.js' */                if (!this.supportsMP4()) {

/*Line 181 - 'AtomVideoPlayer.js' */                    var childDiv = document.createElement("div");
/*Line 182 - 'AtomVideoPlayer.js' */                    childDiv.id = this._divID;

/*Line 184 - 'AtomVideoPlayer.js' */                    $(element).append(childDiv);

/*Line 186 - 'AtomVideoPlayer.js' */                    this._fpID = this._divID + "_Flash";
/*Line 187 - 'AtomVideoPlayer.js' */                    //createVideoPlayer(element.id, this._divID, this._fpID);
/*Line 188 - 'AtomVideoPlayer.js' */                    jwplayer(this._divID).setup({
/*Line 189 - 'AtomVideoPlayer.js' */                        'flashplayer': this._swfPath,
/*Line 190 - 'AtomVideoPlayer.js' */                        'id': this._fpID,
/*Line 191 - 'AtomVideoPlayer.js' */                        'bufferlength': 10,
/*Line 192 - 'AtomVideoPlayer.js' */                        'controlbar.position': 'bottom',
/*Line 193 - 'AtomVideoPlayer.js' */                        'width': '100%',
/*Line 194 - 'AtomVideoPlayer.js' */                        'height': '100%',
/*Line 195 - 'AtomVideoPlayer.js' */                        'events': {
/*Line 196 - 'AtomVideoPlayer.js' */                            'onMeta': function (m) {
/*Line 197 - 'AtomVideoPlayer.js' */                                //log(m);
/*Line 198 - 'AtomVideoPlayer.js' */                            }
/*Line 199 - 'AtomVideoPlayer.js' */                        }
/*Line 200 - 'AtomVideoPlayer.js' */                    });
/*Line 201 - 'AtomVideoPlayer.js' */                    this._isFlash = true;
/*Line 202 - 'AtomVideoPlayer.js' */                }
/*Line 203 - 'AtomVideoPlayer.js' */            },

/*Line 205 - 'AtomVideoPlayer.js' */            initialize: function () {
/*Line 206 - 'AtomVideoPlayer.js' */                var element = this.get_element();
/*Line 207 - 'AtomVideoPlayer.js' */                $(element).addClass("atom-video-player");
/*Line 208 - 'AtomVideoPlayer.js' */                if (this._autoCreate) {
/*Line 209 - 'AtomVideoPlayer.js' */                    this.create();
/*Line 210 - 'AtomVideoPlayer.js' */                }
/*Line 211 - 'AtomVideoPlayer.js' */                baseType.initialize.call(this);
/*Line 212 - 'AtomVideoPlayer.js' */            }
/*Line 213 - 'AtomVideoPlayer.js' */        }
/*Line 214 - 'AtomVideoPlayer.js' */    });
/*Line 215 - 'AtomVideoPlayer.js' */})(WebAtoms.AtomPlayer.prototype);
/*Line 0 - 'AtomAlert.js' */
